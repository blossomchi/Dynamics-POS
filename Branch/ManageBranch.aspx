<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_wldrylq5" %>
...
<!--[if !IE]>--><div class="xr_ap" id="xr_xri" 
 ...
 <img class="xr_ap" src="index_htm_files/17.png" alt="" 
                ...
                style="left: -1px; top: 796px; width: 1005px; height: 74px;"/>
 <span class="xr_s0" style="position: absolute; left:32px; top:1569px;">
  <span class="xr_tc" style="left: 291px; top: -733px; width: 341px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &#169; Developed by Chinyere Blossom Oyem</span>
 </span>
     ...
     <table id="employeeTable" 
         ...
         <tr>
             <td class="style2" colspan="2">
                 <strong>
                 <asp:Label ID="employeeMgtLabel" runat="server" Text="Branch Management."></asp:Label>
                 <asp:TextBox ID="UpdateTextBox0" runat="server" 
                     ...
                     Font-Size="Medium" Visible="False">Add New Branch.</asp:Label>
         ...
         <tr>
             <td class="style3" colspan="2">
                 <strong>
                     ...
                     Text="Branch Name" 
                     Width="107px" ToolTip="Search by branch name" Visible="False" />
                 ...
                 <asp:Button ID="BackButton" runat="server" Text="Back" Visible="False" 
                     Width="66px" />
                 <asp:Button ID="AddattributeButton" runat="server" Text="Create New Branch" 
                     Width="147px" />
                                    </strong>
&nbsp;</td>
         </tr>
         <tr>
             <td class="style14" colspan="2">
                 ...
                 <asp:GridView ID="UnitGridView" runat="server" 
                     ...
                     DataKeyNames="BranchID" DataSourceID="UnitSqlDataSource1" ForeColor="Black" 
...
onclick = "Check_Click(this)"/>
                         ...
                         <asp:BoundField DataField="BranchID" HeaderText="Branch ID" 
                             SortExpression="BranchID" ReadOnly="True" />
                          ...
                          <asp:TemplateField ShowHeader="False">
                             <ItemTemplate>
                                 <asp:ImageButton ID="ImageButton1" runat="server" CausesValidation="false" 
                                  CommandName="Delete" ImageUrl="~/images/property/del.png" Text="Delete" Tooltip="Delete" CommandArgument='<%#Eval("BranchID") %>'/>
                             </ItemTemplate>
                         </asp:TemplateField>
                     </Columns>
                 ...
                 <asp:SqlDataSource ID="UnitSqlDataSource1" runat="server" 
                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                      DeleteCommand="DELETE FROM BranchesTable WHERE (BranchID = @BranchID)"
                     UpdateCommand="UPDATE UnitTable SET Status = @Status WHERE (SN = @SN)"
                    
                     
                     
                     
                     SelectCommand="SELECT BranchID, BranchName FROM BranchesTable WHERE (NOT (BranchID LIKE N'[345]%')) AND (BranchName &lt;&gt; N'Both') ORDER BY BranchName">
                      <DeleteParameters>
                 ...
                 <asp:GridView ID="findUnitNameGridView" runat="server" 
                     ...
                     DataSourceID="emailSqlDataSource1" DataKeyNames="BranchID">
                     <AlternatingRowStyle BackColor="#CCCCCC" />
...
onclick = "Check_Click(this)"/>
         ...
         <tr>
             <td class="style14" colspan="2" valign="top">
                     ...
                     style="background-image: url('images/eeee.gif'); background-repeat: repeat; background-position: center; border-style: dashed"  >
                            <tr>
            ...
            visible="False">
                <tr>
                    <td class="style11" style="" colspan="2">
                        &nbsp;Search.....<br />
                    </td>
                </tr>
                <tr>
                    <td class="style24" style="">
                        Name<strong>:
                    ...
                    <td class="style6" style="">
                     ...
                     Text="Search" 
                     Width="68px" ToolTip="Search by branch name" />
                    </td>
                </tr>
                <tr>
                    <td class="style11" style="" colspan="2">
                        <asp:GridView ID="SearchGridView1" runat="server" AllowPaging="True" 
                            ...
                            DataSourceID="searchviewSqlDataSource2" ForeColor="Black" 
                            GridLines="Vertical" Width="312px" DataKeyNames="BranchID" ShowFooter="True">
                            <AlternatingRowStyle BackColor="#CCCCCC" />
                            <Columns>
                                <asp:BoundField DataField="BranchID" HeaderText="Branch ID" 
                                    SortExpression="BranchID" ReadOnly="True" />
                        ...
                        <asp:GridView ID="SearchGridView2" runat="server" AllowPaging="True" 
                            ...
                            PageSize="5" Visible="False" Width="312px" DataKeyNames="BranchID" 
                            ShowFooter="True">
                            <AlternatingRowStyle BackColor="#CCCCCC" />
                            <Columns>
                                <asp:BoundField DataField="BranchID" HeaderText="Branch ID" 
            ...
            visible="False">
                <tr>
                    ...
                    <td class="style28" style="">
                        ...
                        <asp:Label ID="UnitCodeLabel" runat="server" Visible="False"></asp:Label>
                        </strong>
                    </td>
                </tr>
                <tr>
                    <td class="style25" style="">
                                    Branch Code:</td>
                    <td class="style28" style="">
                        <strong>
                        <asp:TextBox ID="txtBranchCode" runat="server" Width="281px" ReadOnly="True"></asp:TextBox>
                        </strong>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="style28" style="">
                        <strong>
                        <asp:TextBox ID="BranchNameTextBox" runat="server" Width="281px"></asp:TextBox>
                        </strong>
                    </td>
                </tr>
                <tr>
                    <td class="style22" style="">
                        &nbsp;</td>
                    <td class="style22" style="">
                 <strong>
                 <asp:Button ID="saveButton" runat="server" 
                     Text="Save New Branch" Visible="False" 
                     Width="188px" ToolTip="Save new branch" OnClientClick = "Confirm()" />
                                    </strong>
                    </td>
                </tr>
                </table>
         ...
         <tr>
             <td class="style9">
                 <asp:SqlDataSource ID="emailSqlDataSource1" runat="server" 
                     ...
                     SelectCommand="SELECT BranchID, BranchName FROM BranchesTable WHERE (NOT (BranchID LIKE N'[345]%')) AND (BranchName = @BranchName) ORDER BY BranchName" 
                     ...
                     InsertCommand="INSERT INTO [UnitTable] ([SN], [UnitName], [UoMID]) VALUES (@SN, @UnitName, @UoMID)">
                      ...
                      <SelectParameters>
                          <asp:ControlParameter ControlID="findTextBox" Name="BranchName" 
                              PropertyName="Text" />
                      </SelectParameters>
                      <UpdateParameters>
                          <asp:Parameter Name="SN" Type="Int32" />
                 ...
                 <asp:SqlDataSource ID="searchSqlDataSource2" runat="server" 
                     ...
                     SelectCommand="SELECT BranchID, BranchName FROM BranchesTable WHERE (NOT (BranchID LIKE N'[345]%')) AND (BranchName = @BranchName) ORDER BY BranchName">
                     <SelectParameters>
                         <asp:ControlParameter ControlID="viewIDTextBox0" Name="BranchName" 
                             PropertyName="Text" />
                     </SelectParameters>
                 </asp:SqlDataSource>
                 <asp:SqlDataSource ID="searchviewSqlDataSource2" runat="server" 
                     ...
                     SelectCommand="SELECT BranchID, BranchName FROM BranchesTable WHERE (NOT (BranchID LIKE N'[345]%')) ORDER BY BranchName">
                 </asp:SqlDataSource>
                                    </strong>
...
<script type='text/javascript'>//<![CDATA[
    ...
    xr_d.write(".xr_links_menu1 {z-index:999;border-color:#000000;border-style:solid;border-width:0px 0px 0px 0px;background-color:#B2B2B2;left:0px;top:0px;visibility:hidden;position:absolute;}");
    xr_d.write(".xr_links_plain1, a.xr_links_plain1:link, a.xr_links_plain1:visited{text-align:left;background-color:#B2B2B2;color:#000000;text-decoration:none;border-color:#000000;border-style:solid;border-width:0px 0px 0px 0px; padding:2px 0px 2px 0px;cursor:pointer;display:block;font-size:11px;font-family:Arial;}")
    ...
    xr_d.write(".xr_links_menu2 {z-index:999;border-color:#000000;border-style:solid;border-width:0px 0px 0px 0px;background-color:#B2B2B2;left:0px;top:0px;visibility:hidden;position:absolute;}");
    xr_d.write(".xr_links_plain2, a.xr_links_plain2:link, a.xr_links_plain2:visited{text-align:left;background-color:#B2B2B2;color:#000000;text-decoration:none;border-color:#000000;border-style:solid;border-width:0px 0px 0px 0px; padding:2px 0px 2px 0px;cursor:pointer;display:block;font-size:11px;font-family:Arial;}")
