<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_xenjplcv" %>
...
<meta name="XAR Files" content="index_htm_files/xr_files.txt"/>
 <title>Manage Service Charge</title>  
         ...
         <tr>
             <td class="style2" colspan="2">
                 ...
                 <asp:Label ID="employeeMgtLabel" runat="server" 
                     Text="Manage Service Charge"></asp:Label>
                 <asp:TextBox ID="UpdateTextBox0" runat="server" 
                     ...
                     Font-Size="Medium" Visible="False">Add Service Charge</asp:Label>
             ...
             <td class="style3" colspan="2">
                 <strong>
                        <asp:DropDownList ID="CBSourceNO0" runat="server" AutoPostBack="True" 
                            DataSourceID="SqlDataSource1" DataTextField="ServiceName" DataValueField="ServiceName" 
                 ...
                 <asp:Button ID="BackButton" runat="server" Text="Back" Visible="False" 
                     Width="66px" />
                 <asp:Button ID="AddattributeButton" runat="server" Text="Service Charge" 
                     Width="118px" />
                                    </strong>
&nbsp;</td>
         </tr>
         <tr>
             <td class="style14" colspan="2">
                 ...
                 <asp:GridView ID="GVItem" runat="server" 
                     ...
                     DataSourceID="ItemDS" AllowPaging="True" DataKeyNames="ID" 
                     PageSize="28">
                   ...
                   <asp:BoundField DataField="ServiceName" HeaderText="Service Name" 
                         ...
                         <asp:BoundField DataField="Cost" HeaderText="Cost" 
                             SortExpression="Cost" DataFormatString="{0:0,0.00}" />
                         ...
                         <asp:TemplateField ShowHeader="False">
                             <ItemTemplate>
                                 <asp:ImageButton ID="ImageButton1" runat="server" CausesValidation="false" 
                                  CommandName="DeleteFreeItem" ImageUrl="~/images/property/del.png" Text="Delete" Tooltip="Delete"  CommandArgument='<%#Eval("ID") %>'/>
                             </ItemTemplate>
                         </asp:TemplateField>
                     </Columns>
                 ...
                 <asp:GridView ID="findBarcodeGridView" runat="server" 
                     ...
                     DataSourceID="findBarcodeDS" DataKeyNames="ID" AllowPaging="True">
                     <AlternatingRowStyle BackColor="#CCCCCC" />
                     <Columns>
                         <asp:BoundField DataField="ID" HeaderText="ID" SortExpression="ID" 
                             InsertVisible="False" ReadOnly="True"/>
                 ...
                 <asp:SqlDataSource ID="findBarcodeDS" runat="server" 
                     ...
                     SelectCommand="SELECT DISTINCT ID, ServiceName, Description, Cost, DateCreated, CreatedBy FROM ServiceChargeDefinitionTable WHERE (ServiceName = @Name) AND (Cost &lt;&gt; 00.00)">
                     <SelectParameters>
                         <asp:ControlParameter ControlID="findTextBox" Name="Name" 
                             PropertyName="Text" />
                     </SelectParameters>
                 </asp:SqlDataSource>
         ...
         <tr>
             <td class="style14" colspan="2" valign="top">
                 ...
                 <table style="background-position: center; border-style: solid; border-width: medium; width: 989px; margin-left: 0px; height: 114px; background-image: url('images/eeee.gif'); background-repeat: repeat;" 
            ...
            visible="False" align="left" bgcolor="#DBD7CB">
                <tr>
                    ...
                    <td class="style64" valign="top">
                                 ...
                                 <strong >
                        <asp:TextBox ID="txtServiceName" runat="server" Width="230px" 
                ...
                <tr>
                    ...
                    <td class="style64" valign="top">
                                 ...
                                 <strong >
                        <asp:TextBox ID="txtDescription" runat="server" Width="230px" 
                            style="text-align: left" Height="58px" TextMode="MultiLine"></asp:TextBox>
                        </strong></td>
                    <td class="style63" valign="top">
                ...
                <tr>
                    ...
                    <td class="style64" valign="top">
                                 ...
                                 <strong >
                        <asp:TextBox ID="txtUnitCost" runat="server" Width="230px" 
                            style="text-align: left"></asp:TextBox>
                        </strong></td>
                    <td class="style63" valign="top">
         ...
         <tr>
             <td class="style14" colspan="2" valign="top" align="center">
                 ...
                 <table style="background-position: center; border-style: solid; border-width: medium; width: 989px; margin-left: 0px; height: 40px; background-image: url('../../Manage%20Accounting/Customer%20Account/images/eeee.gif'); background-repeat: repeat;" 
            ...
            visible="False" align="left" bgcolor="#DBD7CB">
                <tr>
                    <td class="style74" valign="top" align="center">
                        ...
                        <strong>
                 &nbsp;&nbsp;<asp:Button 
                            ID="saveButton" runat="server" 
                                     Text="Save" ToolTip="Save Service charge" Visible="False" 
                     Width="66px" />
         ...
         <tr>
             <td class="style53">
                 ...
                 <asp:SqlDataSource ID="ItemDS" runat="server" 
                     ...
                     SelectCommand="SELECT DISTINCT ID, ServiceName, Description, Cost, DateCreated, CreatedBy FROM ServiceChargeDefinitionTable WHERE (Cost &lt;&gt; 00.00)">
                 </asp:SqlDataSource>
                     ...
                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                     SelectCommand="SELECT DISTINCT ID, ServiceName, Cost, DateCreated, CreatedBy FROM ServiceChargeDefinitionTable WHERE (Cost &lt;&gt; 0.00)">
                 </asp:SqlDataSource>
