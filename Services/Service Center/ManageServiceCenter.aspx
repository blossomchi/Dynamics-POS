<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_cwqiotfa" %>
...
<meta name="XAR Files" content="index_htm_files/xr_files.txt"/>
 <title>OEM Service Center</title>  
...
<div class="xr_ap" id="xr_xr" 
    ...
    style="width: 1000px; height: 1603px; top:0px; left:50%; margin-left: -500px;">
 ...
 &nbsp;<!--[if IE]><div class="xr_ap" id="xr_xri" 
        ...
        style="width: 1000px; height: 1599px; clip: rect(0px 1000px 1600px 0px); top: 0px; left: 4px;"><![endif]-->
<!--[if !IE]>--><div class="xr_ap" id="xr_xri" 
            ...
            style="width: 1000px; height: 1605px; clip: rect(0px, 1000px, 1600px, 0px); top: -4px; left: 18px;"><!--<![endif]-->
 ...
 <img class="xr_ap" src="index_htm_files/17.png" alt="" 
                ...
                style="left: 2px; top: 1502px; width: 1005px; height: 74px;"/>
 <span class="xr_s0" style="position: absolute; left:32px; top:1569px;">
  <span class="xr_tc" style="left: 292px; top: -33px; width: 341px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &#169; Developed by Chinyere Blossom Oyem</span>
 </span>
 <table id="adminInfoTable" runat="server" 
     ...
     <table id="employeeTable" 
                ...
                style="position: absolute; top: 256px; left: 6px; width: 947px; height: 1646px;">
         <tr>
             <td class="style2" colspan="2">
                 <strong>
                 <asp:Label ID="employeeMgtLabel" runat="server" 
                     Text="OEM Service Center"></asp:Label>
                 <asp:TextBox ID="UpdateTextBox0" runat="server" 
                     ...
                     Font-Size="Medium" Visible="False">Add OEM Service Center</asp:Label>
         ...
         <tr>
             <td class="style3" colspan="2">
                 ...
                 <asp:Button ID="btnDelete" runat="server" Text="Delete Selected" 
                     ...
                     ToolTip="Delete all OEM information." />
                 ...
                 <asp:Button ID="BackButton" runat="server" Text="Back" Visible="False" 
                     Width="66px" />
                 <asp:Button ID="AddattributeButton" runat="server" Text="Add OEM" 
                     Width="118px" />
                                    </strong>
&nbsp;</td>
         </tr>
         <tr>
             <td class="style14" colspan="2">
                 ...
                 <asp:GridView ID="GVItem" runat="server" 
                     ...
                     PageSize="28" DataKeyNames="OEMID">
                     <AlternatingRowStyle BackColor="#CCCCCC" />
                     <Columns>
                         <asp:BoundField DataField="OEMID" HeaderText="OEM ID" ReadOnly="True" 
                             SortExpression="OEMID" />
                         <asp:BoundField DataField="ManagerName" 
                             HeaderText="Manager's Name"  
                             SortExpression="ManagerName"/>
                   <asp:BoundField DataField="CompanyName" HeaderText="OEM Service Center" 
                         ...
                         <asp:TemplateField ShowHeader="False">
                             <ItemTemplate>
                                 <asp:ImageButton ID="ImageButton1" runat="server" CausesValidation="false" 
                                  CommandName="DeleteFreeItem" ImageUrl="~/images/property/del.png" Text="Delete" Tooltip="Delete"  CommandArgument='<%#Eval("OEMID") %>'/>
                             </ItemTemplate>
                         </asp:TemplateField>
                     </Columns>
                 ...
                 <asp:GridView ID="findBarcodeGridView" runat="server" 
                     ...
                     DataSourceID="findBarcodeDS" DataKeyNames="OEMID" AllowPaging="True">
                     <AlternatingRowStyle BackColor="#CCCCCC" />
                     <Columns>
                               <asp:BoundField DataField="OEMID" HeaderText="OEM ID" 
                             SortExpression="OEMID" ReadOnly="True" />
                         <asp:BoundField DataField="ManagerName" 
                             HeaderText="Manager's Name" 
                             SortExpression="ManagerName"/>
                         <asp:BoundField DataField="CompanyName" HeaderText="OEM Service Center" 
                 ...
                 <asp:SqlDataSource ID="findBarcodeDS" runat="server" 
                     ...
                     SelectCommand="SELECT DISTINCT OEMID, ManagerName, CompanyName, CreatedBy, DateCreated FROM ServiceCenterManagerTable WHERE (CompanyName = @ServiceName)">
                     <SelectParameters>
                         <asp:ControlParameter ControlID="findTextBox" Name="ServiceName" 
                             PropertyName="Text" />
                     </SelectParameters>
                 </asp:SqlDataSource>
         ...
         <tr>
             <td class="style14" colspan="2" valign="top">
                        ...
                        <table id="AddItemTable" runat="server" visible="False" align="left" 
                            ...
                            style="background-position: center; border-style: solid; border-width: medium; width: 985px; background-image: url('../../Customer%20and%20Supplier/Suppliers%20Management/images/eeee.gif'); background-repeat: repeat; height: 425px; top: 80px; background-color: #DBD8CA;"  >
                            <tr>
                        ...
                        <table id="SupplierTable" runat="server" visible="False" align="right" 
                                        ...
                                        style="border-style: none; border-width: medium; width: 405px; margin-right: 0px; height: 391px;"  >
                            <tr>
                                <td class="style101" valign="top" colspan="2"  >
                        
                                    &nbsp;<strong>Manager&#39;s&nbsp; Information&nbsp; </strong></td>
                            </tr>
                            <tr>
                        ...
                        <strong>
                                    Entered By: 
                        <asp:TextBox ID="txtAdminName" runat="server" Width="230px" 
                        ...
                        <strong>
                        <asp:Label ID="LBSupID" runat="server"></asp:Label>
                        </strong>
                                </td>
                            </tr>
                            <tr>
                     ...
                     Width="114px" Enabled="False" 
                            ...
                            <tr>
                             ...
                             <asp:TextBox ID="txtHQContact" runat="server" Width="140px" 
                                        ToolTip="Enter manager name "></asp:TextBox>
                             </strong>
                                </td>
                            </tr>
                            <tr>
                 ...
                 <asp:Button ID="saveButton1" runat="server" 
                     Text="Save" 
                     Width="111px" ToolTip="Save manager Information" />
                 &nbsp;<asp:Button ID="CancelButton" runat="server" Text="Add More OEM" 
                     Width="139px" ToolTip="Add More OEM..." />
                                    </strong>
                                </td>
                            </tr>
                            </table>
                        ...
                        <table id="ContactTable" runat="server" visible="False" 
                                        ...
                                        style="border-style: none; border-width: medium; width: 432px; margin-right: 0px; height: 375px;" 
                                        enableviewstate="True"  >
                            <tr>
                                <td class="style102" valign="top" colspan="2" >
                      
                                    <strong>Front Desk / Customer Care Information 
                      
                        
                                    for 
                      
                        
                        <asp:Label ID="LBCompanyName1" runat="server"></asp:Label>
                            ...
                            <tr>
                                <td class="style95" valign="top" colspan="2" >
                                    ...
                                    <strong>
                                    Entry Date:
                        <asp:TextBox ID="txtDate" runat="server" Width="230px" 
                            style="text-align: left" ReadOnly="True"></asp:TextBox>
                                    </strong></td>
                            </tr>
                            <tr>
                        ...
                        <asp:DropDownList ID="cbContactID0" runat="server" 
                            ...
                            DataValueField="OEMID" Width="119px" Enabled="False">
                        </asp:DropDownList>
                                    &nbsp;<strong><asp:Button ID="Same" runat="server" Text="Same As Manager." 
                     Width="147px" Enabled="False" 
                                        ToolTip="Click if the manager is the same as contact information." />
                                    </strong>
                                </td>
                            </tr>
                            <tr>
                     ...
                     OnClientClick = " " />
                                    &nbsp;<asp:Button ID="AddProductButton" runat="server" Text="Add Engineer" 
                     Width="114px" ToolTip="Add Engineer.." />
         ...
         <tr>
             <td valign="top">
                        ...
                        <table id="Engineer" runat="server" visible="False" align="left" 
                     ...
                     style="border-style: solid; border-width: medium; width: 511px; background-color: #DBD8CA;"  >
                            <tr>
                                <td class="style41" valign="top" >
                      
                                    &nbsp;Engineer Information for
                        ...
                        <asp:Label ID="LBCompanyName0" runat="server"></asp:Label>
                            ...
                            <tr>
                                <td class="style87" valign="top" >
                      
                        

                        <table id="EngineerTable" runat="server" visible="False" align=" " 
                                        ...
                                        style="border-style: none; border-width: medium; width: 493px; margin-right: 0px; height: 298px;"  >
                            <tr>
                        ...
                        <asp:DropDownList ID="cbContactID1" runat="server" 
                            ...
                            DataValueField="OEMID" Width="140px" Enabled="False">
                        </asp:DropDownList>
                             </strong>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="style66" valign="top" >
                                    ...
                                    <strong>
                             <asp:TextBox ID="txtEContact" runat="server" Width="140px" 
                        ...
                        <strong>
                        <asp:TextBox ID="txtEnAddress" runat="server" Width="140px" Height="20px"></asp:TextBox>
                        </strong>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <strong>
                        <asp:TextBox ID="txtEnAddress2" runat="server" Width="140px" Height="20px"></asp:TextBox>
                        </strong>
                        ...
                        <strong>
                        <asp:TextBox ID="txtEnEmail" runat="server" Width="140px" 
                            Wrap="False"></asp:TextBox>
                        </strong>
                        ...
                        <strong>
                        <asp:TextBox ID="txtEnEmail1" runat="server" Width="140px" 
                            Wrap="False"></asp:TextBox>
                        </strong>
                        ...
                        <strong>
                        <asp:TextBox ID="txtEPhone" runat="server" Width="140px" 
                            Wrap="False"></asp:TextBox>
                        </strong>
                        ...
                        <strong>
                        <asp:TextBox ID="txtEPhone1" runat="server" Width="140px" 
                            Wrap="False"></asp:TextBox>
                        </strong>
                     ...
                     Width="112px" ToolTip="Click to add Bank Information" />
                     ...
                     Width="76px" Visible="False" onclientclick="Delete1()" 
                                    ...
                                    <asp:Button ID="Cancel1" runat="server" Text="Close" 
                     Width="76px" />
                                    </strong>
                                </td>
                            </tr>
             ...
             <td valign="top">
                     ...
                     style="border-style: solid; border-width: medium; width: 469px; background-color: #DBD8CA; height: 160px;"  >
                            <tr>
                        ...
                        <asp:DropDownList ID="cvAccountType" runat="server" Width="140px">
         ...
         <tr>
             <td valign="top" colspan="2" style="top: 100px; position: absolute;">

                 <table style="border-style: solid; border-width: medium; width: 980px; margin-left: 0px;" 
            ...
            visible="False" align="left">
                <tr>
                    <td class="style25" style="border-style: solid; border-width: 1px" valign="top">
                        ...
                        <asp:Label ID="LBCompanyName2" runat="server">OEM Service Center</asp:Label>
                    ...
                    <td class="style84" style="border-style: solid; border-width: 1px" valign="top">
                        ...
                        <asp:Label ID="LBCompanyName3" runat="server">Front Desk Contact</asp:Label>
                    ...
                    <td class="style28" style="border-style: solid; border-width: 1px" valign="top">
                        ...
                        <asp:Label ID="LBCompanyName4" runat="server">Engineer's Name</asp:Label>
                    ...
                    <td class="style85" style="border-style: solid; border-width: 1px" valign="top">
                        ...
                        <asp:Label ID="LBCompanyName5" runat="server" style="text-align: center">Bank Informations</asp:Label>
                ...
                <tr>
                    <td class="style25" style="border-style: solid; border-width: 1px" valign="top">
                                    <asp:ListBox ID="listBoxSupplier" runat="server" AutoPostBack="True" 
                                        ...
                                        DataTextField="CompanyName" DataValueField="ID" Height="340px" 
                                        Width="179px" ToolTip="List view for company name.">
                                    </asp:ListBox>
                    </td>
                    <td class="style84" style="border-style: solid; border-width: 1px" valign="top">
                        <asp:ListBox ID="ListBoxContact" runat="server" AutoPostBack="True" 
                            DataMember="DefaultView" DataSourceID="OEMContactDS" DataTextField="Contact Name" 
                            DataValueField="Contact ID" Height="340px" Width="199px" 
                            ToolTip="List view for contact."></asp:ListBox>
                    </td>
                    <td class="style28" style="border-style: solid; border-width: 1px" valign="top">
                        <asp:ListBox ID="ListBoxEngineer" runat="server" AutoPostBack="True" 
                            DataMember="DefaultView" DataSourceID="EngineerDS" DataTextField="EngineerName" 
                            DataValueField="Engineer ID" Height="340px" Width="217px" 
                            ToolTip="List view for engineer." style="margin-left: 0px"></asp:ListBox>
                    </td>
                    <td class="style85" style="border-style: solid; border-width: 1px" valign="top">
  ...
  <asp:ListView ID="ListViewProductInfo" runat="server" DataSourceID="AccountDS" 
                            ...
                            <EmptyDataTemplate>
                              ...
                              <ItemTemplate>
                                <span style="background-color: #DCDCDC;color: #000000;">Bank:
                                <asp:Label ID="BankLabel0" runat="server" Text='<%# Eval("Bank") %>' />
                                <br />
                                  Account Type:
                            ...
                            <LayoutTemplate>
                              ...
                              <SelectedItemTemplate>
                                  <span style="background-color: #008A8C;font-weight: bold;color: #FFFFFF;">Bank:
                                  <asp:Label ID="BankLabel1" runat="server" Text='<%# Eval("Bank") %>' />
                                  <br />
                                  Account Type:
                                  <asp:Label ID="Account_TypeLabel1" runat="server" 
                                      Text='<%# Eval("[Account Type]") %>' />
                                  <br />
                                  Account:
                                  ...
                                  <br />
                                  Currency:
                                  <asp:Label ID="CurrencyLabel4" runat="server" Text='<%# Eval("Currency") %>' />
                                  <br />
                                  <br />
                                  </span>
                             </SelectedItemTemplate>
                    ...
                    <td valign="top" class="style86" style="">
                                    ...
                                    <strong>
                                    <asp:Button ID="EditSup" runat="server" Text="Edit Manager" 
                     Width="114px" Visible="False" style="height: 26px" ToolTip="Click to edit." />
                                    <br />
                        <asp:Button ID="EditContact" runat="server" Text="Edit Front Desk" 
                     Width="114px" Visible="False" />
                                    <br />
                        <asp:Button ID="EditEngineer" runat="server" Text="Edit Engineer" 
                     Width="114px" Visible="False" />
                                    <br />
                        <br />
                                    <br />
                 ...
                 <table class="style1" visible="False">
                    ...
                    <td class="style22">
                        ...
                        <asp:TextBox ID="txtRatio" runat="server" Width="20px" 
                            ...
                            ToolTip="Min 0, Max 100"></asp:TextBox>
                                    <span class="style73">
                        <asp:TextBox ID="txtAccountName" runat="server" Width="20px" 
                            style="text-align: left" Visible="False" MaxLength="100" 
                            ToolTip="Min 0, Max 100"></asp:TextBox>
                        <asp:TextBox ID="txtContactID" runat="server" Width="34px" MaxLength="2" 
                            Visible="False"></asp:TextBox>
                        <asp:TextBox ID="txtListContactID" runat="server" Width="34px" MaxLength="2" 
                            Visible="False"></asp:TextBox>
                                    </span>
                     ...
                     <tr>
                         ...
                         <asp:SqlDataSource ID="contactds" runat="server" 
                             ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                                 ...
                                 SelectCommand="SELECT ServiceCenterEngineerTable.EngineerName AS [Engineer Name] FROM ServiceCenterManagerTable INNER JOIN ServiceCenterEngineerTable ON ServiceCenterManagerTable.OEMID = ServiceCenterEngineerTable.OEMID WHERE (ServiceCenterManagerTable.OEMID = @OemID)">
                             <SelectParameters>
                                 <asp:ControlParameter ControlID="listBoxSupplier" Name="OemID" 
                                     PropertyName="SelectedValue" />
                             </SelectParameters>
                         </asp:SqlDataSource>

                             <asp:SqlDataSource ID="EngineerDS" runat="server" 
                                 ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                                 SelectCommand="SELECT ServiceCenterManagerTable.ID, ServiceCenterEngineerTable.ID AS [Engineer ID], ServiceCenterEngineerTable.OEMID, ServiceCenterEngineerTable.EngineerName FROM ServiceCenterEngineerTable INNER JOIN ServiceCenterManagerTable ON ServiceCenterEngineerTable.OEMID = ServiceCenterManagerTable.OEMID WHERE (ServiceCenterManagerTable.ID = @ID)">
                                 <SelectParameters>
                                     <asp:ControlParameter ControlID="listBoxSupplier" Name="ID" 
                                         PropertyName="SelectedValue" />
                                 </SelectParameters>
                             </asp:SqlDataSource>
                         </td>
         ...
         <tr>
             <td class="style53">
                 ...
                 <asp:SqlDataSource ID="ItemDS" runat="server" 
                     ...
                     SelectCommand="SELECT DISTINCT OEMID, ManagerName, CompanyName, CreatedBy, DateCreated FROM ServiceCenterManagerTable">
                 </asp:SqlDataSource>
                     ...
                     SelectCommand="SELECT ServiceCenterBankTable.BankName AS Bank, ServiceCenterBankTable.AccountType AS [Account Type], ServiceCenterBankTable.Account, ServiceCenterBankTable.Currency, ServiceCenterManagerTable.ID FROM ServiceCenterManagerTable INNER JOIN ServiceCenterBankTable ON ServiceCenterManagerTable.OEMID = ServiceCenterBankTable.OEMID WHERE (ServiceCenterManagerTable.ID = @ID)">
                            <SelectParameters>
                                <asp:ControlParameter ControlID="listBoxSupplier" Name="ID" 
                                    PropertyName="SelectedValue" />
                            </SelectParameters>
                                    ...
                                    <asp:SqlDataSource ID="OEMContactDS" runat="server" 
                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                     SelectCommand="SELECT ServiceCenterManagerTable.ID, ServiceCenterFrontDeskTable.ID AS [Contact ID], ServiceCenterFrontDeskTable.ContactFirstName + ' ' + ServiceCenterFrontDeskTable.LastName AS [Contact Name], CONVERT (VARCHAR, ServiceCenterFrontDeskTable.OEMID) AS OEMID FROM ServiceCenterFrontDeskTable INNER JOIN ServiceCenterManagerTable ON ServiceCenterFrontDeskTable.OEMID = ServiceCenterManagerTable.OEMID WHERE (ServiceCenterManagerTable.ID = @ID)">
                                        <SelectParameters>
                                            <asp:ControlParameter ControlID="listBoxSupplier" Name="ID" 
                                                PropertyName="SelectedValue" />
                                        </SelectParameters>
                 ...
                 <asp:SqlDataSource ID="suppliersHeader" runat="server" 
                     ...
                     SelectCommand="SELECT OEMID, CompanyName, ID FROM ServiceCenterManagerTable WHERE (ID = @ID)">
                     <SelectParameters>
                         <asp:ControlParameter ControlID="viewTextBox3" Name="ID" 
                             PropertyName="Text" />
                     </SelectParameters>
                 </asp:SqlDataSource>
                     ...
                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                     SelectCommand="SELECT * FROM [ServiceOrEngineerTable]"></asp:SqlDataSource>
