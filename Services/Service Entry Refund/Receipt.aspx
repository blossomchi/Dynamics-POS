<%@ page language="VB" autoeventwireup="false" inherits="Invoice, App_Web_ytdnkdo2" %>
                        ...
                        <table id="ReceiptHeaderTable" runat="server" visible="True" 
                            ...
                            <tr>
                                <td class="auto-style17" >
                                 ...
                                 <asp:Label ID="LBBranch11" runat="server" ToolTip="Total amount.">Total Refunds: </asp:Label>
                                ...
                                <td class="auto-style17" >
                                 ...
                                 <asp:Label ID="LBTotalRefunds" runat="server"></asp:Label>
