<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_1rrmvos4" %>
     ...
     <table id="employeeTable" 
         ...
         <tr>
             <td class="style2" colspan="2">
                 ...
                 <asp:Label ID="employeeMgtLabel" runat="server" 
                     Text="Fault Diagnosis"></asp:Label>
                 <asp:TextBox ID="UpdateTextBox0" runat="server" 
                     ...
                     Font-Size="Medium" Visible="False">Engineer</asp:Label>
         ...
         <tr>
             <td class="style3" colspan="2">
                 ...
                 <asp:Button ID="AddattributeButton" runat="server" Text="Ledger" 
                     Width="118px" Visible="False" />
                        <asp:DropDownList ID="CBSourceNO0" runat="server" AutoPostBack="True" 
                            DataSourceID="JobcardDS" DataTextField="JobCardNo" DataValueField="JobCardNo" 
                 ...
                 <asp:Button ID="AddattributeButton0" runat="server" Text="Update On Job Card" 
                     Width="150px" ToolTip="Click to update a job card number" />
                                    </strong>
&nbsp;</td>
         </tr>
         <tr>
                   ...
                   <asp:BoundField DataField="JobCardNo" HeaderText="JobCardNo" 
                         ...
                         <asp:BoundField DataField="Date Created" HeaderText="Date Created" 
                             SortExpression="Date Created" />
                              <asp:BoundField DataField="Return In Date" HeaderText="Return In Date" 
                             SortExpression="Return In Date" />
                     </Columns>
...
onclick = "Check_Click(this)"/>
         ...
         <tr>
             <td class="style14" colspan="2" valign="top" 
                 ...
                 <table style="background-position: center; border-style: solid; border-width: medium; width: 989px; margin-left: 0px; height: 913px; background-image: url('images/eeee.gif'); background-repeat: repeat;" 
            ...
            visible="False" align="left" bgcolor="#DBD7CB">
                ...
                <tr>
                    <td class="style631" valign="top" colspan="2">
                            ...
                            style="text-align: center; font-style: italic;">AMOUNT PAID : </asp:Label>
