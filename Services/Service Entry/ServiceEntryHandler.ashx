<%@ WebHandler Language="VB" Class="ServiceEntryHandler" %>
Imports System.Web
...
Public Class ServiceEntryHandler : Implements IHttpHandler
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        If id IsNot Nothing Then
            ...
            Dim sql As String = "SELECT * From ServiceEntryImageTable Where ID = @id"
