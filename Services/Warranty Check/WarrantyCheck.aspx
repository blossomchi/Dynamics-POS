<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_03b4mx3w" %>
         ...
         <tr>
             <td class="style2" colspan="2">
                 ...
                 <asp:TextBox ID="UpdateTextBox0" runat="server" 
                     ...
                     Font-Size="Medium" Visible="False">Warranty</asp:Label>
         ...
         <tr>
             <td class="style3" colspan="2">
                 ...
                 <asp:Button ID="BackButton" runat="server" Text="Back" Visible="False" 
                     Width="66px" />
                 <asp:FileUpload ID="FileUpload1" runat="server" ToolTip="Browse to upload files....." />
                 <asp:TextBox ID="txtFileName" runat="server" ToolTip="Enter the name of the file... " Width="255px"></asp:TextBox>
                 <asp:Button ID="WarrantyButton" runat="server" Text="Warranty" 
                     Width="118px" ToolTip="Add warranty files" />
                                    </strong>
&nbsp;</td>
         </tr>
         <tr>
             <td class="style14" colspan="2">
                 ...
                 <asp:GridView ID="GVItem" runat="server" 
                     ...
                     DataSourceID="ItemDS" AllowPaging="True" DataKeyNames="S/N" 
                     PageSize="28">
                     <AlternatingRowStyle BackColor="#CCCCCC" />
                     <Columns>
                         <asp:BoundField DataField="S/N" HeaderText="S/N"  SortExpression="S/N" InsertVisible="False" ReadOnly="True"/>
                   <asp:BoundField DataField="Document Title" HeaderText="Document Title" 
                             SortExpression="Document Title" />
                         <asp:BoundField DataField="Scan Name" HeaderText="Scan Name" 
                             SortExpression="Scan Name" />
                         <asp:BoundField DataField="Scan Type" HeaderText="Scan Type" 
                             SortExpression="Scan Type" />
                         <asp:BoundField DataField="Document" HeaderText="Document" SortExpression="Document" Visible="False"/>
                           <asp:TemplateField ShowHeader="False">
                             <ItemTemplate>
                                 <asp:ImageButton ID="ImageButton2" runat="server" CausesValidation="false" 
                                     CommandName="Files" ImageUrl='<%# "Handler2.ashx?id=" + Convert.ToString(Eval("S/N"))%>' Text="Print" ToolTip="Display File"                                    
                                         CommandArgument='<%#Eval("S/N")%>' OnClientclick="javascript:DisplayFullImage(this);" Height="15px" Width="15px" />                                           
                             </ItemTemplate>
                         </asp:TemplateField>
                         <asp:TemplateField ShowHeader="False">
                             <ItemTemplate>
                                 <asp:ImageButton ID="ImageButton1" runat="server" CausesValidation="false" CommandName="DownloadFile" 
                                     ImageUrl="~/Services/Service Entry/images/downloadIcon.jpg" Text="Download"  ToolTip="Download files" CommandArgument='<%#Eval("S/N")%>'/>
                             </ItemTemplate>
                         </asp:TemplateField>
                                <asp:TemplateField ShowHeader="False">
                             <ItemTemplate>
                                 <asp:ImageButton ID="ImageButton14" runat="server" CausesValidation="false" 
                                  CommandName="DeleteID" ImageUrl="~/images/property/del.png" Text="Delete" 
                                     Tooltip="Delete files"  CommandArgument='<%#Eval("S/N")%>'/>
                             </ItemTemplate>
                         </asp:TemplateField>
                     </Columns>
         ...
         <tr>
             <td class="style53">
                 ...
                 <asp:SqlDataSource ID="ItemDS" runat="server" 
                     ...
                     SelectCommand="SELECT DISTINCT ID AS [S/N], DocumentTitle AS [Document Title], ScanName AS [Scan Name], ScanType AS [Scan Type], SourceDocumentScan AS [Document] FROM WarrantyCheckTable">
                 </asp:SqlDataSource>

                                    <asp:Button ID="serachButton" runat="server" 
                     Text="Search by" 
                     Width="111px" UseSubmitBehavior="False" Visible="False" />
