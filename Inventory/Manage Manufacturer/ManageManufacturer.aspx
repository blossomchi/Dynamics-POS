<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_fc4mhnku" %>
...
var gv = document.getElementById("<%=ManufacturerGridView.ClientID%>");
...
<div class="xr_ap" id="xr_xr" 
    ...
    style="width: 1000px; height: 1345px; top:0px; left:50%; margin-left: -500px;">
 <script type="text/javascript">     var xr_xr = document.getElementById("xr_xr")</script>
 &nbsp;<!--[if IE]><div class="xr_ap" id="xr_xri" 
        
        
        
        style="width: 1000px; height: 1352px; clip: rect(0px 1000px 1600px 0px); top: 0px; left: 4px;"><![endif]-->
<!--[if !IE]>--><div class="xr_ap" id="xr_xri" 
            
            
            
            style="width: 1000px; height: 1344px; clip: rect(0px, 1000px, 1600px, 0px); top: 0px; left: 16px;"><!--<![endif]-->
<img class="xr_ap" src="index_htm_files/14.png" alt="" title="" 
 ...
 <table id="adminInfoTable" runat="server" 
     ...
     <table id="employeeTable" 
                ...
                style="position: absolute; top: 254px; left: 6px; width: 947px; height: 180px;">
         <tr>
             <td class="style2" colspan="2">
                 <strong>
                 <asp:Label ID="employeeMgtLabel" runat="server" Text="Manufacturer Management"></asp:Label>
                 <asp:TextBox ID="UpdateTextBox0" runat="server" 
                     ...
                     Font-Size="Medium" Visible="False">Add Manufacturer based on the product</asp:Label>
         ...
         <tr>
             <td class="style3" colspan="2">
                 <strong>
                     ...
                     Text=" ID" 
                     Width="88px" ToolTip="Search By Manufacturer ID" Visible="False" />
                                    <asp:Button ID="NameButton" runat="server" 
                     Text="Name" 
                     Width="88px" ToolTip="Search by Manufacturer Name" Visible="False" />
                 ...
                 <asp:Button ID="saveButton" runat="server" 
                     ...
                     Width="66px" ToolTip="Save Manufacturer" OnClientClick = "Confirm()" />
                 <asp:Button ID="BackButton" runat="server" Text="Back" Visible="False" 
                     Width="66px" />
                 <asp:Button ID="AddattributeButton" runat="server" Text="Add Manufacture" 
                     Width="132px" />
                                    </strong>
&nbsp;</td>
         </tr>
         <tr>
             <td class="style14" colspan="2">
                 ...
                 <asp:GridView ID="ManufacturerGridView" runat="server" 
                     AllowSorting="True" AutoGenerateColumns="False" BackColor="White" 
                     BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" 
                     DataKeyNames="ManuID" DataSourceID="ManufacturerSqlDataSource2" ForeColor="Black" 
                     GridLines="Vertical" Width="986px" Visible="False" AllowPaging="True" 
                     ShowFooter="True" PageSize="34" >
...
onclick = "Check_Click(this)"/>
                         ...
                         <asp:BoundField DataField="ManuID" HeaderText="Manufacturer ID" 
                             SortExpression="ManuID" ReadOnly="True" />
                         ...
                         <asp:TemplateField ShowHeader="False">
                             <ItemTemplate>
                                 <asp:ImageButton ID="ImageButton1" runat="server" CausesValidation="false" 
                                  CommandName="DeleteManufacturer" ImageUrl="~/images/property/del.png" Text="Delete" Tooltip="Delete" CommandArgument='<%#Eval("ManuID") %>'/>
                             </ItemTemplate>
                         </asp:TemplateField>
                     </Columns>
                 ...
                 <asp:GridView ID="findIDGridView" runat="server" 
                     AllowSorting="True" AutoGenerateColumns="False" BackColor="White" 
...
onclick = "Check_Click(this)"/>
                         ...
                         <asp:BoundField DataField="ManuID" HeaderText="Manufacturer ID" ReadOnly="True" 
                             SortExpression="ManuID" />
                         <asp:BoundField DataField="ManuName" HeaderText="Manufacturer Name" 
                             SortExpression="ManuName" ReadOnly="True" />
                         ...
                         <asp:TemplateField ShowHeader="False">
                             <ItemTemplate>
                                 <asp:ImageButton ID="ImageButton1" runat="server" CausesValidation="false" 
                                  CommandName="DeleteManu" ImageUrl="~/images/property/del.png" Text="Delete" Tooltip="Delete" CommandArgument='<%#Eval("SN") %>'/>
                             </ItemTemplate>
                         </asp:TemplateField>
                     </Columns>
                     <FooterStyle BackColor="#CCCCCC" />
                 ...
                 <asp:SqlDataSource ID="IDDataSource" runat="server" 
                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                     
                     SelectCommand="SELECT [SN], [ManuID], [ManuName], [Status] FROM [ManufacturerTable] WHERE ([ManuID] = @ManuID)" 
                     DeleteCommand="DELETE FROM ManufacturerTable WHERE (ManuID = @ManuID)">
                     <DeleteParameters>
                         <asp:Parameter Name="ManuID" />
                     </DeleteParameters>
                     <SelectParameters>
                         <asp:ControlParameter ControlID="findTextBox" Name="ManuID" PropertyName="Text" 
                             Type="String" />
                     </SelectParameters>
                 </asp:SqlDataSource>

                 <asp:GridView ID="findNameGridView" runat="server" 
                     AllowSorting="True" AutoGenerateColumns="False" BackColor="White" 
                     BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" 
                     CellPadding="3" ForeColor="Black" 
                     GridLines="Vertical" Width="989px" Visible="False" 
                     DataSourceID="FindManuNameDS">
                     <AlternatingRowStyle BackColor="#CCCCCC" />
                     <Columns>
                      <asp:TemplateField>
                     <HeaderTemplate>
...
onclick = "Check_Click(this)"/>
                         ...
                         <asp:BoundField DataField="ManuID" HeaderText="Manufacturer ID" ReadOnly="True" 
                             SortExpression="ManuID" />
                         <asp:BoundField DataField="ManuName" HeaderText="Manufacturer Name" 
                             ReadOnly="True" SortExpression="ManuName" />
                         <asp:BoundField DataField="Status" HeaderText="Status" ReadOnly="True" 
                             SortExpression="Status" />
                             <asp:TemplateField ShowHeader="False">
                                  <ItemTemplate>
                 ...
                 <asp:SqlDataSource ID="FindManuNameDS" runat="server" 
                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                     
                     SelectCommand="SELECT SN, ManuID, ManuName, Status FROM ManufacturerTable WHERE (ManuName = @ManuName)" 
                     DeleteCommand="DELETE FROM ManufacturerTable WHERE (ManuID = @ManuID)">
                     <DeleteParameters>
                         <asp:Parameter Name="ManuID" />
                     </DeleteParameters>
         ...
         <tr>
            ...
            visible="False">
                <tr>
                    <td class="style26" style="border-style: solid; border-width: 1px" colspan="2">
                ...
                <tr>
                    <td class="style26" style="border-style: solid; border-width: 1px">
                                    Manufacturer Code:</td>
                    <td class="style25" style="border-style: solid; border-width: 1px">
                        <strong>
                        <asp:TextBox ID="ManuCodeTextBox" runat="server" Width="103px" MaxLength="2"></asp:TextBox>
                        </strong>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="style25" style="border-style: solid; border-width: 1px">
                        <strong>
                        <asp:TextBox ID="ManuNameTextBox" runat="server" Width="103px"></asp:TextBox>
                        </strong>
                    </td>
                </tr>
                <tr>
     ...
     Status:</td>
                    <td class="style25" style="border-style: solid; border-width: 1px">
                        ...
                        <strong>
                        <asp:TextBox ID="statusTextBox" runat="server" Width="87px" 
                ...
                <tr>
                    <td class="style11" style="border-style: solid; border-width: 1px" colspan="2">
                        <asp:GridView ID="SearchGridView1" runat="server" AllowPaging="True" 
                            ...
                            DataSourceID="searchviewSqlDataSource2" ForeColor="Black" GridLines="Vertical" 
                            PageSize="4" Width="312px" DataKeyNames="ManuID" ShowFooter="True">
                            <AlternatingRowStyle BackColor="#CCCCCC" />
                            <Columns>
                        ...
                        <asp:GridView ID="SearchGridView2" runat="server" AllowPaging="True" 
                            ...
                            PageSize="4" Visible="False" Width="312px" DataKeyNames="ManuID" 
                            ShowFooter="True">
                            <AlternatingRowStyle BackColor="#CCCCCC" />
                            <Columns>
                                <asp:BoundField DataField="SN" HeaderText="SN" 
         ...
         <tr>
             <td class="style9">
                 ...
                 <asp:SqlDataSource ID="searchSqlDataSource2" runat="server" 
                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                     SelectCommand="SELECT SN, ManuID, ManuName FROM ManufacturerTable WHERE (ManuID = @ManuID)">
                     <SelectParameters>
                         <asp:ControlParameter ControlID="viewIDTextBox0" Name="ManuID" 
                             PropertyName="Text" />
                     </SelectParameters>
                 </asp:SqlDataSource>
                 <asp:SqlDataSource ID="searchviewSqlDataSource2" runat="server" 
                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                     SelectCommand="SELECT SN, ManuID, ManuName FROM ManufacturerTable">
                 </asp:SqlDataSource>
                                    </strong>
             ...
             <td class="style4">
                 ...
                 <asp:SqlDataSource ID="ManufacturerSqlDataSource2" runat="server" 
                     ...
                     SelectCommand="SELECT SN, ManuID, ManuName, Status, UpdateBy, DateCreated FROM ManufacturerTable ORDER BY ManuName">
                 </asp:SqlDataSource>
