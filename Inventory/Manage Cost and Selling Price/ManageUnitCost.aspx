<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_tj0c0wfx" %>
...
var gv = document.getElementById("<%=UnitCostGridView.ClientID%>");
...
<div class="xr_ap" id="xr_xr" 
     style="width: 1000px; height: 1599px; top:0px; left:50%; margin-left: -500px;">
 &nbsp;<script type="text/javascript">     var xr_xr = document.getElementById("xr_xr")</script>&nbsp;<!--[if IE]><div class="xr_ap" id="xr_xri"     
        style="width: 1000px; height: 1969px; clip: rect(0px 1000px 1600px 0px); top: 0px; left: 4px;"><![endif]-->
<!--[if !IE]>--><div class="xr_ap" id="xr_xri"           
            style="width: 1000px; height: 1600px; clip: rect(0px, 1000px, 1600px, 0px); top: 0px; left: 16px;"><!--<![endif]-->
<img class="xr_ap" src="index_htm_files/14.png" alt="" title="" 
 ...
 <table id="adminInfoTable" runat="server" 
         style="width: 442px; left: 530px; top: 142px; height: 42px; right: 28px; position: absolute;" 
         visible="true">
         <tr>
             <td class="style1" >
         ...
         <tr>
             <td class="style2" colspan="2">
                 ...
                 <asp:Label ID="employeeMgtLabel" runat="server" 
                     Text=" Manage Cost and Selling Price."></asp:Label>
                 <asp:TextBox ID="UpdateTextBox0" runat="server" 
                     ...
                     Font-Size="Medium" Visible="False">Add Cost and Selling Price.</asp:Label>
             ...
             <td class="style3" colspan="2">
                 ...
                 <asp:Button ID="btnDelete" runat="server" Text="Delete Selected" 
                     ...
                     Width="113px" ToolTip="Click to delete selected records" />
                        <asp:Button ID="UnitCostPerPiece" runat="server" 
                     Text="Add Cost Per ?." 
                     Width="141px" ToolTip="Click to add cost per piece or per yard..." />
                        <asp:Button ID="Wholesale" runat="server" 
                     Text="Add Wholesale QTY" 
                     Width="141px" />
                 ...
                 <asp:Button ID="AddattributeButton" runat="server" Text="Add Price" 
                     Width="100px" />
                                    </strong>
&nbsp;</td>
         </tr>
         <tr>
             ...
             <div style="overflow: auto; height: 1163px;">
                 <asp:GridView ID="UnitCostGridView" runat="server" 
                     AllowSorting="True" 
                     CellPadding="3" ForeColor="Black" 
                     GridLines="Vertical" Width="989px" PageSize="20" AllowPaging ="True" 
                     AutoGenerateColumns="False" 
                     DataSourceID="CostSelling" style="text-align: left; font-size: 12px;" 
                     DataKeyNames="Barcode" BackColor="White" BorderColor="#999999" 
...
OnClientClick = "Check_Click(this)"/>
                         ...
                         <asp:BoundField DataField="Item Des / Specification" 
                             HeaderText="Item Des / Specification" 
                             SortExpression="Item Des / Specification" />
                         <asp:BoundField DataField="Packaging Unit" HeaderText="Packaging Unit" 
                             SortExpression="Packaging Unit" />
                         <asp:BoundField DataField="Quantity Per Package" 
                             HeaderText="Quantity Per Package" SortExpression="Quantity Per Package" />
                         <asp:BoundField DataField="Cost Per Item in Package" 
                             HeaderText="Cost Per Package" 
                             SortExpression="Cost Per Item in Package" DataFormatString="{0:0,0.00}" />
                         <asp:BoundField DataField="Wholesale Price Level" 
                             HeaderText="Wholesale Price Level" SortExpression="Wholesale Price Level" />
                         <asp:BoundField DataField="Selling Per Item" HeaderText="Selling Per Item" 
                             SortExpression="Selling Per Item" DataFormatString="{0:0,0.00}" />
                 ...
                 <asp:SqlDataSource ID="CostSelling" runat="server" 
                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                     
                     SelectCommand="SELECT Barcode, [Item Des / Specification], [Packaging Unit], [Quantity Per Package], [Cost Per Item in Package], [Wholesale Price Level], [Selling Per Item] FROM Cost_And_Selling_Price ORDER BY [Item Des / Specification]">
                 </asp:SqlDataSource>

                 
                 

                 <asp:GridView ID="BarcodeGridView" runat="server" 
                     AllowSorting="True" AutoGenerateColumns="False" BackColor="White" 
                     BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" 
                     CellPadding="3" ForeColor="Black" 
                     GridLines="Vertical" Width="989px" Visible="False" 
                     DataSourceID="FindBarcode" AllowPaging="True" 
                     style="font-size: 12px" DataKeyNames="Barcode">
                     <AlternatingRowStyle BackColor="#CCCCCC" />
...
OnClientClick = "Check_Click(this)"/>
                         ...
                         <asp:BoundField DataField="Quantity Per Package" 
                             HeaderText="Quantity Per Package" SortExpression="Quantity Per Package" />
                         <asp:BoundField DataField="Cost Per Item in Package" 
                             DataFormatString="{0:0,0.00}" HeaderText="Cost Per Package" 
                             SortExpression="Cost Per Item in Package" />
                         <asp:BoundField DataField="Wholesale Price Level" 
                             HeaderText="Wholesale Price Level" SortExpression="Wholesale Price Level" />
                         <asp:BoundField DataField="Selling Per Item" DataFormatString="{0:0,0.00}" 
                             HeaderText="Selling Per Item" SortExpression="Selling Per Item" />
                              <asp:TemplateField ShowHeader="False">
                                  <ItemTemplate>
                                      <asp:ImageButton ID="ImageButton6" runat="server" CausesValidation="False" 
                                          CommandName="Select" ImageUrl="~/images/property/edit.png" Text="Select" 
                 ...
                 <asp:SqlDataSource ID="FindBarcode" runat="server" 
                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                     SelectCommand="SELECT Barcode, [Item Des / Specification], [Packaging Unit], [Quantity Per Package], [Cost Per Item in Package], [Wholesale Price Level], [Selling Per Item] FROM Cost_And_Selling_Price WHERE (Barcode = @Barcode) ORDER BY [Item Des / Specification]">
                     <SelectParameters>
                 ...
                 <asp:GridView ID="ItemDesGridView" runat="server" 
                     AllowSorting="True" AutoGenerateColumns="False" BackColor="White" 
                     BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" 
                     CellPadding="3" ForeColor="Black" 
         ...
         <tr>
             <td class="style83" colspan="2" valign="top">
                        ...
                        <table id="CostPriceTable" runat="server" visible="False" align="left" 
                            ...
                            style="background-position: center; border-style: solid; border-width: medium; width: 986px; background-image: url('images/eeee.gif'); background-repeat: repeat; height: 781px; background-color: #DBD8CA;"  >
                            <tr>
                 ...
                 <asp:Label ID="LBBarcode0" runat="server">Barcode :</asp:Label>
                    ...
                    <asp:Label ID="PriceTypeLabel0" runat="server" style="text-align: left; font-weight: 700;" 
                        Text="Enter Cost Price."></asp:Label>
                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                 <asp:CheckBox ID="modifyOnlySelling" runat="server" 
                                     Text="Modify Only Selling Price" Visible="False" />
                             </td>
                         </tr>
                         <tr>
                             <td class="style46">
                 ...
                 <asp:Button ID="CartonPerPieceButton" runat="server" Text="Get Cost Per Carton" Visible="False" 
                     Width="139px" Enabled="False" />
                         ...
                         <tr>
                            ...
                            Height="19px" Width="194px" AutoPostBack="True" DataSourceID="SqlDataSource1" 
                    ...
                    <asp:Label ID="PriceTypeLabel1" runat="server" style="text-align: left; font-weight: 700;" 
                        ...
                        <asp:TextBox ID="txtUnitQty0" runat="server" Width="93px" 
                         ...
                         <tr>
                             ...
                             <td class="style68">
                                 <strong>
                 <asp:Button ID="PricePerPieceButton" runat="server" Text="Calc Price Per Level" 
                     Width="139px" Visible="False" />
                                 </strong>
                             </td>
                         </tr>
                         <tr>
                     ...
                     Width="66px" ToolTip="Save Unit Cost and Selling Price" OnClientClick = "Confirm()" />
         ...
         <tr>
             <td class="style51" colspan="2" 
                 style="position: absolute; top: 80px; left: 300px;" valign="top">
                        ...
                        <table id="UnitCostPerPieceTable" runat="server" visible="False" align="center" 
                        ...
                        <asp:GridView ID="PriceLevelsGV0" runat="server" AllowPaging="True" 
                            AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" 
                            BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" 
                                     GridLines="Vertical" Width="203px" 
                            ShowFooter="True" Height="132px" PageSize="9" 
                                     DataSourceID="pieceDS" DataKeyNames="SN">
                            <AlternatingRowStyle BackColor="#CCCCCC" />
                            <Columns>
                                <asp:BoundField DataField="SN" HeaderText="SN" 
                                    SortExpression="SN" InsertVisible="False" ReadOnly="True" 
                                    Visible="False" />
                                <asp:BoundField DataField="PricePerUomName" HeaderText="Price Per Unit of Measurement Name" 
                                    SortExpression="PricePerUomName" />
                            </Columns>
                            <FooterStyle BackColor="#CCCCCC" />
                            <HeaderStyle BackColor="Black" Font-Bold="True" ForeColor="White" />
                            <PagerStyle BackColor="#999999" ForeColor="Black" HorizontalAlign="Center" />
                        ...
                        <asp:GridView ID="SearchPriceLevelsGV0" runat="server" AllowPaging="True" 
                            AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" 
                            BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" 
                                     GridLines="Vertical" Visible="False" Width="203px" 
                            ShowFooter="True" Height="132px" PageSize="2" 
                                     DataSourceID="SearchnameDS">
                            <AlternatingRowStyle BackColor="#CCCCCC" />
                            <Columns>
                                <asp:BoundField DataField="PricePerUomName" HeaderText="Price Per Unit of Measurement Name" 
                                    SortExpression="PricePerUomName" />
                            ...
                            <SortedDescendingHeaderStyle BackColor="#383838" />
                                    ...
                                    <asp:SqlDataSource ID="SearchnameDS" runat="server" 
                                        ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                                        SelectCommand="SELECT PricePerUomName FROM PricePerUoMNameTable WHERE (PricePerUomName = @per)">
                                        <SelectParameters>
                                            <asp:ControlParameter ControlID="txtName" Name="per" PropertyName="Text" />
                                        </SelectParameters>
                                    </asp:SqlDataSource>
                                    </td>
                            </tr>
                            ...
                            <tr>
                                <td class="style77" valign="top" colspan="2" >
                                 ...
                                 <strong style="font-weight: 700" >
                                    <asp:Button ID="saveName" runat="server" 
                     Text="Save" 
                     Width="66px" ToolTip="Save Unit of measurement name" />
                        &nbsp;<asp:Button ID="SearchName" runat="server" 
                     Text="Search" 
                     Width="66px" ToolTip="Search for Unit of measurement name" />
                        &nbsp;<strong ><asp:Button ID="CloseName" runat="server" 
                     Text="Close" 
                     Width="66px" ToolTip="Close" />
                        </strong>
                        </strong>
         ...
         <tr>
             <td class="style51" colspan="2">
                        ...
                        <asp:SqlDataSource ID="pieceDS" runat="server" 
                            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                            SelectCommand="SELECT [PricePerUomName], [SN] FROM [PricePerUoMNameTable]">
                        </asp:SqlDataSource>
                 ...
                 <strong>
                     ...
                     Width="41px" 
                        ...
                        <asp:TextBox ID="SellSN" runat="server" Visible="False" Width="36px" 
                            Wrap="False"></asp:TextBox>
                        <asp:TextBox ID="txtPendingBarcode" runat="server" Visible="False" Width="36px" 
                            Wrap="False"></asp:TextBox>
                                    </strong>
             </td>
         </tr>
