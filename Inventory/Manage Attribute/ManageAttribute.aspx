<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_scjg14wo" enableeventvalidation="false" %>
...
var gv = document.getElementById("<%=AttributeDefinitionGridView.ClientID%>");
...
return confirm("Do you want to delete " + count + " records.");
 ...
 <script type = "text/javascript">
     function Confirm() {
         ...
         if (confirm("Do you want to save this Attributes?")) {
...
<!--[if !IE]>--><div class="xr_ap" id="xr_xri" 
 ...
 <table id="adminInfoTable" runat="server" 
         style="width: 442px; left: 531px; top: 140px; height: 42px; right: 27px; position: absolute;" 
         visible="true">
         <tr>
             <td class="style1" >
     ...
     <table id="employeeTable" 
         ...
         <tr>
             <td class="style2" colspan="2">
                 <strong>
                 <asp:Label ID="employeeMgtLabel" runat="server" Text="Attribute Management"></asp:Label>
                 <asp:TextBox ID="UpdateTextBox0" runat="server" 
                     ...
                     Font-Size="Medium" Visible="False">Add Attribute</asp:Label>
         ...
         <tr>
             <td class="style3" colspan="2">
                 <strong>
                     ...
                     Text="Field Name" 
                     Width="88px" ToolTip="Search By Field Name" Visible="False" />
                                    <asp:Button ID="emailButton" runat="server" 
                     Text="Description" 
                     Width="83px" ToolTip="Search by description" Visible="False" />
                                    <asp:Button ID="NameButton" runat="server" 
                     Text="Field Type" 
                     Width="78px" ToolTip="Search by Field Type" Visible="False" />
                 ...
                 <asp:Button ID="saveButton" runat="server" 
                     ...
                     Width="66px" ToolTip="Save Attribute" onclientclick="Confirm()" />
                 <asp:Button ID="BackButton" runat="server" Text="Back" Visible="False" 
                     Width="66px" />
                                    </strong>
                 <asp:Button ID="AddattributeButton" runat="server" Text="Add Attribute" 
                     Width="96px" />
&nbsp;<asp:Button ID="DownloadButton" runat="server" Text="Download" Width="84px" />
             </td>
         </tr>
         <tr>
             <td class="style14" colspan="2">

                 <asp:GridView ID="AttributeDefinitionGridView" runat="server" 
                     AllowSorting="True" AutoGenerateColumns="False" BackColor="White" 
                     BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" 
                     DataKeyNames="SN" DataSourceID="AttributeSqlDataSource1" ForeColor="Black" 
...
onclick = "Check_Click(this)"/>
                         ...
                         <asp:BoundField DataField="MaxiLength" HeaderText="MaxiLength" 
                             SortExpression="MaxiLength" Visible="False" />
                         ...
                         <asp:BoundField DataField="RegisterDate" HeaderText="RegisterDate" 
                             SortExpression="RegisterDate" Visible="False" />
                         ...
                         <asp:TemplateField ShowHeader="False">
                             <ItemTemplate>
                                 <asp:ImageButton ID="ImageButton1" runat="server" CausesValidation="false" 
                                  CommandName="DeleteAttributeName" ImageUrl="~/images/property/del.png" Text="Delete" Tooltip="Delete" CommandArgument='<%#Eval("SN") %>'/>
                             </ItemTemplate>
                         </asp:TemplateField>
                     </Columns>
                 ...
                 <asp:GridView ID="findFieldNameGridView" runat="server" 
                     AllowSorting="True" AutoGenerateColumns="False" BackColor="White" 
                     BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" 
                     CellPadding="3" ForeColor="Black" 
                     GridLines="Vertical" Width="989px" Visible="False" 
                     DataSourceID="findSqlDataSource1" DataKeyNames="SN" AllowPaging="True">
                     <AlternatingRowStyle BackColor="#CCCCCC" />
                     <Columns>
                      <asp:TemplateField Visible="False">
                     <HeaderTemplate>
...
onclick = "Check_Click(this)"/>
 ...
 <asp:TemplateField ShowHeader="False">
                 ...
                 <asp:GridView ID="findFieldDesGridView" runat="server" 
                     AllowSorting="True" AutoGenerateColumns="False" BackColor="White" 
                     BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" 
                     CellPadding="3" ForeColor="Black" 
                     GridLines="Vertical" Width="989px" Visible="False" 
                     DataSourceID="emailSqlDataSource1" DataKeyNames="SN" AllowPaging="True">
                     <AlternatingRowStyle BackColor="#CCCCCC" />
                     <Columns>
                      <asp:TemplateField Visible="False">
                     <HeaderTemplate>
...
onclick = "Check_Click(this)"/>
                 ...
                 <asp:GridView ID="findFieldTypeGridView" runat="server" 
                     AllowSorting="True" AutoGenerateColumns="False" BackColor="White" 
                     BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" 
                     CellPadding="3" ForeColor="Black" 
                     GridLines="Vertical" Width="989px" Visible="False" 
                     DataSourceID="nameSqlDataSource1" DataKeyNames="SN" AllowPaging="True">
                     <AlternatingRowStyle BackColor="#CCCCCC" />
                     <Columns>
                      <asp:TemplateField Visible="False">
                     <HeaderTemplate>
...
onclick = "Check_Click(this)"/>
         ...
         <tr>
             <td class="style24">
                 <table style="width: 511px" id="AddEmployeeTable" runat="server" 
            visible="False" align="left">
                <tr>
                    <td class="style22" style="border-style: solid; border-width: 1px">
                        Field Name:</td>
                    <td class="style15" style="border-style: solid; border-width: 1px">
                        <strong>
                        <asp:TextBox ID="FieldnameTextBox" runat="server" Width="103px" 
                ...
                <tr>
                    ...
                    <td class="style15" style="border-style: solid; border-width: 1px">
                        <strong>
                        <asp:TextBox ID="DescriptionTextBox" runat="server" Width="103px"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td class="style15" style="border-style: solid; border-width: 1px">
                        ...
                        <asp:TextBox ID="selectTextBox" runat="server" Width="103px" ReadOnly="True"></asp:TextBox>
                        <asp:Button ID="AddButton0" runat="server" 
                     Text="Click to Select Field Type" 
                     Width="165px" />
                        <table id="imageTable" runat="server" visible="False"  >
                            <tr>
                                <td class="style19"  >
                        
                        <asp:ImageButton ID="textImageButton" runat="server" 
                            ImageUrl="~/images/property/textbox-button.gif" Width="115px" Height="32px" />
                        
                                </td>
                                <td class="style21"  >
                        
                        <asp:ImageButton ID="dropImageButton" runat="server" 
                            ImageUrl="~/images/property/dropdown-button.gif" Width="115px" Height="32px" />
                        ...
                        <asp:ImageButton ID="radioImageButton" runat="server" 
                            ImageUrl="~/images/property/radio-button.gif" Width="115px" Height="32px" />
                        
                                </td>
                                <td class="style18"  >
                        
                        <asp:ImageButton ID="checkImageButton" runat="server" 
                            ImageUrl="~/images/property/checkbox-button.gif" Width="115px" 
                        ...
                        <asp:ImageButton ID="dropImageButton0" runat="server" 
                            ImageUrl="~/images/property/date2.jpg" Width="115px" Height="32px" />
                        ...
                        <asp:ImageButton ID="checkImageButton0" runat="server" 
                            ImageUrl="~/images/property/serial no.jpg" Width="115px" 
                                        style="text-align: left" Height="34px" Visible="False" />
...
&nbsp;
     ...
     Status:</td>
                ...
                <tr>
                    <td class="style22" style="border-style: solid; border-width: 1px">
                        <asp:Label ID="Label7" runat="server" Visible="False" Text="Length"></asp:Label></td>
                    <td class="style7" style="border-style: solid; border-width: 1px">
                        <strong>
                        <asp:TextBox ID="maxlengthTextBox" runat="server" Width="101px" 
                            style="text-align: left" Visible="False" MaxLength="100" 
                            ToolTip="Min 0, Max 100"></asp:TextBox>
                        &nbsp;<asp:Label ID="MSGLabel2" runat="server" ForeColor="Red" Visible="False">Maximum length should not be more than 100 characters.</asp:Label>
                        </strong>
                    </td>
                </tr>
                </table>
             ...
             <td class="style9">
                        <asp:GridView ID="SearchGridView1" runat="server" AllowPaging="True" 
                            ...
                            DataSourceID="AttributeDataSource" ForeColor="Black" 
                     GridLines="Vertical" Width="312px" DataKeyNames="AttributeID" 
                     ShowFooter="True" Visible="False">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="AttributeID" HeaderText="Attribute ID" 
                                    SortExpression="AttributeID" ReadOnly="True" />
                                <asp:BoundField DataField="FieldName" HeaderText="Attribute Name" 
                                    SortExpression="FieldName" />
                            </Columns>
                            <FooterStyle BackColor="#CCCCCC" />
                            <HeaderStyle BackColor="Black" Font-Bold="True" ForeColor="White" />
         ...
         <tr>
             <td class="style24">
                 <asp:SqlDataSource ID="emailSqlDataSource1" runat="server" 
                     ...
                     SelectCommand="SELECT SN, FieldName, Description, FieldType, Status, RegisterDate FROM AttributeDefinitionTable WHERE (Description = @Description)">
                     <SelectParameters>
                         <asp:ControlParameter ControlID="findTextBox" Name="Description" 
                             PropertyName="Text" />
                     </SelectParameters>
                     <UpdateParameters>
                     ...
                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                            ...
                            SelectCommand="SELECT [SN], [AttributeID], [FieldName] FROM [AttributeDefinitionTable] ORDER BY [FieldName]">
                 </asp:SqlDataSource>
                 ...
                 <asp:SqlDataSource ID="AttributeSqlDataSource1" runat="server" 
                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                     SelectCommand="SELECT SN, AttributeID, FieldName, Description, MaxiLength, FieldType, Status, RegisterDate FROM AttributeDefinitionTable ORDER BY FieldName"
                     UpdateCommand="UPDATE AttributeDefinitionTable SET Status = @Status WHERE (SN = @SN)" 
                     >
                     <UpdateParameters>
                         <asp:Parameter Name="Status" />
             ...
             <td class="style4">
                 <asp:SqlDataSource ID="nameSqlDataSource1" runat="server" 
                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
                     UpdateCommand="UPDATE AttributeDefinitionTable SET Status = @Status WHERE (SN = @SN)" 
                     
                     SelectCommand="SELECT SN, FieldName, Description, FieldType, Status, RegisterDate FROM AttributeDefinitionTable WHERE (FieldType = @FieldType)">
                     <SelectParameters>
                         <asp:ControlParameter ControlID="findTextBox" Name="FieldType" 
                             PropertyName="Text" />
                     </SelectParameters>
                     <UpdateParameters>
                         <asp:Parameter Name="Status" />
