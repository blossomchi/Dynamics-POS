<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_clehkra4" %>
...
<meta name="XAR Files" content="index_htm_files/xr_files.txt"/>
 <title>Manage Special Price</title>
...
var gv = document.getElementById("<%=UnitGridView.ClientID%>");
...
<div class="xr_ap" id="xr_xr" 
    ...
    style="width: 1000px; height: 1416px; top:0px; left:50%; margin-left: -500px;">
 <script type="text/javascript">     var xr_xr = document.getElementById("xr_xr")</script>
 &nbsp;<!--[if IE]><div class="xr_ap" id="xr_xri" 
        
        
        
        style="width: 1000px; height: 1405px; clip: rect(0px 1000px 1600px 0px); top: 0px; left: 4px;"><![endif]-->
<!--[if !IE]>--><div class="xr_ap" id="xr_xri" 
            
            
            
            style="width: 1000px; height: 1400px; clip: rect(0px, 1000px, 1600px, 0px); top: 0px; left: 16px;"><!--<![endif]-->
         ...
         <tr>
             <td class="style2" colspan="2">
                 ...
                 <asp:Label ID="employeeMgtLabel" runat="server" 
                     Text="Special Price Management."></asp:Label>
                 <asp:TextBox ID="UpdateTextBox0" runat="server" 
                     ...
                     Font-Size="Medium" Visible="False">Add Special Price.</asp:Label>
             ...
             <td class="style3" colspan="2">
                 ...
                 <asp:Button ID="btnDelete" runat="server" Text="Delete Selected" 
                     ...
                     Width="113px" ToolTip="Click to delete selected records" />
                        <asp:Button ID="NewReason" runat="server" 
                     Text="Create Reason." 
                     Width="112px" />
                 ...
                 <asp:Button ID="BackButton" runat="server" Text="Back" Visible="False" 
                     Width="66px" />
                 <asp:Button ID="AddattributeButton" runat="server" Text="Create Special Price" 
                     Width="147px" />
                                    </strong>
&nbsp;</td>
         </tr>
         <tr>
             <td class="style14" colspan="2">
                 ...
                 <asp:GridView ID="UnitGridView" runat="server" 
                     AllowSorting="True" AutoGenerateColumns="False" BackColor="White" 
                     BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" 
                     CellPadding="3" DataSourceID="UnitSqlDataSource1" ForeColor="Black" 
                     GridLines="Vertical" Width="986px" Visible="False" AllowPaging="True" 
                     ShowFooter="True" style="text-align: left; font-size: 12px;" 
                     PageSize="26" >
...
onclick = "Check_Click(this)"/>
                         ...
                         <asp:BoundField DataField="Itemdes" HeaderText="Item Description" 
                             SortExpression="Itemdes" />
                              <asp:BoundField DataField="EffectiveDate" HeaderText="Start Date" SortExpression="EffectiveDate"/>
                         <asp:BoundField DataField="EndDate" HeaderText="End Date" SortExpression="EndDate"/>
                         <asp:BoundField DataField="SellingPrice" HeaderText="New Selling Price" 
                             SortExpression="SellingPrice" DataFormatString="{0:0,0.0}" />
                          ...
                          <asp:TemplateField ShowHeader="False">
                             <ItemTemplate>
                                 <asp:ImageButton ID="ImageButton1" runat="server" CausesValidation="false" 
                                  CommandName="Delete" ImageUrl="~/images/property/del.png" Text="Delete" Tooltip="Delete" CommandArgument='<%#Eval("Barcode") %>'/>
                             </ItemTemplate>
                         </asp:TemplateField>
                     </Columns>
                 ...
                 <asp:SqlDataSource ID="UnitSqlDataSource1" runat="server" 
                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
                     UpdateCommand="UPDATE UnitTable SET Status = @Status WHERE (SN = @SN)"
                     ...
                     SelectCommand="SELECT ID, Barcode, Itemdes, ExpiryMFGDate, Duration, SellingPrice, EffectiveDate, EndDate FROM ReducedPriceTable ORDER BY ID">
                     <UpdateParameters>
                         <asp:Parameter Name="Status" />
                         <asp:Parameter Name="SN" />
                     </UpdateParameters></asp:SqlDataSource>

                 <asp:GridView ID="findUnitNameGridView" runat="server" 
                     AllowSorting="True" AutoGenerateColumns="False" BackColor="White" 
                     BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" 
                     CellPadding="3" ForeColor="Black" 
                     GridLines="Vertical" Width="989px" Visible="False" 
                     DataSourceID="emailSqlDataSource1" style="font-size: 12px">
                     <AlternatingRowStyle BackColor="#CCCCCC" />
...
onclick = "Check_Click(this)"/>
         ...
         <tr>
             <td class="style14" colspan="2" valign="top">
                        ...
                        <table id="imageTable" runat="server" visible="False" 
                     
                            
                            style="background-image: url('images/eeee.gif'); background-repeat: repeat; background-position: center; border-style: solid; background-color: #DBD8CA;"  >
                            <tr>
                                <td class="style19" valign="top" 
                                    style=""  >
                        
                 <asp:Label ID="LBExpiryDate1" runat="server" style="text-align: right">Select Barcode:</asp:Label>
                        ...
                        <asp:DropDownList ID="cbFreeItem" runat="server" AutoPostBack="True" 
                            ...
                            class="chosen-select" Width="322px" style="text-align: left" Height="16px">
                        </asp:DropDownList>
                 <strong>
                                ...
                                <td class="style19" valign="top" rowspan="5" colspan="3"  >
                        
                 <asp:GridView ID="ExpiryMFG" runat="server" AllowPaging="True" 
                     AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" 
                     BorderStyle="Solid" BorderWidth="1px" CellPadding="3" 
                     DataSourceID="ExpiryDS" ForeColor="Black" GridLines="Vertical" style="margin-left: 0px" 
                                        Visible="False" Width="274px" Height="30px">
                     <AlternatingRowStyle BackColor="#CCCCCC" />
                     <Columns>
                 ...
                 <asp:Label ID="LBExpiryDate2" runat="server" style="text-align: right">Item Description:</asp:Label>
                                ...
                                <td class="style30" valign="top"  >
                                 ...
                                 <strong >
                        <asp:TextBox ID="txtItemDescription" runat="server" Width="320px" 
                 ...
                 <asp:Label ID="LBExpiryDate10" runat="server" style="text-align: right">Serial Number:</asp:Label>
                            ...
                            Width="322px" DataSourceID="SerialNumberDS" 
                 ...
                 <asp:Label ID="LBExpiryDate11" runat="server" style="text-align: right">IMEI:</asp:Label>
                            ...
                            Width="322px" DataSourceID="IMEIDS" 
                 ...
                 <asp:Label ID="LBExpiryDate3" runat="server" style="text-align: right">Product No:</asp:Label>
                        
                                </td>
                                <td class="style19" valign="top"  >
                        
                        <strong>
                        <asp:TextBox ID="txtProductNo" runat="server" Width="321px" ReadOnly="True"></asp:TextBox>
                        </strong>
                 ...
                 <asp:Label ID="LBExpiryDate5" runat="server" style="text-align: right">Selling Price:</asp:Label>
                        
                                </td>
                                <td class="style81" valign="top"  >
                        
                        <strong>
                        <asp:TextBox ID="txtSellingPrice" runat="server" Width="321px"></asp:TextBox>
                        </strong>
                        
                                </td>
                                <td class="style81" valign="top"  >
                        
                 <asp:Label ID="LBExpiryDate7" runat="server" style="text-align: right">Expiry Date:</asp:Label>
                        
                                </td>
                                <td class="style81" valign="top" colspan="2"  >
                        
                        <strong>
                        <asp:TextBox ID="txtExpiryDate" runat="server" Width="114px" ReadOnly="True"></asp:TextBox>
                        </strong>
                 ...
                 <asp:Label ID="LBExpiryDate6" runat="server" style="text-align: right">Reason:</asp:Label>
                            ...
                            Width="321px" DataSourceID="ReasonDS" 
                 ...
                 <asp:Label ID="LBExpiryDate4" runat="server" style="text-align: right">Duration to Expiry Date:</asp:Label>
                        
                                </td>
                                <td class="style32" valign="top"  >
                        
                        <strong>
                        <asp:TextBox ID="txtDuration" runat="server" Width="114px"></asp:TextBox>
                        </strong>
                 ...
                 <asp:Label ID="LBExpiryDate8" runat="server" style="text-align: right">Effective Date:</asp:Label>
                        
                                </td>
                                <td class="style80" valign="top"  >
                        
                        <strong>
                        <asp:TextBox ID="txtEffectiveDate" runat="server" Width="321px" ReadOnly="True"></asp:TextBox>
                        
                        

                                    <asp:ImageButton ID="ImageButton18" runat="server" 
                                        ImageUrl="~/images/property/calendar.png" ToolTip="Click to select effective date" 
                 ...
                 <asp:Button ID="saveButton0" runat="server" 
                     Text="Cal. Effective Date" 
                     Width="132px" Enabled="False" />
                                    </strong>
                 ...
                 <asp:Label ID="LBExpiryDate9" runat="server" style="text-align: right">End Date:</asp:Label>
                        
                                </td>
                                <td class="style19" valign="top"  >
                        
                        <strong>
                        <asp:TextBox ID="txtEndDate" runat="server" Width="321px" ReadOnly="True"></asp:TextBox>
                        
                        

                                    <asp:ImageButton ID="ImageButton17" runat="server" 
                                        ImageUrl="~/images/property/calendar.png" ToolTip="Click to select end date" 
                                        Width="24px" />
                 ...
                 <asp:Button ID="saveButton" runat="server" 
                     Text="Save New Price" Visible="False" 
                     Width="188px" ToolTip="Save New Price" OnClientClick = " " Enabled="False" />
                                    </strong>
         ...
         <tr>
             <td class="style14" colspan="2" valign="top" 
                 ...
                 style="border-style: none; width: 554px;  position: absolute; top: 90px; left: 200px;" 
                 align="center">

                        <table id="NewReasonTable" runat="server" visible="False" 
                            ...
                            <tr>
                                <td class="style74" valign="top" colspan="2" >
                                    ...
                                    <strong>Create Reason For Reduction......</strong></td>
                                <td class="style73" valign="top" align="left" rowspan="3" >
                      
                        

                        <asp:GridView ID="ReasonGV" runat="server" AllowPaging="True" 
                            AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" 
                            BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" 
                                     GridLines="Vertical" Width="241px" 
                            ShowFooter="True" Height="132px" PageSize="9" 
                                     DataSourceID="RoleDS" DataKeyNames="Id">
                            <AlternatingRowStyle BackColor="#CCCCCC" />
                            <Columns>
                             ...
                             <ItemTemplate>
                                 <asp:ImageButton ID="ImageButton8" runat="server" CausesValidation="false" 
                                  CommandName="DeleteReason" ImageUrl="~/images/property/del.png" Text="Delete" Tooltip="Delete" CommandArgument='<%#Eval("Id") %>'/>
                             </ItemTemplate>
                         </asp:TemplateField>
                            </Columns>
                            <FooterStyle BackColor="#CCCCCC" />
                            ...
                            <tr>
                                ...
                                <td class="style69" valign="top" >
                                 ...
                                 <strong>
                                 <asp:TextBox ID="txtCreateReason" runat="server" 
         ...
         <tr>
             <td class="style9">
                 <asp:SqlDataSource ID="emailSqlDataSource1" runat="server" 
                     ...
                     SelectCommand="SELECT ID, Barcode, Itemdes, ExpiryMFGDate, Duration, SellingPrice, EffectiveDate, EndDate FROM ReducedPriceTable WHERE (Barcode = @Barcode)" 
                 ...
                 <strong>
                     ...
                     SelectCommand="SELECT DISTINCT StockDetailsTable.StockID, StockDetailsTable.IMEI, StockLocationTable.StoreName FROM StockDetailsTable INNER JOIN StockLocationTable ON StockDetailsTable.StockLocationID = StockLocationTable.StockLocationID WHERE (StockDetailsTable.StockID = @Barcode) AND (StockLocationTable.StoreName LIKE N'%Showroom')">
                                        <SelectParameters>
                                            <asp:ControlParameter ControlID="cbFreeItem" Name="Barcode" 
                                                PropertyName="SelectedValue" />
                                        </SelectParameters>
                 </asp:SqlDataSource>
                 <asp:SqlDataSource ID="SerialNumberDS" runat="server" 
                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                     
                     SelectCommand="SELECT DISTINCT StockDetailsTable.StockID, StockDetailsTable.SerialNumber, StockLocationTable.StoreName FROM StockDetailsTable INNER JOIN StockLocationTable ON StockDetailsTable.StockLocationID = StockLocationTable.StockLocationID WHERE (StockDetailsTable.StockID = @Barcode) AND (StockLocationTable.StoreName LIKE N'%Showroom')">
                     <SelectParameters>
                         <asp:ControlParameter ControlID="cbFreeItem" Name="Barcode" 
                             PropertyName="SelectedValue" />
                     </SelectParameters>
                     ...
                     SelectCommand="SELECT Id, Reason FROM ReducedPriceReasons ORDER BY Reason">
                                    </asp:SqlDataSource>
                 <asp:SqlDataSource ID="ReasonDS" runat="server" 
                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                     SelectCommand="SELECT [Id], [Reason] FROM [ReducedPriceReasons]">
                 </asp:SqlDataSource>
                 <asp:SqlDataSource ID="ExpiryDS" runat="server" 
                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                     
                     SelectCommand="SELECT StockDetailsTable.ExpiryDate, StockDetailsTable.MFGDate, StockLocationTable.StoreName FROM StockDetailsTable INNER JOIN StockLocationTable ON StockDetailsTable.StockLocationID = StockLocationTable.StockLocationID WHERE (StockDetailsTable.StockID = @Barcode) AND (StockLocationTable.StoreName LIKE N'%Showroom')">
                     <SelectParameters>
                         <asp:ControlParameter ControlID="cbFreeItem" Name="Barcode" 
                             PropertyName="SelectedValue" />
                     </SelectParameters>
             ...
             <td class="style4">
                        ...
                        <strong>
                        <asp:TextBox ID="statusTextBox" runat="server" Visible="False" Width="36px" 
                            Wrap="False"></asp:TextBox>
                        <asp:TextBox ID="statusTextBox0" runat="server" Visible="False" Width="91px"></asp:TextBox>
                        <asp:TextBox ID="UnitTextBox" runat="server" Visible="False" Width="36px" 
                            Wrap="False"></asp:TextBox>
                        <asp:TextBox ID="NewTextBox" runat="server" Visible="False" Width="36px" 
                            Wrap="False"></asp:TextBox>
                        </strong>
