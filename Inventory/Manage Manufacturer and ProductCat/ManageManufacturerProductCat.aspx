<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_phxj4pej" %>
...
<meta name="XAR Files" content="index_htm_files/xr_files.txt"/>
 <title>Manage Manufacturer/Product Category</title>
...
<img class="xr_ap" src="index_htm_files/14.png" alt="" title="" 
 ...
 <table id="adminInfoTable" runat="server" 
     ...
     <table id="employeeTable" 
                ...
                style="position: absolute; top: 252px; left: 6px; width: 947px; height: 180px;">
         <tr>
             <td class="style2">
                 <strong>
                 <asp:Label ID="employeeMgtLabel" runat="server" 
                     Text="Product / Manufacturer Management"></asp:Label>
                 <asp:TextBox ID="UpdateTextBox0" runat="server" 
                     ...
                     Font-Size="Medium" Visible="False">Add Product/Manufacturer.</asp:Label>
         ...
         <tr>
             <td class="style3" colspan="2">
                 <strong>
                     ...
                     Text=" Product" 
                     Width="88px" ToolTip="Search By Product Name" Visible="False" />
                                    <asp:Button ID="NameButton" runat="server" 
                     Text="Manufacturer" 
                     Width="108px" ToolTip="Search by Manufacturer Name" Visible="False" />
         ...
         <tr>
             <td class="style14" colspan="2">
                 ...
                 <asp:GridView ID="ManufacturerGridView" runat="server" 
                     ...
                     DataKeyNames="SN" DataSourceID="ManufacturerProductDS" ForeColor="Black" 
...
onclick = "Check_Click(this)"/>
                 ...
                 <asp:SqlDataSource ID="ManufacturerProductDS" runat="server" 
                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                     
                     
                     SelectCommand="SELECT ManufacturerProductCategoryTable.ManuID, ManufacturerProductCategoryTable.PCatID, ManufacturerTable.ManuName, ProductCatTable.ProductCatName, ManufacturerProductCategoryTable.SN FROM ManufacturerProductCategoryTable INNER JOIN ManufacturerTable ON ManufacturerProductCategoryTable.ManuID = ManufacturerTable.ManuID INNER JOIN ProductCatTable ON ManufacturerProductCategoryTable.PCatID = ProductCatTable.PCatID ORDER BY ProductCatTable.ProductCatName, ManufacturerTable.ManuName">
                 </asp:SqlDataSource>
                 ...
                 <asp:GridView ID="findIDGridView" runat="server" 
                     ...
                     DataSourceID="emailSqlDataSource1" DataKeyNames="ManuID">
                     <AlternatingRowStyle BackColor="#CCCCCC" />
                     <Columns>
                     <asp:TemplateField>
                     <HeaderTemplate>
...
onclick = "Check_Click(this)"/>
                         ...
                         <asp:BoundField DataField="ManuID" HeaderText="ManuID" Visible="False" />
                         <asp:BoundField DataField="PCatID" HeaderText="PCatID" Visible="False" />
                         <asp:BoundField DataField="ProductCatName" 
                 ...
                 <asp:GridView ID="findNameGridView" runat="server" 
                     ...
                     CellPadding="3" ForeColor="Black" 
                     GridLines="Vertical" Width="989px" Visible="False" 
                     DataSourceID="ManuNameSqlDataSource2" DataKeyNames="ManuID">
                     <AlternatingRowStyle BackColor="#CCCCCC" />
                     <Columns>
                     <asp:TemplateField>
                     <HeaderTemplate>
...
onclick = "Check_Click(this)"/>
                 ...
                 <asp:SqlDataSource ID="ManuNameSqlDataSource2" runat="server" 
                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                     
                     
                     
                     
                     SelectCommand="SELECT ManufacturerProductCategoryTable.PCatID, ManufacturerProductCategoryTable.SN, ManufacturerProductCategoryTable.ManuID, ManufacturerTable.ManuName, ProductCatTable.ProductCatName FROM ManufacturerProductCategoryTable INNER JOIN ManufacturerTable ON ManufacturerProductCategoryTable.ManuID = ManufacturerTable.ManuID INNER JOIN ProductCatTable ON ManufacturerProductCategoryTable.PCatID = ProductCatTable.PCatID WHERE (ManufacturerTable.ManuName = @ManuName)">
                     <SelectParameters>
         ...
         <tr>
             <td class="style9" colspan="2">
                 <table style="width: 739px" id="AddEmployeeTable" runat="server" 
            visible="False" align="center">
                ...
                <tr>
                    <td class="style26" style="border-style: solid; border-width: 1px">
                                    Product Group:</td>
                    <td class="style25" style="border-style: solid; border-width: 1px">
                        <asp:DropDownList ID="CBProductCat" runat="server" 
                            DataSourceID="CatSqlDataSource2" DataTextField="ProductCatName" 
                            DataValueField="PCatID" Height="16px" Width="156px">
                        </asp:DropDownList>
                        <strong>
                ...
                <tr>
                    ...
                    <td class="style25" style="border-style: solid; border-width: 1px">
                        <asp:DropDownList ID="CBManufacturer" runat="server" 
                            DataSourceID="ManufacturerDS" DataTextField="ManuName" DataValueField="ManuID" 
                            Height="20px" Width="157px">
                        </asp:DropDownList>
                        <strong>
                        <asp:TextBox ID="txtManufacturerName" runat="server" Width="34px" MaxLength="2" 
                            Visible="False"></asp:TextBox>
                        </strong>
                    </td>
                </tr>
                <tr>
                 ...
                 <asp:SqlDataSource ID="emailSqlDataSource1" runat="server" 
                     ...
                     SelectCommand="SELECT ManufacturerProductCategoryTable.PCatID, ManufacturerProductCategoryTable.ManuID, ManufacturerProductCategoryTable.SN, ProductCatTable.ProductCatName, ManufacturerTable.ManuName FROM ManufacturerProductCategoryTable INNER JOIN ProductCatTable ON ManufacturerProductCategoryTable.PCatID = ProductCatTable.PCatID INNER JOIN ManufacturerTable ON ManufacturerProductCategoryTable.ManuID = ManufacturerTable.ManuID WHERE (ProductCatTable.ProductCatName = @ProductCatName)">
                     <SelectParameters>
                 ...
                 <asp:SqlDataSource ID="ManufacturerDS" runat="server" 
                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                     SelectCommand="SELECT [ManuID], [ManuName], [SN] FROM [ManufacturerTable]">
                 </asp:SqlDataSource>
             </td>
         </tr>
         <tr>
