<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_pch1nflm" enableeventvalidation="false" %>
     ...
     <table id="employeeTable" 
         ...
         <tr>
             <td class="style2" colspan="2">
                 <strong>
                 <asp:Label ID="employeeMgtLabel" runat="server" Text="Category Management"></asp:Label>
                 <asp:TextBox ID="UpdateTextBox0" runat="server" 
                     ...
                     Font-Size="Medium" Visible="False">Add Category</asp:Label>
         ...
         <tr>
             <td class="style3" colspan="2">
                 <strong>
                     ...
                     Text="Category ID" 
                     Width="107px" ToolTip="Search By Category ID" Visible="False" />
                                    <asp:Button ID="NameButton" runat="server" 
                     Text="Category Name" 
                     Width="116px" ToolTip="Search by Category Name" Visible="False" />
                 ...
                 <asp:Button ID="saveButton" runat="server" 
                     ...
                     Width="66px" ToolTip="Save Category" OnClientClick = "Confirm()" />
                 <asp:Button ID="BackButton" runat="server" Text="Back" Visible="False" 
                     Width="66px" />
                 <asp:Button ID="AddattributeButton" runat="server" Text="Add Category" 
                     Width="113px" />
                                    </strong>
&nbsp;<asp:Button ID="DownloadButton" runat="server" Text="Download" Width="80px" />
             </td>
         </tr>
         <tr>
             <td class="style14" colspan="2">
                 ...
                 <asp:GridView ID="CategoryGridView" runat="server" 
                     ...
                     DataKeyNames="PCatID" DataSourceID="CategorySqlDataSource1" ForeColor="Black" 
                     ...
                     <HeaderTemplate>
                      <asp:CheckBox ID="chkAll" runat="server" 
                               onclick = "checkAll(this);" /> </HeaderTemplate> 
                               <ItemTemplate>
...
onclick = "Check_Click(this)"/>
                         ...
                         <asp:BoundField DataField="PCatID" HeaderText="Cat ID" ReadOnly="True" 
                         ...
                         <asp:BoundField DataField="UpdateBy" HeaderText="UpdateBy" 
                             ...
                             SelectImageUrl="~/images/property/edit.png" ShowSelectButton="True" />
                 ...
                 <asp:GridView ID="findCatIDGridView" runat="server" 
                     AllowSorting="True" AutoGenerateColumns="False" BackColor="White" 
                     BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" 
                     DataKeyNames="PCatID" DataSourceID="findIDSqlDataSource2" ForeColor="Black" 
                     GridLines="Vertical" Width="986px" Visible="False" AllowPaging="True" 
...
onclick = "Check_Click(this)"/>
                 ...
                 <asp:GridView ID="findCatNameGridView" runat="server" 
                     AllowSorting="True" AutoGenerateColumns="False" BackColor="White" 
                     BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" 
                     DataKeyNames="PCatID" DataSourceID="findNameSqlDataSource2" ForeColor="Black" 
                     GridLines="Vertical" Width="986px" Visible="False" AllowPaging="True" 
                     ShowFooter="True" PageSize="5" >
                     <AlternatingRowStyle BackColor="#CCCCCC" />
                     <Columns>
...
onclick = "Check_Click(this)"/>
                         ...
                         <asp:BoundField DataField="SN" HeaderText="SN" ReadOnly="True" 
                             SortExpression="SN" InsertVisible="False" Visible="False" />
                   
                         <asp:BoundField DataField="PCatID" HeaderText="Cat ID" 
                             ReadOnly="True" SortExpression="PCatID" />
                         <asp:BoundField DataField="ProductCatName" HeaderText="Product Group" 
                             SortExpression="ProductCatName" />
                               <asp:BoundField DataField="Status" HeaderText="Status" 
                             SortExpression="Status" />
                 ...
                 <asp:SqlDataSource ID="findNameSqlDataSource2" runat="server" 
                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                      DeleteCommand="DELETE FROM ProductCatTable WHERE (PCatID = @PCatID)"
                     UpdateCommand="UPDATE ProductCatTable SET Status = @Status WHERE (SN = @SN)"
                     
                     
                     SelectCommand="SELECT SN, PCatID, ProductCatName, Status, DateCreated, CreatedBy, DateUpdated, UpdateBy FROM ProductCatTable WHERE (ProductCatName = @ProductName)">
                    <SelectParameters>
                         <asp:ControlParameter ControlID="findTextBox" Name="ProductName" 
                             PropertyName="Text" />
                     </SelectParameters>
                      <DeleteParameters>
                         <asp:Parameter Name="PCatID" />
                     </DeleteParameters>
                     <UpdateParameters>
                 ...
                 <asp:SqlDataSource ID="findIDSqlDataSource2" runat="server" 
                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
                       DeleteCommand="DELETE FROM ProductCatTable WHERE (PCatID = @PCatID)"
                     UpdateCommand="UPDATE ProductCatTable SET Status = @Status WHERE (SN = @SN)"
                     ...
                     SelectCommand="SELECT SN, PCatID, ProductCatName, Status, DateCreated, CreatedBy, DateUpdated, UpdateBy FROM ProductCatTable WHERE (PCatID = @PcatID)">
                     <SelectParameters>
                         <asp:ControlParameter ControlID="findTextBox" Name="PCatID" PropertyName="Text" 
                             Type="String" />
                     </SelectParameters>
                       <DeleteParameters>
                         <asp:Parameter Name="PCatID" />
                 ...
                 <asp:SqlDataSource ID="CategorySqlDataSource1" runat="server" 
                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                      DeleteCommand="DELETE FROM ProductCatTable WHERE (PCatID = @PCatID)"
                     UpdateCommand="UPDATE ProductCatTable SET Status = @Status WHERE (SN = @SN)"
                    
                     SelectCommand="SELECT SN, PCatID, ProductCatName, Status, DateCreated, CreatedBy, DateUpdated, UpdateBy FROM ProductCatTable">
                    <DeleteParameters>
                         <asp:Parameter Name="PCatID" />
                     </DeleteParameters>
                     <UpdateParameters>
                 ...
                 <asp:Label ID="result" runat="server" Visible="False"/></td>
         </tr>
         <tr>
             <td class="style9" valign="top">
                 <table style="width: 541px" id="AddEmployeeTable" runat="server" 
            visible="False">
                <tr>
                    <td class="style26" style="border-style: solid; border-width: 1px">
                    &nbsp;<strong><asp:Label ID="MSGLabel1" runat="server" ForeColor="Red"></asp:Label>
                        </strong>
                    </td>
                ...
                <tr>
                    ...
                    <td class="style25" style="border-style: solid; border-width: 1px">
                        <strong>
                        <asp:TextBox ID="CatCodeTextBox" runat="server" Width="103px" 
                            style="text-align: left" MaxLength="3" ToolTip="Maximum : 3"></asp:TextBox>
                        </strong>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="style25" style="border-style: solid; border-width: 1px">
                        <strong>
                        <asp:TextBox ID="catNameTextBox" runat="server" Width="103px" 
     ...
     Status:</td>
                ...
                <tr>
                    <td class="style22" style="border-style: solid; border-width: 1px" colspan="2">
                        <strong>
                        ...
                        <asp:TextBox ID="Name" runat="server" Visible="False" Width="36px" 
                            Wrap="False"></asp:TextBox>
                        <asp:TextBox ID="Name0" runat="server" Visible="False" Width="36px" 
                            Wrap="False"></asp:TextBox>
                        </strong></td>
                </tr>
                </table>
            ...
            visible="False">
                <tr>
                    <td class="style13" style="border-style: solid; border-width: 1px" colspan="2">
                        &nbsp;Search/Add:<br />
                    </td>
                </tr>
                <tr>
                    <td class="style24" style="border-style: solid; border-width: 1px">
                        <strong>
                        Code:
                        <asp:TextBox ID="viewIDTextBox0" runat="server" Width="103px" 
                            style="text-align: left" ToolTip="Code...."></asp:TextBox>
                        </strong>
                    </td>
                    <td class="style6" style="border-style: solid; border-width: 1px">
                ...
                <tr>
                    <td class="style11" style="border-style: solid; border-width: 1px" colspan="2">
                        <asp:GridView ID="SearchGridView1" runat="server" AllowPaging="True" 
                            AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" 
                            BorderStyle="Solid" BorderWidth="1px" CellPadding="3" 
                            DataSourceID="viewSearchSqlDataSource2" ForeColor="Black" GridLines="Vertical" 
                            PageSize="4" Width="271px" DataKeyNames="PCatID">
                            <AlternatingRowStyle BackColor="#CCCCCC" />
                            <Columns>
                                <asp:BoundField DataField="SN" HeaderText="SN" 
                                    ...
                                    Visible="False" />
                                <asp:BoundField DataField="PCatID" HeaderText="Cat ID" 
                                    SortExpression="PCatID" ReadOnly="True" />
                                <asp:BoundField DataField="ProductCatName" HeaderText="Product Category Name" 
                                    SortExpression="ProductCatName" />
                            </Columns>
                            <FooterStyle BackColor="#CCCCCC" />
                            <HeaderStyle BackColor="Black" Font-Bold="True" ForeColor="White" />
                        ...
                        <asp:GridView ID="SearchGridView2" runat="server" AllowPaging="True" 
                            AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" 
                            BorderStyle="Solid" BorderWidth="1px" CellPadding="3" 
                            DataSourceID="searchSqlDataSource2" ForeColor="Black" GridLines="Vertical" 
                            PageSize="4" Visible="False" Width="271px" DataKeyNames="PCatID">
                            <AlternatingRowStyle BackColor="#CCCCCC" />
                            <Columns>
                                <asp:BoundField DataField="SN" HeaderText="SN" InsertVisible="False" 
                                    ReadOnly="True" SortExpression="SN" Visible="False" />
         ...
         <tr>
             <td class="style9">
                 ...
                 <strong>
                 <asp:SqlDataSource ID="searchSqlDataSource2" runat="server" 
                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                     SelectCommand="SELECT SN, PCatID, ProductCatName FROM ProductCatTable WHERE (PCatID = @PCatID)">
                     <SelectParameters>
                         <asp:ControlParameter ControlID="viewIDTextBox0" Name="PCatID" 
                             PropertyName="Text" />
                     </SelectParameters>
                 </asp:SqlDataSource>
                 <asp:SqlDataSource ID="viewSearchSqlDataSource2" runat="server" 
                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
             ...
             <td class="style4">
                 ...
                 <asp:SqlDataSource ID="ManufacturerSqlDataSource2" runat="server" 
                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                     SelectCommand="SELECT ManufacturerTable.* FROM ManufacturerTable">
                 </asp:SqlDataSource>

                 <asp:SqlDataSource ID="ModelSqlDataSource2" runat="server" 
                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                     SelectCommand="SELECT ModelTable.* FROM ModelTable"></asp:SqlDataSource>
