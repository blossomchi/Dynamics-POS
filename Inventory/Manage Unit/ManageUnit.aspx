<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_rcqccjow" %>
...
<!--[if !IE]>--><div class="xr_ap" id="xr_xri" 
 ...
 <img class="xr_ap" src="index_htm_files/17.png" alt="" 
                ...
                style="left: 2px; top: 1497px; width: 1005px; height: 74px;"/>
 <span class="xr_s0" style="position: absolute; left:32px; top:1569px;">
  <span class="xr_tc" style="left: 294px; top: -32px; width: 341px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &#169; Developed by Chinyere Blossom Oyem</span>
 </span>
     ...
     <table id="employeeTable" 
         ...
         <tr>
             <td class="style2" colspan="2">
                 <strong>
                 <asp:Label ID="employeeMgtLabel" runat="server" Text="Unit Management."></asp:Label>
                 <asp:TextBox ID="UpdateTextBox0" runat="server" 
                     ...
                     Font-Size="Medium" Visible="False">Add Unit.</asp:Label>
         ...
         <tr>
             <td class="style3" colspan="2">
                 <strong>
                     ...
                     Text="Unit Name" 
                     Width="107px" ToolTip="Search By Unit Name" Visible="False" />
                 ...
                 <asp:Button ID="saveButton" runat="server" 
                     ...
                     Width="66px" ToolTip="Save Unit" OnClientClick = "Confirm()" />
                 <asp:Button ID="BackButton" runat="server" Text="Back" Visible="False" 
                     Width="66px" />
                 <asp:Button ID="AddattributeButton" runat="server" Text="Add Base Unit" 
                     Width="132px" />
                                    </strong>
&nbsp;</td>
         </tr>
         <tr>
             <td class="style14" colspan="2">
                 ...
                 <asp:GridView ID="UnitGridView" runat="server" 
                     ...
                     DataKeyNames="UoMID" DataSourceID="UnitSqlDataSource1" ForeColor="Black" 
...
onclick = "Check_Click(this)"/>
                         ...
                         <asp:BoundField DataField="UoMID" HeaderText="UoM ID" 
                             SortExpression="UoMID" ReadOnly="True" />
                 ...
                 <asp:SqlDataSource ID="UnitSqlDataSource1" runat="server" 
                     ...
                     SelectCommand="SELECT SN, UoMID, UnitName, Status, UpdateDate, UpdateBy FROM UnitTable ORDER BY UnitName">
                     <UpdateParameters>
                 ...
                 <asp:GridView ID="findUnitNameGridView" runat="server" 
                     ...
                     DataSourceID="emailSqlDataSource1" DataKeyNames="UoMID">
                     <AlternatingRowStyle BackColor="#CCCCCC" />
         ...
         <tr>
                ...
                <tr>
                    <td class="style11" style="border-style: solid; border-width: 1px" colspan="2">
                        <asp:GridView ID="SearchGridView1" runat="server" AllowPaging="True" 
                            ...
                            PageSize="15" Width="312px" DataKeyNames="UoMID" ShowFooter="True">
                            <AlternatingRowStyle BackColor="#CCCCCC" />
                            <Columns>
                                <asp:BoundField DataField="UoMID" HeaderText="UoM ID" 
                                    SortExpression="UoMID" ReadOnly="True" />
                        ...
                        <asp:GridView ID="SearchGridView2" runat="server" AllowPaging="True" 
                            ...
                            PageSize="15" Visible="False" Width="312px" DataKeyNames="UoMID" 
                            ShowFooter="True">
                            <AlternatingRowStyle BackColor="#CCCCCC" />
                            <Columns>
                                <asp:BoundField DataField="UoMID" HeaderText="UoM ID" 
            ...
            visible="False">
                ...
                <tr>
                    ...
                    <td class="style28" style="border-style: solid; border-width: 1px">
                        <strong>
                        <asp:TextBox ID="txtUnitCode" runat="server" Width="133px"></asp:TextBox>
                        </strong>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="style28" style="border-style: solid; border-width: 1px">
                        <strong>
                        <asp:TextBox ID="UnitNameTextBox" runat="server" Width="133px"></asp:TextBox>
                        </strong>
                    </td>
                </tr>
                <tr>
         ...
         <tr>
             <td class="style9">
                 <asp:SqlDataSource ID="emailSqlDataSource1" runat="server" 
                     ...
                     SelectCommand="SELECT SN, UoMID, UnitName, Status, UpdateDate, UpdateBy FROM UnitTable WHERE (UnitName = @UnitName)" 
                     ...
                     InsertCommand="INSERT INTO [UnitTable] ([SN], [UnitName], [UoMID]) VALUES (@SN, @UnitName, @UoMID)">
                      ...
                      <SelectParameters>
                          <asp:ControlParameter ControlID="findTextBox" Name="UnitName" 
                 ...
                 <asp:SqlDataSource ID="searchSqlDataSource2" runat="server" 
                     ...
                     SelectCommand="SELECT UoMID, UnitName FROM UnitTable WHERE (UnitName = @UnitName)">
                     <SelectParameters>
                         <asp:ControlParameter ControlID="viewIDTextBox0" Name="UnitName" 
                             PropertyName="Text" />
                     </SelectParameters>
                 </asp:SqlDataSource>
                 <asp:SqlDataSource ID="searchviewSqlDataSource2" runat="server" 
                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                     SelectCommand="SELECT [UoMID], [UnitName] FROM [UnitTable]">
                 </asp:SqlDataSource>
                                    </strong>
