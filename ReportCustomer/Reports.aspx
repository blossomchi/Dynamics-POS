<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_3qn3frgr" %>
...
<!--[if !IE]>--><div class="xr_ap" id="xr_xri" 
 ...
 <img class="xr_ap" src="index_htm_files/5.png" alt="" title="" style="left: 829px; top: 121px; width: 364px; height: 37px;"/>
  <table id="adminInfoTable" runat="server" 
         style="width: 541px; left: 693px; top: 146px; height: 42px; right: 17px; position: absolute;" 
         visible="true">
         <tr>
             <td class="style1" >
     ...
     <table id="employeeTable" 
                ...
                style="position: absolute; top: 234px; left: 6px; width: 1242px; height: 180px;">
         <tr>
             <td class="style2">
                 <strong>
