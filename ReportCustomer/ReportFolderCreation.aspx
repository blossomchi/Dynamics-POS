<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_lc5c3owd" %>
...
<!--[if !IE]>--><div class="xr_ap" id="xr_xri" 
 ...
 <table id="adminInfoTable" runat="server" 
         style="width: 519px; left: 695px; top: 135px; height: 42px; right: 37px; position: absolute;" 
         visible="true">
         <tr>
             <td class="style1" >
     ...
     <table id="employeeTable" 
                ...
                style="position: absolute; top: 243px; left: 154px; width: 974px; height: 220px;">
         <tr>
             <td class="style2">
                 <strong>
