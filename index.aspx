<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_ga4y2nd2" %>
...
<div class="xr_ap" id="xr_xr" 
    style="width: 1000px; height: 880px; top:0px; left:50%; margin-left: -500px;">
 <script type="text/javascript">     var xr_xr = document.getElementById("xr_xr")</script>
 <!--[if IE]><div class="xr_ap" id="xr_xri" 
        style="width: 1000px; height: 882px; clip: rect(0px 1000px 1600px 0px); top: 0px; left: 4px;"><![endif]-->
<!--[if !IE]>--><div class="xr_ap" id="xr_xri" 
            style="width: 1000px; height: 880px; clip: rect(0px, 1000px, 1600px, 0px); top: 0px; left: 15px;"><!--<![endif]-->
 ...
 <a href="#" target="_self" onclick="return(xr_nn());">
  <img class="xr_ap" src="index_htm_files/13.png" alt="" title="" onmousemove="xr_mmo(this,0)" onmouseover="xr_openmenu11(event);return false;" style="left: 860px; top: 227px; width: 59px; height: 22px;"/>
     ...
     <table id="Table1" runat="server" 
         style="width: 980px; left: 9px; top: 276px; height: 495px; right: 11px; position: absolute;" 
         visible="true" border="1">
         <tr>
             <td style="border-style: solid; border-width: medium; font-size: xx-large; background-color: #DBD8CA;" 
                 class="style2" >
                   
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   
                  Welcome 
                     <asp:Label ID="adminLabel5" runat="server"></asp:Label>
                     <asp:Label ID="adminLabel6" runat="server"></asp:Label>
                 <strong>
                                    <asp:TextBox ID="UpdateTextBox1" runat="server" 
                     Width="27px" Visible="False" 
                                        style="margin-left: 0px"></asp:TextBox>
                                    </strong>To POS System
             </td>
         </tr>
     </table>
 ...
 <div id="xr_xd0"></div>
            ...
            <table class="style3" style="position: absolute; top: 152px; font-weight: 700;">
                <tr>
                    <td id="Admin1" style="">
                     ...
                     &nbsp;<asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Login.aspx">Log Out</asp:HyperLink></td>
...
<script type='text/javascript'>//<![CDATA[
    ...
    xr_submenuItem("Manage Stock Entity", "/Stock/Stock Entity/ManageStockEntity.aspx", "", "xr_links_plain7");
