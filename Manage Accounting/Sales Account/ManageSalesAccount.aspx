<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_qz1nkn0m" enableeventvalidation="false" %>
         ...
         <tr>
             <td class="style2" colspan="2">
                 ...
                 <asp:Label ID="employeeMgtLabel" runat="server" 
                     Text="View Sales Account."></asp:Label>
                 <asp:TextBox ID="UpdateTextBox0" runat="server" 
                     ...
                     Font-Size="Medium" Visible="False">Sales Account.</asp:Label>
         ...
         <tr>
             <td class="style53">
                 ...
                 <asp:SqlDataSource ID="ItemDS" runat="server" 
                     ...
                     SelectCommand="SELECT DISTINCT SalesAccountTable.SalesID, SalesAccountTable.SalesDate, CustomerHeaderTable.CustomerName, SalesAccountTable.Account, SalesAccountTable.AccountDetail, SalesAccountTable.Amount, SalesAccountTable.TransactionType, SalesAccountTable.Remark, SalesAccountTable.DateCreated, SalesAccountTable.CreatedBy, SalesAccountTable.ID, SalesAccountTable.DateUpdated, SalesAccountTable.UpdatedBy FROM SalesAccountTable INNER JOIN CustomerHeaderTable ON SalesAccountTable.CustomerID = CustomerHeaderTable.CusID ORDER BY SalesAccountTable.SalesID DESC, SalesAccountTable.SalesDate DESC">
                 </asp:SqlDataSource>
