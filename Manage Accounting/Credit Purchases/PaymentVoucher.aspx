<%@ page language="VB" autoeventwireup="false" inherits="Manage_Accounting_Credit_Purchases_PaymentVoucher, App_Web_0cso5spe" %>
...
<!--[if !IE]>--><div class="xr_ap" id="xr_xri" style="width: 793px; height: 1122px; clip: rect(0px, 760px, 1000px, 0px);"><!--<![endif]-->
 ...
 <span class="xr_s1" style="position: absolute; left:382px; top:90px;">
  <span class="xr_tc" style="left: -151px; top: -11px; width: 343px;"><span class="xr_s2">PAYMENT VOUCHER(PURCHASES)</span></span>
 </span>
                 ...
                 <asp:Label ID="PVID" runat="server" style="font-size: 12px"></asp:Label>
                     ...
                     <asp:TextBox ID="UpdateTextBox" runat="server" Visible="False" Width="27px"></asp:TextBox>
                                    ...
                                    <asp:SqlDataSource ID="PVDS" runat="server" 
                                        ...
                                        SelectCommand="SELECT PurchasePaymentMethodTypeTable.PaymentName, SUM(PurchasePaymentTable.AmountPaid) AS AmountPaid FROM PurchasePaymentTable INNER JOIN PurchasePaymentMethodTypeTable ON PurchasePaymentTable.PaymentMethodID = PurchasePaymentMethodTypeTable.ID WHERE (PurchasePaymentTable.PurchaseOrderID = @PID) GROUP BY PurchasePaymentMethodTypeTable.PaymentName">
                                        <SelectParameters>
                                            <asp:ControlParameter ControlID="LBReciept3" Name="PID" PropertyName="Text" />
                                        </SelectParameters>
                                    </asp:SqlDataSource>
