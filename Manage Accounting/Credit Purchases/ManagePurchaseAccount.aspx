<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_0cso5spe" %>
         ...
         <tr>
             <td class="style2" colspan="2">
                 ...
                 <asp:Label ID="employeeMgtLabel" runat="server" 
                     Text="Purchases Account Managment."></asp:Label>
                 <asp:TextBox ID="UpdateTextBox0" runat="server" 
                     ...
                     Font-Size="Medium" Visible="False">Make Purchases.</asp:Label>
                                    <asp:Label ID="CostPriceLabel0" runat="server" 
                     Font-Size="Medium" Visible="False">Purchases Payment Method.</asp:Label>
             ...
             <td class="style3" colspan="2">
                 <strong>
                        <asp:DropDownList ID="CBSourceNO0" runat="server" AutoPostBack="True" 
                            DataSourceID="SqlDataSource3" DataTextField="CompanyName" DataValueField="CompanyName" 
                 ...
                 <asp:GridView ID="StockGridView" runat="server" 
                     ...
                     <Columns>
                         ...
                         <asp:BoundField DataField="CompanyName" HeaderText="Suppliers" 
                             ...
                             ReadOnly="True" SortExpression="Amount Paid" />
         ...
         <tr>
             <td class="style14" colspan="2">
                 ...
                 <asp:SqlDataSource ID="costSellingDS" runat="server" 
                     ...
                     SelectCommand="SELECT DISTINCT PurchasePaymentTable.PurchaseOrderID, SupplierHeaderTable.CompanyName, SUM(PurchasePaymentTable.AmountPaid) AS [Amount Paid], PurchasePaymentTable.DateCreated FROM PurchasePaymentTable INNER JOIN SupplierHeaderTable ON PurchasePaymentTable.SuplierID = SupplierHeaderTable.SupID GROUP BY SupplierHeaderTable.CompanyName, PurchasePaymentTable.PurchaseOrderID, PurchasePaymentTable.DateCreated ORDER BY PurchasePaymentTable.PurchaseOrderID">
                 </asp:SqlDataSource>
                 ...
                 <asp:SqlDataSource ID="CostSellingPriceDS" runat="server" 
                     ...
                     SelectCommand="SELECT DISTINCT PurchasePaymentTable.PurchaseOrderID, SupplierHeaderTable.CompanyName, SUM(PurchasePaymentTable.AmountPaid) AS [Amount Paid], PurchasePaymentTable.DateCreated FROM PurchasePaymentTable INNER JOIN SupplierHeaderTable ON PurchasePaymentTable.SuplierID = SupplierHeaderTable.SupID GROUP BY SupplierHeaderTable.CompanyName, PurchasePaymentTable.PurchaseOrderID, PurchasePaymentTable.DateCreated HAVING (SupplierHeaderTable.CompanyName = @Supplier)">
                     <SelectParameters>
            ...
            visible="False" align="left" bgcolor="#DBD7CB">
                <tr>
                    ...
                    <asp:Label ID="PriceTypeLabel" runat="server" style="text-align: left; font-weight: 700;" 
                        Text="MAKE YOUR PURCHASES HERE."></asp:Label>
                ...
                <tr>
                    ...
                    <td class="style228" valign="top">
                                 ...
                                 <asp:DropDownList ID="CBPOID" runat="server" 
                                     DataSourceID="PurchaseIDDS" DataTextField="PurchaseOrderID" 
                                     DataValueField="PurchaseOrderID"  class="chosen-select" Width="230px" 
                ...
                <tr>
                    ...
                    <td class="style228" valign="top">
                                 ...
                                 <asp:DropDownList ID="CBCustomer" runat="server" 
                                     ...
                                     DataValueField="SupplierID"  class="chosen-select" Width="230px" 
...
<asp:GridView ID="ReturnGV" runat="server" 
                            ...
                            ShowFooter="True" Height="104px" PageSize="6" Font-Size="7pt" 
                                     ...
                                     DataSourceID="ReturnView" Visible="False" 
                                      >
                            <AlternatingRowStyle BackColor="#CCCCCC" />
                               <Columns>
                                   ...
                                   <asp:TemplateField HeaderText="Unit Price" SortExpression="UnitCost">
                                      
                                       <ItemTemplate>
                                           <asp:Label ID="Label1" runat="server" Text='<%# Bind("UnitCost") %>'></asp:Label>
                                       </ItemTemplate>
                                        <FooterTemplate>
                                       <asp:Label ID="LBDiscount" runat="server" Font-Bold="true" ForeColor="Magenta">Discount:</asp:Label><br /><br />
                                        <asp:Label ID="SubTotalLabel" runat="server" Font-Bold="true" ForeColor="Magenta">Total:</asp:Label><br /><br />
                                         </FooterTemplate>
                                   </asp:TemplateField>
                                   <asp:TemplateField HeaderText="Amount" SortExpression="Amount">
                                       ...
                                       <ItemTemplate>
                                        ...
                                        <FooterTemplate>
                                         <asp:Label ID="PurchaseDiscountAmount" runat="server" Font-Bold="true" ForeColor="Magenta"></asp:Label><br /><br />
...
<asp:GridView ID="ReturnSaleGV" runat="server" AllowPaging="True" 
                          ...
                          <asp:TemplateField ShowHeader="False">
                            ...
                            SelectCommand="SELECT ProductNumber, Barcode, Description, Quantity, UnitCost, Amount FROM PurchaseOrderDetailsTable WHERE (PurchaseOrderID = @id)" 
                ...
                <tr>
                    <td class="style35">
                     ...
                     Text="Cancel" 
                     Width="74px" ToolTip="Cancel purchase." Height="28px" 
                                     style="margin-left: 0px" Enabled="False" />
         ...
         <tr>
             <td class="auto-style1" colspan="2">
                        ...
                        <table id="DiscountTable" runat="server" visible="False" align="left" 
                            ...
                            style="border-style: solid; border-width: medium; background-color: #DBD8CA; " class="auto-style2"  >
                            <tr>
                        ...
                        <asp:DropDownList ID="CBDiscountName" runat="server" 
                            ...
                            <tr>
                                <td class="style150" valign="top" colspan="2" >
         ...
         <tr>
             <td class="style51" colspan="2">
                        ...
                        <strong > 
                            ...
                            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                            SelectCommand="SELECT DISTINCT SalesHeaderTable.CusID, CustomerHeaderTable.CustomerName FROM CustomerHeaderTable INNER JOIN SalesHeaderTable ON CustomerHeaderTable.CusID = SalesHeaderTable.CusID">
                        </asp:SqlDataSource>
                      
                        

                                 <asp:SqlDataSource ID="PurchaseIDDS" runat="server" 
                            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                            SelectCommand="SELECT PurchaseOrderHeaderTable.* FROM PurchaseOrderHeaderTable">
                        </asp:SqlDataSource>
                            ...
                            SelectCommand="SELECT DISTINCT PurchasePaymentMethodTypeTable.PaymentName, PurchasePaymentTable.AmountPaid FROM PurchasePaymentTable INNER JOIN PurchasePaymentMethodTypeTable ON PurchasePaymentTable.PaymentMethodID = PurchasePaymentMethodTypeTable.ID WHERE (PurchasePaymentTable.PurchaseOrderID = @ID)">
                                     <SelectParameters>
                                         <asp:ControlParameter ControlID="CBPOID" Name="ID" 
                            ...
                            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                            SelectCommand="SELECT PurchaseOrderHeaderTable.SupplierID, SupplierHeaderTable.CompanyName, PurchaseOrderHeaderTable.PurchaseOrderID FROM SupplierHeaderTable INNER JOIN PurchaseOrderHeaderTable ON SupplierHeaderTable.SupID = PurchaseOrderHeaderTable.SupplierID WHERE (PurchaseOrderHeaderTable.PurchaseOrderID = @id)">
                                     <SelectParameters>
                                         <asp:ControlParameter ControlID="txtInvocieID" Name="id" PropertyName="Text" />
                                     </SelectParameters>
                        </asp:SqlDataSource>
                            ...
                            SelectCommand="SELECT [ID], [PaymentName] FROM [PurchasePaymentMethodTypeTable]">
                        </asp:SqlDataSource>
                            ...
                            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                            SelectCommand="SELECT DISTINCT SupplierHeaderTable.CompanyName FROM PurchasePaymentTable INNER JOIN SupplierHeaderTable ON PurchasePaymentTable.SuplierID = SupplierHeaderTable.SupID GROUP BY SupplierHeaderTable.CompanyName">
                        </asp:SqlDataSource>
                        ...
                        <asp:SqlDataSource ID="StockDetailsDS" runat="server" 
                            ...
                            SelectCommand="SELECT DeductionType, ID FROM OtherChargesTypeTable WHERE (DeductionType = N'VAT')">
                        </asp:SqlDataSource>
