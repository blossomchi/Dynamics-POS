<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_t1uzpruk" %>
...
var gv = document.getElementById("<%=Receip_InvoiceGridView.ClientID%>");
         ...
         <tr>
             <td class="style2" colspan="2">
                 ...
                 <asp:Label ID="employeeMgtLabel" runat="server" 
                     Text=" Receipt / Invoice  Entry"></asp:Label>
                 <asp:TextBox ID="UpdateTextBox0" runat="server" 
                     ...
                     Font-Size="Medium" Visible="False">Add Receipt / Invoice.</asp:Label>
...
&nbsp;</td>
         ...
         <tr>
             <td class="style85" valign="top" colspan="2">
                 ...
                 <asp:GridView ID="Receip_InvoiceGridView" runat="server" 
                     ...
                     ShowFooter="True" DataKeyNames="Receipt_InvoiceNumber">
                     ...
                     <Columns>
                         ...
                         <asp:BoundField DataField="SourceDocument" HeaderText="Document Type" SortExpression="SourceDocument" />
                         <asp:BoundField DataField="Receipt_InvoiceNumber" HeaderText="Receipt_Invoice Number" 
                             SortExpression="Receipt_InvoiceNumber" ReadOnly="True" >
                           </asp:BoundField>
                         ...
                         <asp:BoundField DataField="Receive by" HeaderText="Receive By" SortExpression="Receive by" />
                 ...
                 <asp:SqlDataSource ID="costSellingDS" runat="server" 
                     ...
                     SelectCommand="SELECT Receipt_InvoiceHeaderTable.ID, SourceDocumentTypeTable.SourceDocument, Receipt_InvoiceHeaderTable.Receipt_InvoiceNumber, Receipt_InvoiceHeaderTable.InvoiceDate, Receipt_InvoiceHeaderTable.DateCreated, Receipt_InvoiceHeaderTable.CreatedBY, SupplierHeaderTable.CompanyName, employeeTable.Firstname + ' ' + employeeTable.LastName AS [Receive by] FROM Receipt_InvoiceHeaderTable INNER JOIN SourceDocumentTypeTable ON Receipt_InvoiceHeaderTable.DocumentType = SourceDocumentTypeTable.ID INNER JOIN SupplierHeaderTable ON Receipt_InvoiceHeaderTable.Company = SupplierHeaderTable.SupID INNER JOIN employeeTable ON Receipt_InvoiceHeaderTable.RecieveBy = employeeTable.SN ORDER BY Receipt_InvoiceHeaderTable.ID">
                 </asp:SqlDataSource>
         ...
         <tr>
             <td class="style14" colspan="2" style="position: absolute; top: 70px" 
                 ...
                 <asp:GridView ID="DocumentTypeGridView" runat="server" 
                     ...
                     PageSize="20" style="font-size: 12px" DataKeyNames="Receipt_InvoiceNumber">
                     <AlternatingRowStyle BackColor="#CCCCCC" />
                     ...
                     <Columns>
                         ...
                         <asp:BoundField DataField="ID" HeaderText="ID" 
                             SortExpression="ID" InsertVisible="False" ReadOnly="True" />
                         <asp:BoundField DataField="SourceDocument" HeaderText="Document Type" 
                         ...
                         <asp:BoundField DataField="Receive by" HeaderText="Receive by" 
                             SortExpression="Receive by" ReadOnly="True" />
                         <asp:BoundField DataField="DateCreated" HeaderText="Date Created" 
                             SortExpression="DateCreated" />
                 ...
                 <asp:GridView ID="DocumentNoGridView" runat="server" 
                     ...
                     DataKeyNames="Receipt_InvoiceNumber">
                     <AlternatingRowStyle BackColor="#CCCCCC" />
                     ...
                     <Columns>
                         ...
                         <asp:BoundField DataField="CompanyName" HeaderText="Supplier" 
                             SortExpression="CompanyName" />
                         <asp:BoundField DataField="Receive by" 
                             HeaderText="Receive by" SortExpression="Receive by" ReadOnly="True" />
                         <asp:BoundField DataField="DateCreated" HeaderText="Date Created" 
                             SortExpression="DateCreated" />
                         <asp:BoundField DataField="CreatedBY" HeaderText="Created BY" 
                             SortExpression="CreatedBY" />
                 ...
                 <asp:SqlDataSource ID="SupplierDS" runat="server" 
                     ...
                     SelectCommand="SELECT Receipt_InvoiceHeaderTable.ID, SourceDocumentTypeTable.SourceDocument, Receipt_InvoiceHeaderTable.Receipt_InvoiceNumber, Receipt_InvoiceHeaderTable.InvoiceDate, Receipt_InvoiceHeaderTable.DateCreated, Receipt_InvoiceHeaderTable.CreatedBY, SupplierHeaderTable.CompanyName, employeeTable.Firstname + ' ' + employeeTable.LastName AS [Receive by] FROM Receipt_InvoiceHeaderTable INNER JOIN SourceDocumentTypeTable ON Receipt_InvoiceHeaderTable.DocumentType = SourceDocumentTypeTable.ID INNER JOIN SupplierHeaderTable ON Receipt_InvoiceHeaderTable.Company = SupplierHeaderTable.SupID INNER JOIN employeeTable ON Receipt_InvoiceHeaderTable.RecieveBy = employeeTable.SN WHERE (SupplierHeaderTable.CompanyName = @Suppliers)">
                     <SelectParameters>
                         <asp:ControlParameter ControlID="findTextBox" Name="Suppliers" 
                             PropertyName="Text" />
                     </SelectParameters>
                 </asp:SqlDataSource>
                 ...
                 <asp:SqlDataSource ID="DocumentNo" runat="server" 
                     ...
                     SelectCommand="SELECT Receipt_InvoiceHeaderTable.ID, SourceDocumentTypeTable.SourceDocument, Receipt_InvoiceHeaderTable.Receipt_InvoiceNumber, Receipt_InvoiceHeaderTable.InvoiceDate, Receipt_InvoiceHeaderTable.DateCreated, Receipt_InvoiceHeaderTable.CreatedBY, SupplierHeaderTable.CompanyName, employeeTable.Firstname + ' ' + employeeTable.LastName AS [Receive by] FROM Receipt_InvoiceHeaderTable INNER JOIN SourceDocumentTypeTable ON Receipt_InvoiceHeaderTable.DocumentType = SourceDocumentTypeTable.ID INNER JOIN SupplierHeaderTable ON Receipt_InvoiceHeaderTable.Company = SupplierHeaderTable.SupID INNER JOIN employeeTable ON Receipt_InvoiceHeaderTable.RecieveBy = employeeTable.SN WHERE (Receipt_InvoiceHeaderTable.Receipt_InvoiceNumber = @Number)">
                     <SelectParameters>
                         <asp:ControlParameter ControlID="findTextBox" Name="Number" 
                             PropertyName="Text" />
                     </SelectParameters>
                 </asp:SqlDataSource>
                 ...
                 <asp:SqlDataSource ID="CostSellingPriceDS" runat="server" 
                     ...
                     SelectCommand="SELECT Receipt_InvoiceHeaderTable.ID, SourceDocumentTypeTable.SourceDocument, Receipt_InvoiceHeaderTable.Receipt_InvoiceNumber, Receipt_InvoiceHeaderTable.InvoiceDate, Receipt_InvoiceHeaderTable.DateCreated, Receipt_InvoiceHeaderTable.CreatedBY, SupplierHeaderTable.CompanyName, employeeTable.Firstname + ' ' + employeeTable.LastName AS [Receive by] FROM Receipt_InvoiceHeaderTable INNER JOIN SourceDocumentTypeTable ON Receipt_InvoiceHeaderTable.DocumentType = SourceDocumentTypeTable.ID INNER JOIN SupplierHeaderTable ON Receipt_InvoiceHeaderTable.Company = SupplierHeaderTable.SupID INNER JOIN employeeTable ON Receipt_InvoiceHeaderTable.RecieveBy = employeeTable.SN WHERE (SourceDocumentTypeTable.SourceDocument = @SourceDocumnet)">
                     <SelectParameters>
                         <asp:ControlParameter ControlID="findTextBox" Name="SourceDocumnet" 
                             PropertyName="Text" />
                     </SelectParameters>
                 </asp:SqlDataSource>
         ...
         <tr>
             <td class="style83" colspan="2" valign="top">
                        ...
                        <table id="SourceDocumentInfoTable" runat="server" visible="False" align="left" 
                            ...
                            style="background-position: center; border-style: solid; border-width: medium; width: 989px; background-image: url('images/eeee.gif'); background-repeat: repeat; height: 740px; background-color: #DBD8CA;"  >
                            <tr>
                    ...
                    <asp:Label ID="PriceTypeLabel" runat="server" style="text-align: left; font-weight: 700;" 
                        ...
                        <asp:TextBox ID="txtSourceNo" runat="server" Width="184px" 
                         ...
                         <tr>
                             ...
                             <td class="style47">
                                 ...
                                 <strong > 
                        <asp:TextBox ID="txtInvoiceDate" runat="server" Width="184px" 
                            style="text-align: left"></asp:TextBox>
                         ...
                         <tr>
                            ...
                            Height="19px" Width="194px" class="chosen-select" DataSourceID="SqlDataSource1" 
                         ...
                         <tr>
                             ...
                             <td class="style126">
                                 ...
                                 <asp:DropDownList ID="CBSupplier" runat="server" 
                                     ...
                                     DataValueField="SupID"  class="chosen-select" Width="197px" 
                                     AutoPostBack="True">
                                 </asp:DropDownList>
                     ...
                     Text="Save" 
                     Width="318px" ToolTip="save and add document details" OnClientClick = " " />
                        &nbsp;
                        </strong>
                    ...
                    <asp:Label ID="PriceTypeLabel1" runat="server" style="text-align: left; font-weight: 700;" 
                        Text="Document Details" Visible="False"></asp:Label>
                             </td>
                         </tr>
                         <tr>
                          ...
                          <asp:GridView ID="MasterDetailGV" runat="server" AllowPaging="True" 
                            ...
                            ShowFooter="True" Height="132px" 
                                     DataSourceID="MasterView" Visible="False" 
         ...
         <tr>
             <td class="style51" colspan="2" 
                 style="position: absolute; top: 80px; left: 100px; text-align: center;" 
                 valign="top">
                     ...
                     <table ID="SourceDocDetailsTable" runat="server" visible="False" align="center" 
                            ...
                            style="border-style: ridge; width: 783px; background-color: #DBD8CA;">
                         <tr>
                             <td class="style108">
                                 &nbsp;</td>
                             <td class="style117">
                    ...
                    <asp:Label ID="PriceTypeLabel0" runat="server" style="text-align: left; font-weight: 700;" 
                        Text="Enter Document Details"></asp:Label>
                             </td>
                             <td class="style124" rowspan="6" valign="top" align="left">
                      
                        <asp:GridView ID="SerialNoGridView" runat="server" AllowPaging="True" 
                            AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" 
                            BorderStyle="Solid" BorderWidth="1px" CellPadding="3" 
                            DataSourceID="SN" ForeColor="Black" 
                            GridLines="Vertical" Width="192px" Visible="False" style="font-size: 10px">
                            <AlternatingRowStyle BackColor="#CCCCCC" />
                            <Columns>
                         ...
                         <tr>
                             ...
                             <td class="style118">
                                 ...
                                 <asp:DropDownList ID="CBPV" runat="server" 
                                     DataSourceID="PVDS" DataTextField="PVID" 
                                     DataValueField="ExpenseHeaderID"   class="chosen-select" Width="383px" 
                                     AutoPostBack="True">
                                 </asp:DropDownList>
                         ...
                         <tr>
                             ...
                             <td class="style118">
                                 ...
                                 <asp:DropDownList ID="CBItemDes" runat="server" 
                                     DataSourceID="ExpenseDetailsDS" DataTextField="ItemName" 
                                     DataValueField="ItemName"   class="chosen-select" Width="383px" 
                                     AutoPostBack="True">
                                 </asp:DropDownList>
                         ...
                         <tr>
                             ...
                             <td class="style120" 
                                  >
                                 <strong > 
                        <asp:TextBox ID="txtQtySupplied" runat="server" Width="380px" 
                         ...
                         <tr>
                             ...
                             <td class="style120" 
                                  >
                                 <strong > 
                        <asp:TextBox ID="txtUnitPrice" runat="server" Width="380px" 
                            style="text-align: left" ReadOnly="True"></asp:TextBox>
                        </strong>
                             </td>
                         </tr>
                     ...
                     Text="Save" 
                     Width="66px" ToolTip="Save source document details" />
         ...
         <tr>
             <td class="style51" colspan="2" 
                 style="position: absolute; top: 170px; left: 450px; " 
                 valign="top" align="center">
                      
                        

                 <asp:Calendar ID="InvoiceDate" runat="server" BackColor="#FFFFCC" 
         ...
         <tr>
             <td class="style51" colspan="2">
                        ...
                        <strong > 
                            ...
                            SelectCommand="SELECT Description, ID FROM Receipt_InvoiceDetailTable WHERE (Receipt_InvoiceNumber = @id)">
                                     <SelectParameters>
                                         <asp:ControlParameter ControlID="txtSourceNo" Name="id" 
                                             PropertyName="Text" />
                                     </SelectParameters>
                                 </asp:SqlDataSource>
                 ...
                 <asp:SqlDataSource ID="UnitDS" runat="server" 
                     ...
                     <DeleteParameters>
                         <asp:Parameter Name="SN" />
                            ...
                            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                            SelectCommand="SELECT ExpensesPaymentVoucherTable.PVID, ExpensesHeadsTable.ExpenseHead, ExpensesPaymentVoucherTable.ExpenseHeaderID FROM ExpensesPaymentVoucherTable INNER JOIN ExpensesHeadsTable ON ExpensesPaymentVoucherTable.ExpenseID = ExpensesHeadsTable.ID">
                        </asp:SqlDataSource>
                        <asp:SqlDataSource ID="ExpenseDetailsDS" runat="server" 
                            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                            SelectCommand="SELECT ItemName, ExpensesID FROM ExpensesDetailsTable WHERE (ExpensesID = @id)">
                            <SelectParameters>
                                <asp:ControlParameter ControlID="PV" Name="id" PropertyName="Text" />
                            </SelectParameters>
                        </asp:SqlDataSource>
                            ...
                            SelectCommand="SELECT DISTINCT Description, UnitPrice, Qty, Amount FROM Receipt_InvoiceDetailTable WHERE (Receipt_InvoiceNumber = @ID)">
                                     <SelectParameters>
                                         <asp:ControlParameter ControlID="txtSourceNo" Name="ID" PropertyName="Text" />
                                     </SelectParameters>
                        </asp:SqlDataSource>
                            ...
                            SelectCommand="SELECT PurchaseOrderDetailsTable.PurchaseOrderID, PurchaseOrderDetailsTable.Barcode FROM PurchaseOrderDetailsTable INNER JOIN PurchaseOrderHeaderTable ON PurchaseOrderDetailsTable.PurchaseOrderID = PurchaseOrderHeaderTable.PurchaseOrderID WHERE (PurchaseOrderDetailsTable.PurchaseOrderID = @ID)">
                                     <SelectParameters>
                            ...
                            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                            SelectCommand="SELECT [CompanyName], [SupID] FROM [SupplierHeaderTable]">
                        </asp:SqlDataSource>
                 ...
                 <strong>
                     ...
                     Font-Size="Medium" Height="25px" 
                        ...
                        <asp:TextBox ID="DetailID" runat="server" Visible="False" Width="36px" 
                            Wrap="False"></asp:TextBox>
                        <asp:TextBox ID="txtDescription" runat="server" Width="175px" 
                            style="text-align: left" Visible="False"></asp:TextBox>
                        <asp:TextBox ID="txtCompany" runat="server" Width="184px" 
                            style="text-align: left" Visible="False"></asp:TextBox>
                        ...
                        <asp:TextBox ID="POID" runat="server" Visible="False" Width="36px" 
                            Wrap="False"></asp:TextBox>
                        <asp:TextBox ID="PV" runat="server" Visible="False" Width="36px" 
                            Wrap="False"></asp:TextBox>
                                    </strong>
             </td>
         </tr>
