<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_hpgsh0xj" enableeventvalidation="false" %>
         ...
         <tr>
             <td class="style2" colspan="2">
                 ...
                 <asp:Label ID="employeeMgtLabel" runat="server" 
                     Text="View Supplier Account."></asp:Label>
                 <asp:TextBox ID="UpdateTextBox0" runat="server" 
                     ...
                     Font-Size="Medium" Visible="False">Supplier Account.</asp:Label>
             ...
             <td class="style14" colspan="2">
                 ...
                 <asp:GridView ID="GVItem" runat="server" 
                   ...
                   <asp:BoundField DataField="CompanyName" HeaderText="Suppliers" 
                         ...
                         <asp:BoundField DataField="AccountDetail2" HeaderText="AccountDetail 2" 
                             Visible="False" />
         ...
         <tr>
             <td class="style53">
                 ...
                 <asp:SqlDataSource ID="ItemDS" runat="server" 
                     ...
                     SelectCommand="SELECT DISTINCT AccountsPayableTable.ID, SupplierHeaderTable.CompanyName, AccountsPayableTable.TransDate, AccountsPayableTable.Account, AccountsPayableTable.AccountDetail, AccountsPayableTable.AccountDetail2, AccountsPayableTable.Amount, AccountsPayableTable.TransactionType, AccountsPayableTable.Remark, AccountsPayableTable.DateCreated, AccountsPayableTable.CreatedBy FROM AccountsPayableTable INNER JOIN SupplierHeaderTable ON AccountsPayableTable.SupplierID = SupplierHeaderTable.SupID ORDER BY AccountsPayableTable.TransDate DESC">
                 </asp:SqlDataSource>
