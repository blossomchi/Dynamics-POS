<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_v445menk" enableeventvalidation="false" %>
         ...
         <tr>
             <td class="style2" colspan="2">
                 ...
                 <asp:Label ID="employeeMgtLabel" runat="server" 
                     Text="View Surcharge Account."></asp:Label>
         ...
         <tr>
             <td class="style14" colspan="2">
                 ...
                 <asp:GridView ID="GVItem" runat="server" 
                   ...
                   <asp:BoundField DataField="ChargesName" HeaderText="Charges Name" 
         ...
         <tr>
             <td class="style53">
                 ...
                 <asp:SqlDataSource ID="ItemDS" runat="server" 
                     ...
                     SelectCommand="SELECT DISTINCT TransDate, ChargesName, Account, AccountDetail, TransactionType, Amount, Remark, DateCreated, CreatedBy FROM SurchargesAccountTable ORDER BY TransDate DESC">
                 </asp:SqlDataSource>
