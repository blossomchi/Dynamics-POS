<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_egvu0azd" enableeventvalidation="false" %>
...
<img class="xr_ap" src="index_htm_files/14.png" alt="" title="" 
 ...
 <table id="adminInfoTable" runat="server" 
         style="width: 442px; left: 531px; top: 145px; height: 42px; right: 27px; position: absolute;" 
         visible="true">
         <tr>
             <td class="style1" >
         ...
         <tr>
             <td class="style2" colspan="2">
                 ...
                 <asp:Label ID="employeeMgtLabel" runat="server" 
                     Text="View Customer Account."></asp:Label>
             ...
             <td class="style14" colspan="2">
                 ...
                 <asp:GridView ID="GVItem" runat="server" 
                   ...
                   <asp:BoundField DataField="CustomerName" HeaderText="CustomerName" 
                         ...
                         <asp:BoundField DataField="AccountDetail" HeaderText="AccountDetail" 
         ...
         <tr>
             <td class="style53">
                 ...
                 <asp:SqlDataSource ID="ItemDS" runat="server" 
                     ...
                     SelectCommand="SELECT DISTINCT AccountsReceivableTable.ID, CustomerHeaderTable.CustomerName, AccountsReceivableTable.TransDate, AccountsReceivableTable.Account, AccountsReceivableTable.AccountDetail, AccountsReceivableTable.Amount, AccountsReceivableTable.TransactionType, AccountsReceivableTable.Remark, AccountsReceivableTable.DateCreated, AccountsReceivableTable.CreatedBy FROM AccountsReceivableTable INNER JOIN CustomerHeaderTable ON AccountsReceivableTable.CustomerID = CustomerHeaderTable.CusID ORDER BY AccountsReceivableTable.ID DESC, AccountsReceivableTable.TransDate DESC">
                 </asp:SqlDataSource>
