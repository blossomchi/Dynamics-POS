<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_biw0xpro" enableeventvalidation="false" %>
...
<meta name="XAR Files" content="index_htm_files/xr_files.txt"/>
 <title>Complementary Account</title>  
         ...
         <tr>
             <td class="style2" colspan="2">
                 ...
                 <asp:Label ID="employeeMgtLabel" runat="server" 
                     Text="View Complementary Account"></asp:Label>
                 <asp:TextBox ID="UpdateTextBox0" runat="server" 
                     ...
                     Font-Size="Medium" Visible="False">Surcharge Account.</asp:Label>
             ...
             <td class="style14" colspan="2">
                 ...
                 <asp:GridView ID="GVItem" runat="server" 
                   ...
                   <asp:BoundField DataField="SalesID" HeaderText="Sales ID" 
                         ...
                         <asp:BoundField DataField="ComplementaryName" HeaderText="Complementary Name" 
                             SortExpression="ComplementaryName" />
         ...
         <tr>
             <td class="style53">
                 ...
                 <asp:SqlDataSource ID="ItemDS" runat="server" 
                     ...
                     SelectCommand="SELECT DISTINCT TransDate, SalesID, ComplementaryName, Account, AccountDetail, TransactionType, Amount, Remark, DateCreated, CreatedBy FROM ComplementaryAccountTable ORDER BY TransDate DESC">
                 </asp:SqlDataSource>
