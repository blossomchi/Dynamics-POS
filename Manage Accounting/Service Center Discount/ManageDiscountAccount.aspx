<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_4iejq00g" enableeventvalidation="false" %>
         ...
         <tr>
             <td class="style2" colspan="2">
                 ...
                 <asp:Label ID="employeeMgtLabel" runat="server" 
                     Text="View Service Center Discount Account."></asp:Label>
                 <asp:TextBox ID="UpdateTextBox0" runat="server" 
                     ...
                     Font-Size="Medium" Visible="False">Discount Account.</asp:Label>
         ...
         <tr>
             <td class="style53">
                 ...
                 <asp:SqlDataSource ID="ItemDS" runat="server" 
                     ...
                     SelectCommand="SELECT TransDate, JobCardNo, Account, AccountDetail, TransactionType, Amount, Remark, DateCreated, CreatedBy FROM DiscountAllowedAccountOnServiceCenterTable ORDER BY TransDate DESC">
                 </asp:SqlDataSource>
