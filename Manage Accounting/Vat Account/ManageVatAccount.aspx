<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_pwkl5nii" enableeventvalidation="false" %>
         ...
         <tr>
             <td class="style2" colspan="2">
                 ...
                 <asp:Label ID="employeeMgtLabel" runat="server" 
                     Text="View Vat Account."></asp:Label>
                 <asp:TextBox ID="UpdateTextBox0" runat="server" 
                     ...
                     Font-Size="Medium" Visible="False">Vat Account.</asp:Label>
         ...
         <tr>
             <td class="style14" colspan="2">
                 ...
                 <asp:GridView ID="GVItem" runat="server" 
                   ...
                   <asp:BoundField DataField="TaxeName" HeaderText="Vat of" 
                             SortExpression="TaxeName" />
         ...
         <tr>
             <td class="style53">
                 ...
                 <asp:SqlDataSource ID="ItemDS" runat="server" 
                     ...
                     SelectCommand="SELECT TransDate, TaxeName, Account, AccountDetail, TransactionType, Amount, Remark, DateCreated, CreatedBy FROM VatAccountTable ORDER BY TransDate DESC">
                 </asp:SqlDataSource>
