<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_flsdyxum" enableeventvalidation="false" %>
     ...
     <table id="employeeTable" 
         ...
         <tr>
             <td class="style2" colspan="2">
                 ...
                 <asp:Label ID="employeeMgtLabel" runat="server" 
                     Text="View Imprest Account."></asp:Label>
                 <asp:TextBox ID="UpdateTextBox0" runat="server" 
                     ...
                     Font-Size="Medium" Visible="False">Imprest.</asp:Label>
         ...
         <tr>
             <td class="style3" colspan="2">
                 ...
                 <asp:Button ID="DownloadButton" runat="server" Text="Download" Width="95px" 
         ...
         <tr>
             <td class="style14" colspan="2">
                 ...
                 <asp:GridView ID="GVItem" runat="server" 
                     ...
                     PageSize="28" style="font-size: 12px" ShowFooter="True">
                     <AlternatingRowStyle BackColor="#CCCCCC" />
                     <Columns>
                         <asp:BoundField DataField="TransDate" HeaderText="Trans_Date"  
                             SortExpression="TransDate"/>
                         <asp:BoundField DataField="Name" HeaderText="Imprest Type" SortExpression="Name"/>
                   <asp:BoundField DataField="Account" HeaderText="Account" 
                             SortExpression="Account" />
                         <asp:BoundField DataField="AccountDetail" HeaderText="Details" 
                             SortExpression="AccountDetail" />
                         <asp:TemplateField HeaderText="Transaction_Type" SortExpression="TransactionType">
                                                         <ItemTemplate>
                                 <asp:Label ID="Label1" runat="server" Text='<%# Bind("TransactionType") %>'></asp:Label>
                             </ItemTemplate>
                              <FooterTemplate>
                 ...
                 <asp:GridView ID="findBarcodeGridView" runat="server" 
                     ...
                     CellPadding="3" ForeColor="Black" 
                     GridLines="Vertical" Width="989px" Visible="False" 
                     DataSourceID="findBarcodeDS" style="font-size: 12px">
                     <AlternatingRowStyle BackColor="#CCCCCC" />
                     <Columns>
                      <asp:TemplateField>
                     <HeaderTemplate>
         ...
         <tr>
             <td class="style53">
                 ...
                 <asp:SqlDataSource ID="ItemDS" runat="server" 
                     ...
                     SelectCommand="SELECT ImprestAccountTable.TransDate, ImprestDefinitionTable.Name, ImprestAccountTable.Account, ImprestAccountTable.AccountDetail, ImprestAccountTable.TransactionType, ImprestAccountTable.Amount, ImprestAccountTable.Remark, ImprestAccountTable.DateCreated, ImprestAccountTable.CreatedBy FROM ImprestDefinitionTable INNER JOIN ImprestAccountTable ON ImprestDefinitionTable.ID = ImprestAccountTable.ImprestID">
                 </asp:SqlDataSource>
