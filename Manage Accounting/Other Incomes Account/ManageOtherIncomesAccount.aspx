<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_g2nfxetp" enableeventvalidation="false" %>
...
<meta name="XAR Files" content="index_htm_files/xr_files.txt"/>
 <title>Other Income Account</title>  
         ...
         <tr>
             <td class="style2" colspan="2">
                 ...
                 <asp:Label ID="employeeMgtLabel" runat="server" 
                     Text="View Other Incomes Account."></asp:Label>
                 <asp:TextBox ID="UpdateTextBox0" runat="server" 
                     ...
                     Font-Size="Medium" Visible="False">Other Incomes.</asp:Label>
             ...
             <td class="style14" colspan="2">
                 ...
                 <asp:GridView ID="GVItem" runat="server" 
                   ...
                   <asp:BoundField DataField="Account" HeaderText="Account" 
                         ...
                         <asp:BoundField DataField="AccountDetail" HeaderText="Account Detail" 
                             SortExpression="AccountDetail" />
                         <asp:BoundField DataField="TransactionType" HeaderText="Transs Type" 
         ...
         <tr>
             <td class="style53">
                 ...
                 <asp:SqlDataSource ID="ItemDS" runat="server" 
                     ...
                     SelectCommand="SELECT OtherIncomesAccountTable.TransDate, OtherIncomesAccountTable.Account, OtherIncomesAccountTable.AccountDetail, OtherIncomesAccountTable.TransactionType, OtherIncomesAccountTable.Amount, OtherIncomesAccountTable.Remark, OtherIncomesAccountTable.DateCreated, OtherIncomesAccountTable.CreatedBy, OtherIncomeTable.IncomeHead FROM OtherIncomesAccountTable INNER JOIN OtherIncomeTable ON OtherIncomesAccountTable.OtherIncomeID = OtherIncomeTable.ID ORDER BY OtherIncomesAccountTable.TransDate DESC">
                 </asp:SqlDataSource>
