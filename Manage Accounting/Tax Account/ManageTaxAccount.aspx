<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_1pke1qdi" enableeventvalidation="false" %>
         ...
         <tr>
             <td class="style2" colspan="2">
                 ...
                 <asp:Label ID="employeeMgtLabel" runat="server" 
                     Text="View Tax Account."></asp:Label>
                 <asp:TextBox ID="UpdateTextBox0" runat="server" 
                     ...
                     Font-Size="Medium" Visible="False">Tax Account.</asp:Label>
         ...
         <tr>
             <td class="style14" colspan="2">
                 ...
                 <asp:GridView ID="GVItem" runat="server" 
                   ...
                   <asp:BoundField DataField="TaxesHead" HeaderText="Taxes " 
         ...
         <tr>
             <td class="style53">
                 ...
                 <asp:SqlDataSource ID="ItemDS" runat="server" 
                     ...
                     SelectCommand="SELECT DISTINCT TaxesAccountTable.TransDate, TaxesHeadTable.TaxesHead, TaxesAccountTable.Account, TaxesAccountTable.AccountDetail, TaxesAccountTable.TransactionType, TaxesAccountTable.Amount, TaxesAccountTable.Remark, TaxesAccountTable.DateCreated, TaxesAccountTable.CreatedBy FROM TaxesAccountTable INNER JOIN TaxesHeadTable ON TaxesAccountTable.TaxesID = TaxesHeadTable.ID ORDER BY TaxesAccountTable.TransDate DESC">
                 </asp:SqlDataSource>
