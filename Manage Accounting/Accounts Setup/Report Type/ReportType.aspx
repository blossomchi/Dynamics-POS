<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_5ra4vob4" %>
 ...
 <span class="xr_s0" style="position: absolute; left:32px; top:1569px;">
  ...
  <table id="adminInfoTable" runat="server" 
     ...
     <table id="employeeTable" 
                ...
                style="position: absolute; top: 250px; left: 6px; width: 947px; height: 180px;">
         <tr>
             <td class="style2" colspan="2">
                 <strong>
                 <asp:Label ID="employeeMgtLabel" runat="server" 
                     Text="Report Types Management."></asp:Label>
                 <asp:TextBox ID="UpdateTextBox0" runat="server" 
                     ...
                     Font-Size="Medium" Visible="False">Report Types.</asp:Label>
             ...
             <td class="style3" colspan="2">
                 <strong>
                        <asp:DropDownList ID="CBSourceNO0" runat="server" AutoPostBack="True" 
                            DataSourceID="SqlDataSource1" DataTextField="ReportType" DataValueField="ReportType" 
                 ...
                 <asp:Button ID="BackButton" runat="server" Text="Back" Visible="False" 
                     Width="66px" />
                 <asp:Button ID="AddattributeButton" runat="server" Text="Add Types" 
                     Width="118px" ToolTip="Click to add report types" />
                                    </strong>
&nbsp;</td>
         </tr>
         <tr>
             <td class="style14" colspan="2">
                 ...
                 <asp:SqlDataSource ID="findBarcodeDS" runat="server" 
                     ...
                     SelectCommand="SELECT DISTINCT ID, ReportType FROM ReportTypeTable WHERE (ReportType = @Name)">
                     <SelectParameters>
         ...
         <tr>
            ...
            visible="False">
                ...
                <tr>
                    ...
                    <td class="style73">
                        <strong>
                        <asp:TextBox ID="txtReportType" runat="server" Width="281px"></asp:TextBox>
                        <br />
                        </strong>
                    </td>
                </tr>
                <tr>
                 ...
                 <asp:Button ID="saveButton0" runat="server" 
                     Text=" Save New Report Type" 
                     Width="188px" ToolTip=" Save New Report Type" OnClientClick = "Confirm()" />
                        </strong>
                        </td>
                </tr>
                </table>
                 ...
                 <table class="style1" visible="False">
                    ...
                    <td class="style22">
                        ...
                        <asp:TextBox ID="txtRatio" runat="server" Width="20px" 
                            style="text-align: left" Visible="False" MaxLength="100" 
                            ToolTip="Min 0, Max 100"></asp:TextBox>
                        <asp:TextBox ID="txtRepoert" runat="server" Width="20px" 
                            style="text-align: left" Visible="False" MaxLength="100" 
                            ToolTip="Min 0, Max 100"></asp:TextBox>
         ...
         <tr>
             <td class="style53">
                 ...
                 <asp:SqlDataSource ID="ItemDS" runat="server" 
                     ...
                     SelectCommand="SELECT DISTINCT ID, ReportType FROM ReportTypeTable">
                 </asp:SqlDataSource>
                 ...
                 <asp:SqlDataSource ID="searchSqlDataSource2" runat="server" 
                     ...
                     SelectCommand="SELECT ID, ReportType FROM ReportTypeTable WHERE (ReportType = @NAme)">
                     <SelectParameters>
