<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_z2lltcgg" %>
         ...
         <tr>
             <td class="style2" colspan="2">
                 ...
                 <asp:TextBox ID="UpdateTextBox0" runat="server" 
                     ...
                     Font-Size="Medium" Visible="False">Taxes.</asp:Label>
             ...
             <td class="style3" colspan="2">
                 <strong>
                        <asp:DropDownList ID="CBSourceNO0" runat="server" AutoPostBack="True" 
                            DataSourceID="SqlDataSource1" DataTextField="TaxesHead" DataValueField="TaxesHead" 
                 ...
                 <asp:Button ID="btnDelete" runat="server" Text="Delete Selected" 
                     ...
                     Text="Update" 
                     Width="68px" Visible="False" ToolTip="Click to update." />
                 <asp:Button ID="BackButton" runat="server" Text="Back" Visible="False" 
                     Width="66px" />
                 <asp:Button ID="AddattributeButton" runat="server" Text="Taxes" 
                     Width="118px" />
                                    </strong>
&nbsp;</td>
         </tr>
         <tr>
             <td class="style14" colspan="2">
                 ...
                 <asp:GridView ID="GVItem" runat="server" 
                   ...
                   <asp:BoundField DataField="TaxesHead" HeaderText="Tax Head" 
                             SortExpression="TaxesHead" />
                 ...
                 <asp:GridView ID="findBarcodeGridView" runat="server" 
                     ...
                     CellPadding="3" ForeColor="Black" 
                     GridLines="Vertical" Width="989px" Visible="False" 
                     DataSourceID="findBarcodeDS" DataKeyNames="ID">
                     <AlternatingRowStyle BackColor="#CCCCCC" />
                     <Columns>
                         <asp:BoundField DataField="ID" HeaderText="ID" SortExpression="ID" 
                             InsertVisible="False" ReadOnly="True"/>
                         <asp:BoundField DataField="TaxesHead" HeaderText="Taxes Head" 
                             SortExpression="TaxesHead" />
                         <asp:BoundField DataField="DateCreated" HeaderText="Date Created" 
                             SortExpression="DateCreated" />
                         <asp:BoundField DataField="CreatedBy" HeaderText="Created By" 
                 ...
                 <asp:SqlDataSource ID="findBarcodeDS" runat="server" 
                     ...
                     SelectCommand="SELECT DISTINCT ID, TaxesHead, DateCreated, CreatedBy FROM TaxesHeadTable WHERE (TaxesHead = @Name)">
                     <SelectParameters>
            ...
            visible="False">
                ...
                <tr>
                    <td class="style71">
                     ...
                     Text="Search" 
                     Width="68px" ToolTip="Search by name" />
                    </td>
                    <td class="style72">
                        Tax Name:</td>
                    <td class="style73">
                        <strong>
                        <asp:TextBox ID="txtTax" runat="server" Width="281px"></asp:TextBox>
                        <br />
                        </strong>
                    </td>
                </tr>
                <tr>
                    <td class="style66">
                        <asp:GridView ID="SearchGridView1" runat="server" AllowPaging="True" 
                            ...
                            GridLines="Vertical" Width="312px" DataKeyNames="ID" ShowFooter="True">
                            <AlternatingRowStyle BackColor="#CCCCCC" />
                            <Columns>
                        ...
                        <asp:GridView ID="SearchGridView2" runat="server" AllowPaging="True" 
                            ...
                            PageSize="5" Visible="False" Width="312px" DataKeyNames="ID" 
                            ShowFooter="True">
                            <AlternatingRowStyle BackColor="#CCCCCC" />
                            <Columns>
                                <asp:BoundField DataField="ID" HeaderText="ID" 
                 ...
                 <asp:Button ID="saveButton0" runat="server" 
                     Text="Save New Tax" 
                     Width="188px" ToolTip="Save new taxes" OnClientClick = "Confirm()" />
                        </strong>
                        </td>
                </tr>
                </table>
                 ...
                 <table class="style1" visible="False">
                    ...
                    <td class="style22">
                        ...
                        <asp:TextBox ID="txtRatio" runat="server" Width="20px" 
                            style="text-align: left" Visible="False" MaxLength="100" 
                            ToolTip="Min 0, Max 100"></asp:TextBox>
                        <asp:TextBox ID="txtTa" runat="server" Width="20px" 
                            style="text-align: left" Visible="False" MaxLength="100" 
                            ToolTip="Min 0, Max 100"></asp:TextBox>
         ...
         <tr>
             <td class="style53">
                 ...
                 <asp:SqlDataSource ID="ItemDS" runat="server" 
                     ...
                     SelectCommand="SELECT DISTINCT ID, TaxesHead, DateCreated, CreatedBy FROM TaxesHeadTable">
                 </asp:SqlDataSource>

                 <asp:SqlDataSource ID="searchviewSqlDataSource2" runat="server" 
                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                     
                     SelectCommand="SELECT ID, TaxesHead FROM TaxesHeadTable">
                 </asp:SqlDataSource>
                 <asp:SqlDataSource ID="searchSqlDataSource2" runat="server" 
                     ...
                     SelectCommand="SELECT ID, TaxesHead FROM TaxesHeadTable WHERE (TaxesHead = @Name)">
                     <SelectParameters>
                         <asp:ControlParameter ControlID="viewIDTextBox0" Name="Name" 
                             PropertyName="Text" />
                     </SelectParameters>
                 </asp:SqlDataSource>
                     ...
                     Text="Name" 
                     Width="107px" ToolTip="Search by name" Visible="False" />
