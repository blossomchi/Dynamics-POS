<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_3syj22vq" %>
         ...
         <tr>
             <td class="style2" colspan="2">
                 ...
                 <asp:TextBox ID="UpdateTextBox0" runat="server" 
                     ...
                     Font-Size="Medium" Visible="False">Enter Loan.</asp:Label>
         ...
         <tr>
             <td class="style3" colspan="2">
                 ...
                 <asp:Button ID="BackButton" runat="server" Text="Back" Visible="False" 
                     Width="66px" />
                 <asp:Button ID="AddattributeButton" runat="server" Text="Loan" 
                     Width="118px" />
                                    </strong>
&nbsp;</td>
         </tr>
         <tr>
             <td class="style14" colspan="2">
                 ...
                 <asp:GridView ID="GVItem" runat="server" 
                   ...
                   <asp:BoundField DataField="LoanName" HeaderText="Loan Name" 
                             SortExpression="LoanName" />
                 ...
                 <asp:SqlDataSource ID="findBarcodeDS" runat="server" 
                     ...
                     SelectCommand="SELECT DISTINCT ID, LoanName, DateCreated, CreatedBy FROM LoanDefinitionTable WHERE (LoanName = @Name)">
                     <SelectParameters>
            ...
            visible="False">
                ...
                <tr>
                 ...
                 <asp:Button ID="saveButton0" runat="server" 
                     Text="Save New Loan" 
                     Width="188px" ToolTip="Save new loan" OnClientClick = "Confirm()" />
                        </strong>
                        </td>
                </tr>
                </table>
         ...
         <tr>
             <td class="style53">
                 ...
                 <asp:SqlDataSource ID="ItemDS" runat="server" 
                     ...
                     SelectCommand="SELECT DISTINCT ID, LoanName, DateCreated, CreatedBy FROM LoanDefinitionTable">
                 </asp:SqlDataSource>
                 ...
                 <asp:SqlDataSource ID="searchviewSqlDataSource2" runat="server" 
                     ...
                     SelectCommand="SELECT [ID], [LoanName] FROM [LoanDefinitionTable]">
                 </asp:SqlDataSource>
                 <asp:SqlDataSource ID="searchSqlDataSource2" runat="server" 
                     ...
                     SelectCommand="SELECT ID, LoanName FROM LoanDefinitionTable WHERE (LoanName = @Name)">
                     <SelectParameters>
