<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_oxvrgrvr" %>
         ...
         <tr>
             <td class="style2" colspan="2">
                 ...
                 <asp:Label ID="employeeMgtLabel" runat="server" 
                     Text="Manage Other Income."></asp:Label>
                 <asp:TextBox ID="UpdateTextBox0" runat="server" 
                     ...
                     Font-Size="Medium" Visible="False">Other Income.</asp:Label>
             ...
             <td class="style3" colspan="2">
                 <strong>
                        <asp:DropDownList ID="CBSourceNO0" runat="server" AutoPostBack="True" 
                            DataSourceID="SqlDataSource1" DataTextField="IncomeHead" DataValueField="IncomeHead" 
                 ...
                 <asp:Button ID="BackButton" runat="server" Text="Back" Visible="False" 
                     Width="66px" />
                 <asp:Button ID="AddattributeButton" runat="server" Text="Other Income" 
                     Width="118px" />
                                    </strong>
&nbsp;</td>
         </tr>
         <tr>
             <td class="style14" colspan="2">
                 ...
                 <asp:GridView ID="GVItem" runat="server" 
                   ...
                   <asp:BoundField DataField="IncomeHead" HeaderText="Income Head" 
                             SortExpression="IncomeHead" />
                 ...
                 <asp:SqlDataSource ID="findBarcodeDS" runat="server" 
                     ...
                     SelectCommand="SELECT DISTINCT ID, IncomeHead, DateCreated, CreatedBy FROM OtherIncomeTable WHERE (IncomeHead = @Name)">
                     <SelectParameters>
            ...
            visible="False">
                ...
                <tr>
                 ...
                 <asp:Button ID="saveButton0" runat="server" 
                     Text="Save New Income" 
                     Width="188px" ToolTip="Save new income" OnClientClick = "Confirm()" />
                        </strong>
                        </td>
                </tr>
                </table>
                 ...
                 <table class="style1" visible="False">
                    ...
                    <td class="style22">
                        ...
                        <asp:TextBox ID="txtRatio" runat="server" Width="20px" 
                            style="text-align: left" Visible="False" MaxLength="100" 
                            ToolTip="Min 0, Max 100"></asp:TextBox>
                        <asp:TextBox ID="txtOther" runat="server" Width="20px" 
                            style="text-align: left" Visible="False" MaxLength="100" 
                            ToolTip="Min 0, Max 100"></asp:TextBox>
         ...
         <tr>
             <td class="style53">
                 ...
                 <asp:SqlDataSource ID="ItemDS" runat="server" 
                     ...
                     SelectCommand="SELECT DISTINCT ID, IncomeHead, DateCreated, CreatedBy FROM OtherIncomeTable">
                 </asp:SqlDataSource>
                 ...
                 <asp:SqlDataSource ID="searchviewSqlDataSource2" runat="server" 
                     ...
                     SelectCommand="SELECT [ID], [IncomeHead] FROM [OtherIncomeTable]">
                 </asp:SqlDataSource>
                 <asp:SqlDataSource ID="searchSqlDataSource2" runat="server" 
                     ...
                     SelectCommand="SELECT ID, IncomeHead FROM OtherIncomeTable WHERE (IncomeHead = @Name)">
                     <SelectParameters>
