<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_wabslcxl" %>
         ...
         <tr>
             <td class="style2" colspan="2">
                 ...
                 <asp:Label ID="employeeMgtLabel" runat="server" 
                     Text="Chart Of Accounts Management."></asp:Label>
                 <asp:TextBox ID="UpdateTextBox0" runat="server" 
                     ...
                     Font-Size="Medium" Visible="False">Chart of Accounts.</asp:Label>
             ...
             <td class="style3" colspan="2">
                 <strong>
                        <asp:DropDownList ID="CBSourceNO0" runat="server" AutoPostBack="True" 
                            DataSourceID="SqlDataSource1" DataTextField="AccountName" DataValueField="AccountName" 
                 ...
                 <asp:Button ID="BackButton" runat="server" Text="Back" Visible="False" 
                     Width="66px" />
                 <asp:Button ID="AddattributeButton" runat="server" Text="Account" 
                     Width="118px" />
                                    </strong>
&nbsp;</td>
         </tr>
         <tr>
             <td class="style14" colspan="2">
                 ...
                 <asp:GridView ID="GVItem" runat="server" 
                     ...
                     DataSourceID="ItemDS" AllowPaging="True" DataKeyNames="AccountID" 
...
onclick = "Check_Click(this)"/>
                   ...
                   <asp:BoundField DataField="AccountName" HeaderText="Account " 
                         ...
                         <asp:BoundField DataField="AssetOrLiability" 
                             HeaderText="Asset Or Liability" SortExpression="AssetOrLiability"/>
                         <asp:BoundField DataField="CurrentOrNonCurrent" 
                             HeaderText="Current Or NonCurrent" SortExpression="CurrentOrNonCurrent"/>
                         <asp:BoundField DataField="IncomeOrExpense" HeaderText="Income Or Expense" SortExpression="IncomeOrExpense" />
                         <asp:BoundField DataField="Cash_Bank_Relationship" 
                             HeaderText="Cash_Bank Relationship" SortExpression="Cash_Bank_Relationship"/>
                        ...
                        <asp:TemplateField ShowHeader="False" Visible="False">
                             <ItemTemplate>
                                 <asp:ImageButton ID="ImageButton1" runat="server" CausesValidation="false" 
                                  CommandName="DeleteChart" ImageUrl="~/images/property/del.png" Text="Delete" Tooltip="Delete"  CommandArgument='<%#Eval("AccountID") %>' />
                             </ItemTemplate>
                         </asp:TemplateField>
                     </Columns>
                 ...
                 <asp:GridView ID="findBarcodeGridView" runat="server" 
                     ...
                     CellPadding="3" ForeColor="Black" 
                     GridLines="Vertical" Width="989px" Visible="False" 
                     DataSourceID="findBarcodeDS" AllowPaging="True" DataKeyNames="AccountName">
                     <AlternatingRowStyle BackColor="#CCCCCC" />
                     <Columns>
                         <asp:BoundField DataField="AccountID" HeaderText="AccountID" 
                             SortExpression="AccountID" InsertVisible="False" ReadOnly="True"/>
                         <asp:BoundField DataField="AccountName" HeaderText="AccountName" 
                             SortExpression="AccountName" ReadOnly="True" />
                         <asp:BoundField DataField="AssetOrLiability" HeaderText="AssetOrLiability" 
                             SortExpression="AssetOrLiability" />
                         <asp:BoundField DataField="CurrentOrNonCurrent" HeaderText="Current Or Non-Current" 
                             SortExpression="CurrentOrNonCurrent" />
                         <asp:BoundField DataField="IncomeOrExpense" HeaderText="Income Or Expense" 
                             SortExpression="IncomeOrExpense" />
                         <asp:BoundField DataField="Cash_Bank_Relationship" HeaderText="Cash_Bank_Relationship" 
                             SortExpression="Cash_Bank_Relationship" />
                 ...
                 <asp:SqlDataSource ID="findBarcodeDS" runat="server" 
                     ...
                     SelectCommand="SELECT DISTINCT AccountChartTable.AccountID, AccountChartTable.AccountName, AssetOrLiabilityTable.AssetOrLiability, CurrentOrNonCurrentTable.CurrentOrNonCurrent, Cash_Bank_RelationshipTable.Cash_Bank_Relationship, ReportTypeTable.ReportType, AccountChartTable.Description, AccountChartTable.IncomeOrExpense FROM AccountChartTable INNER JOIN AssetOrLiabilityTable ON AccountChartTable.AssetOrLiability = AssetOrLiabilityTable.ID INNER JOIN Cash_Bank_RelationshipTable ON AccountChartTable.Cash_Bank_Relationship = Cash_Bank_RelationshipTable.ID INNER JOIN CurrentOrNonCurrentTable ON AccountChartTable.CurrentOrNonCurrent = CurrentOrNonCurrentTable.ID INNER JOIN ReportTypeTable ON AccountChartTable.ReportType = ReportTypeTable.ID WHERE (AccountChartTable.AccountName = @AccountName)">
                     <SelectParameters>
            ...
            visible="False" align="left" bgcolor="#DBD7CB">
                ...
                <tr>
                    ...
                    <td class="style63" valign="top">
                        ...
                        <asp:DropDownList ID="cbAL" runat="server" DataSourceID="AssetLiabilityDS" 
                            DataTextField="AssetOrLiability" DataValueField="ID" Height="20px" 
                            Width="207px">
                        </asp:DropDownList>
                    </td>
                    <td class="style63" valign="top">
                ...
                <tr>
                    <td class="style64" valign="top">
                        ...
                        Current/Non Current:</td>
                    <td class="style63" valign="top">

                        <asp:DropDownList ID="cbCurrentNonCurrent" runat="server" DataSourceID="CNCDS" 
                            DataTextField="CurrentOrNonCurrent" DataValueField="ID" Width="207px">
                        </asp:DropDownList>
                    </td>
                    <td class="style63" valign="top">
                ...
                <tr>
                    ...
                    <td class="style63" valign="top">
                        ...
                        <asp:DropDownList ID="CBIncomeExpense" runat="server" Height="20px" 
                            Width="207px">
                ...
                <tr>
                    <td class="style64" valign="top">
                        ...
                        Cash/Bank RelationShip:</td>
                    <td class="style63" valign="top">

                        <asp:DropDownList ID="cbCB" runat="server" DataSourceID="CBRelationshipSD" 
                            DataTextField="Cash_Bank_Relationship" DataValueField="ID" Width="207px">
                        </asp:DropDownList>
                    </td>
                    <td class="style63" valign="top">
                ...
                <tr>
                    ...
                    <td class="style63" valign="top">
                        ...
                        <asp:DropDownList ID="cbReport" runat="server" DataSourceID="ReportDS" 
                            DataTextField="ReportType" DataValueField="ID" Width="207px">
                        </asp:DropDownList>
                    </td>
                    <td class="style63" valign="top">
         ...
         <tr>
             <td class="style53">
                 ...
                 <asp:SqlDataSource ID="ItemDS" runat="server" 
                     ...
                     SelectCommand="SELECT DISTINCT AccountChartTable.AccountID, AccountChartTable.AccountName, AssetOrLiabilityTable.AssetOrLiability, CurrentOrNonCurrentTable.CurrentOrNonCurrent, Cash_Bank_RelationshipTable.Cash_Bank_Relationship, ReportTypeTable.ReportType, AccountChartTable.Description, AccountChartTable.IncomeOrExpense FROM AccountChartTable INNER JOIN AssetOrLiabilityTable ON AccountChartTable.AssetOrLiability = AssetOrLiabilityTable.ID INNER JOIN Cash_Bank_RelationshipTable ON AccountChartTable.Cash_Bank_Relationship = Cash_Bank_RelationshipTable.ID INNER JOIN CurrentOrNonCurrentTable ON AccountChartTable.CurrentOrNonCurrent = CurrentOrNonCurrentTable.ID INNER JOIN ReportTypeTable ON AccountChartTable.ReportType = ReportTypeTable.ID">
                 </asp:SqlDataSource>

                        <asp:SqlDataSource ID="AssetLiabilityDS" runat="server" 
                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                     SelectCommand="SELECT [ID], [AssetOrLiability] FROM [AssetOrLiabilityTable]">
                 </asp:SqlDataSource>
                 <asp:SqlDataSource ID="CBRelationshipSD" runat="server" 
                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                     SelectCommand="SELECT [ID], [Cash_Bank_Relationship] FROM [Cash_Bank_RelationshipTable]">
                 </asp:SqlDataSource>
                 <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                     SelectCommand="SELECT AccountID, AccountName FROM AccountChartTable ORDER BY AccountID">
                 </asp:SqlDataSource>
                 <asp:SqlDataSource ID="ReportDS" runat="server" 
                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                     SelectCommand="SELECT [ID], [ReportType] FROM [ReportTypeTable]">
                 </asp:SqlDataSource>
                 <asp:SqlDataSource ID="CNCDS" runat="server" 
                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                     SelectCommand="SELECT [ID], [CurrentOrNonCurrent] FROM [CurrentOrNonCurrentTable]">
                 </asp:SqlDataSource>
