<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_w2gzlqro" %>
         ...
         <tr>
             <td class="style2" colspan="2">
                 ...
                 <asp:Label ID="employeeMgtLabel" runat="server" 
                     Text="Manage Expense Head."></asp:Label>
                 <asp:TextBox ID="UpdateTextBox0" runat="server" 
                     ...
                     Font-Size="Medium" Visible="False">Add Expense Head</asp:Label>
             ...
             <td class="style3" colspan="2">
                 <strong>
                        <asp:DropDownList ID="CBSourceNO0" runat="server" AutoPostBack="True" 
                            DataSourceID="SqlDataSource1" DataTextField="ExpenseHead" DataValueField="ExpenseHead" 
                 ...
                 <asp:Button ID="BackButton" runat="server" Text="Back" Visible="False" 
                     Width="66px" />
                 <asp:Button ID="AddattributeButton" runat="server" Text="Expense Head" 
                     Width="118px" />
                                    </strong>
&nbsp;</td>
         </tr>
         <tr>
             <td class="style14" colspan="2">
                 ...
                 <asp:GridView ID="GVItem" runat="server" 
                   ...
                   <asp:BoundField DataField="ExpenseHead" HeaderText="Expense Head Name" 
                 ...
                 <asp:SqlDataSource ID="findBarcodeDS" runat="server" 
                     ...
                     SelectCommand="SELECT DISTINCT ID, ExpenseHead FROM ExpensesHeadsTable WHERE (ExpenseHead = @Name)">
                     <SelectParameters>
             ...
             <td class="style14" colspan="2" valign="top">
                        ...
                        <table id="AddHeadTable" runat="server" visible="False" 
                            ...
                            <tr>
                                ...
                                <td class="style125" valign="top" rowspan="3" >
                      
                        

                                    <asp:GridView ID="HeadGridView" runat="server" AutoGenerateColumns="False" 
                                        DataSourceID="Head" Width="398px" AllowPaging="True" 
                                        PageSize="2" DataKeyNames="ID" style="font-size: 11px" Visible="False">
                                        <Columns>
                     ...
                     Width="66px" ToolTip="Click to save unlock expense head." />
                            ...
                            <tr>
                                ...
                                <td class="style125" valign="top" rowspan="2" >
                      
                        

                                    <asp:GridView ID="DetailGridView" runat="server" AutoGenerateColumns="False" 
                                        DataSourceID="HeadDS" Width="398px" AllowPaging="True" 
                                        PageSize="4" style="font-size: 11px" Visible="False">
                                        <Columns>
                                            <asp:BoundField DataField="ID" HeaderText="S/N"  SortExpression="ID"/>
                                            <asp:BoundField DataField="ExpensesName" HeaderText="Details Name" 
         ...
         <tr>
             <td class="style53">
                 ...
                 <asp:SqlDataSource ID="ItemDS" runat="server" 
                     ...
                     SelectCommand="SELECT DISTINCT ID, ExpenseHead FROM ExpensesHeadsTable">
                 </asp:SqlDataSource>
                 ...
                 <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                     ...
                     SelectCommand="SELECT ExpenseHeadDetailTable.ExpensesName, ExpenseHeadDetailTable.Description, ExpenseHeadDetailTable.ID FROM ExpensesHeadsTable INNER JOIN ExpenseHeadDetailTable ON ExpensesHeadsTable.ID = ExpenseHeadDetailTable.ExpenseHeadID WHERE (ExpensesHeadsTable.ExpenseHead = @Name)">
                                        <SelectParameters>
                                            <asp:ControlParameter ControlID="txtName" Name="Name" PropertyName="Text" />
                                        </SelectParameters>
                                    </asp:SqlDataSource>
                                <asp:SqlDataSource ID="Head" runat="server" 
                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                     SelectCommand="SELECT ID, ExpenseHead FROM ExpensesHeadsTable WHERE (ExpenseHead = @Name)">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="txtName" Name="Name" PropertyName="Text" />
                                    </SelectParameters>
                 </asp:SqlDataSource>
             ...
             <td class="style4">
                 ...
                 <strong>
                        ...
                        <asp:TextBox ID="ID0" runat="server" Width="16px" 
                            style="text-align: left" Visible="False"></asp:TextBox>
