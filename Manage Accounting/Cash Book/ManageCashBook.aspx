<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_3h2d2o0b" %>
...
<div class="xr_ap" id="xr_xr" 
 ...
 &nbsp;<!--[if IE]><div class="xr_ap" id="xr_xri" 
       style="width: 1000px; height: 1683px; clip: rect(0px 1000px 1600px 0px); top: 0px; left: 4px;"><![endif]-->
<!--[if !IE]>--><div class="xr_ap" id="xr_xri" 
            style="width: 1000px; height: 1682px; clip: rect(0px, 1000px, 1600px, 0px); top: -4px; left: 18px;"><!--<![endif]-->
 ...
 <span class="xr_s0" style="position: absolute; left:32px; top:1569px;">
  ...
  <table id="adminInfoTable" runat="server" 
         style="width: 442px; left: 531px; top: 147px; height: 42px; right: 27px; position: absolute;" 
         visible="true">
         <tr>
             <td class="style1" >
     ...
     <table id="employeeTable" 
         ...
         <tr>
             <td class="style2" colspan="2">
                 ...
                 <asp:TextBox ID="UpdateTextBox0" runat="server" 
                     ...
                     Font-Size="Medium" Visible="False">Cash Book.</asp:Label>
         ...
         <tr>
             <td class="style3" colspan="2">
                 <strong>
                        ...
                        <asp:DropDownList ID="CBSearch0" runat="server" AutoPostBack="True" 
                            DataSourceID="SearchDS" DataTextField="Account" DataValueField="Account" 
                 ...
                 <asp:Button ID="BackButton" runat="server" Text="Back" Visible="False" 
                     Width="66px" />
                 <asp:Button ID="AddattributeButton" runat="server" Text="Receive Cash" 
                     Width="118px" />
                 <asp:Button ID="AddattributeButton1" runat="server" Text="Disburse Cash" 
                     Width="118px" />
                                    </strong>&nbsp;</td>
         </tr>
         <tr>
             <td class="style14" colspan="2">
                 ...
                 <asp:GridView ID="GVItem" runat="server" 
                     ...
                     DataSourceID="ItemDS" AllowPaging="True" 
                     PageSize="29" style="font-size: 11px">
                   ...
                   <asp:BoundField DataField="Account" HeaderText="Account" 
                         ...
                         <asp:BoundField DataField="AccountDetail" HeaderText="Details 1" 
                             SortExpression="AccountDetail" />
                         <asp:BoundField DataField="AccountDetails" HeaderText="Details 2" 
                             SortExpression="AccountDetails"/>
                         ...
                         <asp:BoundField DataField="Remark" HeaderText="Remark" 
                             SortExpression="Remark" />
                              <asp:BoundField DataField="DateCreated" HeaderText="Entry Date" 
                             SortExpression="DateCreated" />
                         <asp:BoundField DataField="CreatedBy" HeaderText="Entered By" 
                         ...
                         <asp:TemplateField ShowHeader="False" Visible="False">
                             <ItemTemplate>
                                 <asp:ImageButton ID="ImageButton1" runat="server" CausesValidation="false" 
                                  CommandName="DeleteFreeItem" ImageUrl="~/images/property/del.png" Text="Delete" Tooltip="Delete"/>
                             </ItemTemplate>
                         </asp:TemplateField>
                         <asp:TemplateField ShowHeader="False">
                             <ItemTemplate>
                                 <asp:ImageButton ID="ImageButton2" runat="server" CausesValidation="false" 
                                     CommandName="DisplayReciept" ImageUrl="~/images/magnify.jpg" Text="Print" ToolTip="Display Receipt" CommandArgument='<%#Eval("ID") %>'/>
                             </ItemTemplate>
                         </asp:TemplateField>
                     </Columns>
                 ...
                 <asp:GridView ID="findBarcodeGridView" runat="server" 
                     ...
                     CellPadding="3" ForeColor="Black" 
                     GridLines="Vertical" Width="989px" Visible="False" 
                     DataSourceID="findBarcodeDS" CssClass="auto-style1" DataKeyNames="ID" AllowPaging="True" PageSize="25">
                     <AlternatingRowStyle BackColor="#CCCCCC" />
                     <Columns>
                         <asp:BoundField DataField="ID" HeaderText="ID" InsertVisible="False" ReadOnly="True" SortExpression="ID" Visible="False" />
                         ...
                         <asp:BoundField DataField="Account" HeaderText="Account" 
                             SortExpression="Account" />
                         <asp:BoundField DataField="AccountDetail" HeaderText="Detail 1" 
                             SortExpression="AccountDetail" />
                         ...
                         <asp:BoundField DataField="DateUpdated" HeaderText="DateUpdated" SortExpression="DateUpdated" Visible="False" />
                 ...
                 <asp:SqlDataSource ID="findBarcodeDS" runat="server" 
                     ...
                     SelectCommand="SELECT TransDate, Account, AccountDetail, TransactionType, Amount, Remark, DateCreated, CreatedBy, DateUpdated, UpdatedBy, Cash_Bank, AccountDetails, ID FROM CashAccountTable WHERE (Account = @AccountName) ORDER BY DateCreated DESC, TransDate DESC">
                     <SelectParameters>
                         <asp:ControlParameter ControlID="findTextBox" Name="AccountName" 
                             PropertyName="Text" />
                     </SelectParameters>
                 </asp:SqlDataSource>

                 <strong>
                                    <asp:SqlDataSource ID="SearchDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT Account FROM CashAccountTable GROUP BY Account HAVING (Account = N'Account Receivables')"></asp:SqlDataSource>
                                    </strong>
            ...
            visible="False" align="left" bgcolor="#DBD7CB">
                ...
                <tr>
                    ...
                    <td class="style70" valign="top">
                        ...
                        <asp:DropDownList ID="cbCashBank" runat="server" Height="19px" Width="259px" 
                            class="chosen-select" AutoPostBack="True">
                            <asp:ListItem>Cash</asp:ListItem>
                            <asp:ListItem>Bank</asp:ListItem>
                            
                        </asp:DropDownList>
                        <asp:DropDownList ID="cbBankType" runat="server" Height="19px" 
                            Width="200px" Visible="False" class="chosen-select" AutoPostBack="True">
                    ...
                    <td class="style72" valign="top" align="right">

                        Entry Date:</td>
                    <td class="style71" valign="top">

                        <asp:TextBox ID="txtDate" runat="server" Height="20px" ReadOnly="True" 
                ...
                <tr>
                    ...
                    <td class="style70" valign="top">
                        ...
                        <asp:DropDownList ID="cbTransactionType" runat="server" Enabled="False" 
                            Height="19px" Width="259px">
                    ...
                    <td class="style71" valign="top">
                        ...
                        <asp:TextBox ID="txtEnteredBY" runat="server" Height="20px" ReadOnly="True" 
                            Width="253px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="style67" valign="top">
                        ...
                        <asp:TextBox ID="txtTransDate" runat="server" Height="20px" Width="253px" 
                    ...
                    <td class="style73" valign="top" align="right" rowspan="2">
                ...
                <tr>
                    ...
                    <td class="style68" valign="top">
                        ...
                        <asp:DropDownList ID="cbAccount" runat="server" DataSourceID="ChartDS" 
                            DataTextField="AccountName" DataValueField="AccountID" Height="19px" 
                            Width="259px" AutoPostBack="True" class="chosen-select">
                            <asp:ListItem>DR</asp:ListItem>
                            <asp:ListItem>CR</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                ...
                <tr>
                    ...
                    <td class="style220" valign="top">
                        ...
                        <asp:DropDownList ID="cbAccountDetails" runat="server" Height="19px" 
                            Width="259px" AutoPostBack="True" class="chosen-select">
                        </asp:DropDownList>
                        <asp:DropDownList ID="cbPurchaseOrder" runat="server" Height="19px" 
                            Width="200px" Visible="False" class="chosen-select" AutoPostBack="True">
                        </asp:DropDownList>
                    </td>
                    <td class="style73" valign="top" align="right" rowspan="3">

                        &nbsp;</td>
                    <td class="style73" valign="top" align="right" rowspan="3">

                                    <asp:GridView ID="CreditGV" runat="server" 
                            AutoGenerateColumns="False" Width="200px" 
                            AllowPaging="True" style="font-size: 11px; text-align: left;" Visible="False" 
                            ToolTip="Detail View on credit" PageSize="6" DataSourceID="CreditDS">
                                        <Columns>
                                            <asp:BoundField DataField="Payment Method" HeaderText="Payment Method" 
                                                SortExpression="Payment Method" />
                                            <asp:BoundField DataField="AmountPaid" HeaderText="Amount" 
                                                SortExpression="AmountPaid" />
                                        </Columns>
                                    </asp:GridView>
                        
                                    <asp:GridView ID="ExpensePaymentViewGV0" runat="server" 
                            AutoGenerateColumns="False" Width="200px" 
                            AllowPaging="True" style="font-size: 11px; text-align: left;" Visible="False" 
                            ToolTip="Detail view on expenses that was disbursed." PageSize="6" DataSourceID="viewDS">
                                        <Columns>
                                            <asp:BoundField DataField="PVID" HeaderText="PVID" SortExpression="PVID" 
                                                Visible="False" />
                                            <asp:BoundField DataField="Payment Method" HeaderText="Payment Method" 
                                                ReadOnly="True" SortExpression="Payment Method" />
                                            <asp:BoundField DataField="AmountPaid" HeaderText="Amount Paid" ReadOnly="True" 
                                                SortExpression="AmountPaid" />
                                            <asp:BoundField DataField="ExpenseHeaderID" HeaderText="ExpenseHeaderID" 
                                                SortExpression="ExpenseHeaderID" Visible="False" />
                                        </Columns>
                                    </asp:GridView>
                ...
                <tr>
                    ...
                    <td class="style67" valign="top">
                     ...
                     Width="99px" ToolTip="Convert from one currency to another." Visible="False" />
                                 </strong>
                ...
                <tr>
                    ...
                    <td class="style67" valign="top">
                        ...
                        <asp:TextBox ID="txtRemark" runat="server" Height="64px" Width="253px" 
         ...
         <tr>
             <td class="style77" colspan="2" valign="top">
                 ...
                 <table style="background-position: center; border-style: solid; border-width: medium; width: 989px; margin-left: 0px; height: 40px; background-image: url('../Customer%20Account/images/eeee.gif'); background-repeat: repeat;" 
                     id="SaveCancelledTable" runat="server" 
            visible="False" align="left" bgcolor="#DBD7CB">
                <tr>
         ...
         <tr>
             <td class="style14" colspan="2" style="position: absolute; top: 90px" 
                 valign="top">

                 <table style="background-position: center; border-style: solid; border-width: medium; width: 989px; margin-left: 0px; height: 204px; background-image: url('images/eeee.gif'); background-repeat: repeat;" 
                     id="disburseTable" runat="server" 
            visible="False" align="left" bgcolor="#DBD7CB">
                <tr>
                    <td class="style63" valign="top" colspan="4">

                        <strong>DISBURSE CASH</strong></td>
                </tr>
                <tr>
                    ...
                    <td class="style78" valign="top">
                        ...
                        <asp:DropDownList ID="cbCashBank0" runat="server" Height="19px" Width="259px" 
                            class="chosen-select" AutoPostBack="True">
                            <asp:ListItem>Cash</asp:ListItem>
                            <asp:ListItem>Bank</asp:ListItem>
                        </asp:DropDownList>
                        <asp:DropDownList ID="cbBankType0" runat="server" Height="19px" 
                            Width="200px" Visible="False" class="chosen-select" AutoPostBack="True">
                            <asp:ListItem>Card</asp:ListItem>
                            <asp:ListItem>Cheque</asp:ListItem>
                            <asp:ListItem>Electronic Transfer</asp:ListItem>
                    ...
                    <td class="style63" valign="top">
                        ...
                        <asp:TextBox ID="txtDisburseDate" runat="server" Height="20px" ReadOnly="True" 
                            Width="253px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="style78" valign="top">
                        ...
                        <asp:DropDownList ID="cbTransactionType0" runat="server" Enabled="False" 
                            Height="19px" Width="259px">
                            <asp:ListItem>CR</asp:ListItem>
                            <asp:ListItem>DR</asp:ListItem>
                        </asp:DropDownList>
                    ...
                    <td class="style63" valign="top">
                        ...
                        <asp:TextBox ID="txtDisEnteredBY" runat="server" Height="20px" ReadOnly="True" 
                            Width="253px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="style78" valign="top">
                        ...
                        <asp:TextBox ID="txtTransDate0" runat="server" Height="20px" Width="253px" 
                            ReadOnly="True"></asp:TextBox>
                                 <strong > 
                ...
                <tr>
                    ...
                    <td class="style78" valign="top">
                        ...
                        <asp:DropDownList ID="cbAccount0" runat="server" DataSourceID="DisburseDS" 
                            DataTextField="AccountName" DataValueField="AccountID" Height="19px" 
                            Width="259px" AutoPostBack="True" class="chosen-select">
                            <asp:ListItem>DR</asp:ListItem>
                            <asp:ListItem>CR</asp:ListItem>
                    ...
                    <td class="style63" valign="top" rowspan="4">

                        &nbsp;&nbsp;&nbsp; </td>
                    <td class="style63" valign="top" rowspan="4">

                                    <asp:GridView ID="ExpensePaymentViewGV" runat="server" 
                            AutoGenerateColumns="False" Width="200px" 
                            AllowPaging="True" style="font-size: 11px" Visible="False" 
                            ToolTip="Detail view on expense." PageSize="6" DataSourceID="viewDS">
                                        <Columns>
                                            <asp:BoundField DataField="PVID" HeaderText="PVID" SortExpression="PVID" 
                                                Visible="False" />
                                            <asp:BoundField DataField="Payment Method" HeaderText="Payment Method" 
                                    ...
                                    <asp:GridView ID="PurchasePaymentViewGV" runat="server" 
                            AutoGenerateColumns="False" Width="200px" 
                            AllowPaging="True" style="font-size: 11px" Visible="False" 
                            ToolTip="Detail view on expense." PageSize="6" DataSourceID="PurchaseDS">
                                        <Columns>
                                            <asp:BoundField DataField="Payment Method" HeaderText="Payment Method" 
                                                SortExpression="Payment Method" ReadOnly="True" />
                ...
                <tr>
                    ...
                    <td class="style78" valign="top">
                        ...
                        <asp:DropDownList ID="cbAccountDetails0" runat="server" Height="19px" 
                            Width="259px" AutoPostBack="True" class="chosen-select">
                        </asp:DropDownList>
                    &nbsp;<asp:DropDownList ID="cbAccountDetails1" runat="server" Height="19px" 
                            Width="200px" Visible="False" class="chosen-select">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="style78" valign="top">
                        ...
                        <asp:TextBox ID="txtRemark0" runat="server" Height="64px" Width="253px" 
                            TextMode="MultiLine"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="style78" valign="top">
                                    ...
                                    <asp:GridView ID="PendingExpenses" runat="server" 
                            AutoGenerateColumns="False" Width="415px" 
                            AllowPaging="True" style="font-size: 11px" Visible="False" 
                            ToolTip="Detail view on expense." PageSize="6" DataSourceID="PendingDs" DataKeyNames="ID">
                                        <Columns>
         ...
         <tr>
             <td class="style75" colspan="2" valign="top" 
                 style="position: absolute; top: 450px">

                 <table style="background-position: center; border-style: solid; border-width: medium; width: 989px; margin-left: 0px; height: 40px; background-image: url('../Customer%20Account/images/eeee.gif'); background-repeat: repeat;" 
                     id="DSaveCancelledTable" runat="server" 
            visible="False" align="left" bgcolor="#DBD7CB">
                <tr>
                    <td class="style74" valign="top" align="center">

                        <strong>
                 &nbsp;<asp:Button ID="saveExpenses" runat="server" Text="Enter" ToolTip=" Enter to pending view" Visible="False" Width="66px" />
                        <asp:Button ID="saveButton0" runat="server" OnClientClick="Confirm()" 
         ...
         <tr>
             <td class="style4" colspan="2">
                 ...
                 <table class="style1" visible="False">
                     <tr>
                    <td class="style22" align="center" colspan="2" 
                             style="position: absolute; top: 145px; left: 430px;">
                                 <strong > 
                     ...
                     <tr>
                    <td class="style77" align="center" colspan="2" 
                        ...
                        <table id="CompItemTable" runat="server" visible="False" align="center" 
                            ...
                            style="border-style: solid; border-width: medium; width: 580px; background-color: #DBD8CA; height: 96px;"  >
                            <tr>
                                <td class="style189" valign="top" >
                      
                                    <strong style="text-align: left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Select from the list of PV. </strong></td>
                            </tr>
                            <tr align="left">
                                <td class="style218" valign="top" >
                                    ...
                                    <asp:GridView ID="FreeItemGV0" runat="server" AutoGenerateColumns="False" 
                                        DataSourceID="PVDS" Width="640px" AllowPaging="True" 
                    ...
                    <td class="style77" align="center" colspan="2" 
                     ...
                     Text="Close" 
                     Width="66px" ToolTip="Click to close customer sales view." Visible="False" />
                        </strong>
                    ...
                    <td class="style22">
                        ...
                        <asp:TextBox ID="txtRatio" runat="server" Width="20px" 
                            style="text-align: left" Visible="False" MaxLength="100" 
                            ToolTip="Min 0, Max 100"></asp:TextBox>
                        <asp:TextBox ID="txtCredit" runat="server" Width="20px" 
                            style="text-align: left" Visible="False" MaxLength="100" 
                            ToolTip="Min 0, Max 100"></asp:TextBox>
                        <asp:TextBox ID="ItemIDTextBox1" runat="server" Width="100px" MaxLength="5" 
                            ReadOnly="True" Visible="False"></asp:TextBox>
                        <asp:TextBox ID="ExpSupplier" runat="server" Width="20px" 
                            style="text-align: left" Visible="False" MaxLength="100" 
                            ToolTip="Min 0, Max 100"></asp:TextBox>
                        ...
                        <asp:TextBox ID="txtExpenseAmount" runat="server" Width="16px" 
                            style="text-align: left" Visible="False"></asp:TextBox>
                      
                        <asp:TextBox ID="txtPV" runat="server" Width="16px" 
                            style="text-align: left" Visible="False"></asp:TextBox>
                      
                        <asp:TextBox ID="txtOtherIncomeID" runat="server" Width="16px" 
                            style="text-align: left" Visible="False"></asp:TextBox>
                      
                        <asp:TextBox ID="txtTaxesID" runat="server" Width="16px" 
                            style="text-align: left" Visible="False"></asp:TextBox>
                      
                        <asp:TextBox ID="txtDisburseRecievedExpenses" runat="server" Width="16px" 
                            style="text-align: left" Visible="False"></asp:TextBox>
                      
                        <asp:TextBox ID="txtDisburseRecievedID" runat="server" Width="16px" 
                            style="text-align: left" Visible="False"></asp:TextBox>
                      
                        <asp:TextBox ID="txtAccountDetails" runat="server" Width="16px" 
                            style="text-align: left" Visible="False"></asp:TextBox>
                    ...
                    <td class="style7">
                        ...
                        <asp:TextBox ID="txtunitName" runat="server" Width="52px" 
                            style="text-align: left" Visible="False"></asp:TextBox>
                        <asp:TextBox ID="txtSaleID" runat="server" Width="52px" 
                            style="text-align: left" Visible="False"></asp:TextBox>
                        </strong>
                        </td>
                     </tr>
         ...
         <tr>
             <td class="style53">
                 ...
                 <asp:SqlDataSource ID="ItemDS" runat="server" 
                     ...
                     SelectCommand="SELECT TransDate, Account, AccountDetail, TransactionType, Amount, Remark, DateCreated, CreatedBy, DateUpdated, UpdatedBy, Cash_Bank, AccountDetails, ID FROM CashAccountTable ORDER BY DateCreated DESC, TransDate DESC">
                 </asp:SqlDataSource>
                     ...
                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                     SelectCommand="SELECT CASE PurchasePaymentMethodTypeTable.PaymentName WHEN 'CASH' THEN 'CASH' ELSE 'BANK' END AS [Payment Method], SUM(PurchasePaymentTable.AmountPaid) AS Amount FROM PurchasePaymentTable INNER JOIN PurchasePaymentMethodTypeTable ON PurchasePaymentTable.PaymentMethodID = PurchasePaymentMethodTypeTable.ID WHERE (PurchasePaymentTable.PurchaseOrderID = @ID) AND (PurchasePaymentTable.PaymentMethodID &lt;&gt; 4) GROUP BY CASE PurchasePaymentMethodTypeTable.PaymentName WHEN 'CASH' THEN 'CASH' ELSE 'BANK' END">
                                     <SelectParameters>
                                         <asp:ControlParameter ControlID="cbAccountDetails0" Name="ID" 
                                 ...
                                 <asp:SqlDataSource ID="PendingDs" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT ID, PV, Amount, PaymentType, PaymentName FROM ExpensePendingTable WHERE (PV = @PV)">
                                     <SelectParameters>
                                         <asp:ControlParameter ControlID="txtAccountDetails" Name="PV" PropertyName="Text" />
                                     </SelectParameters>
                 </asp:SqlDataSource>

                        

                                 <asp:SqlDataSource ID="viewDS" runat="server" 
                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                     ...
                     SelectCommand="SELECT SalesHeaderTable.SalesID, SalesDetailTable.Barcode, SalesDetailTable.ItemDescription, SalesHeaderTable.SalesDate, SalesHeaderTable.InvoiceName, SalesDetailTable.SerialNumber FROM SalesHeaderTable INNER JOIN SalesDetailTable ON SalesHeaderTable.SalesID = SalesDetailTable.SalesID INNER JOIN CustomerHeaderTable ON SalesHeaderTable.CusID = CustomerHeaderTable.CusID INNER JOIN PaymentTable ON SalesHeaderTable.SalesID = PaymentTable.SalesID WHERE (SalesHeaderTable.CusID = @CustomerID) AND (NOT (SalesHeaderTable.InvoiceName LIKE N'CANCELLED')) AND (SalesHeaderTable.BranchID = @BranchID) AND (PaymentTable.PaymentMethodTypeID = 4)">
                                     <SelectParameters>
                        ...
                        <asp:SqlDataSource ID="CreditDS" runat="server" 
                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                     SelectCommand="SELECT ServicePaymentMethodTypeTable.PaymentName AS [Payment Method], ServicePaymentTable.AmountPaid FROM ServicePaymentTable INNER JOIN ServicePaymentMethodTypeTable ON ServicePaymentTable.PaymentMethodID = ServicePaymentMethodTypeTable.ID INNER JOIN ServiceEntryHeaderTable ON ServicePaymentTable.JobCardNo = ServiceEntryHeaderTable.JobCardNo WHERE (ServicePaymentMethodTypeTable.PaymentName = N'CREDIT') AND (ServiceEntryHeaderTable.JobCardNo = @ID)">
                        ...
                        <asp:SqlDataSource ID="DisburseDS" runat="server" 
                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                     SelectCommand="SELECT AccountChartTable.AccountID, AccountChartTable.AccountName FROM AccountChartTable INNER JOIN Cash_Bank_RelationshipTable ON AccountChartTable.Cash_Bank_Relationship = Cash_Bank_RelationshipTable.ID WHERE (Cash_Bank_RelationshipTable.Cash_Bank_Relationship = N'Disburse and Receive') OR (Cash_Bank_RelationshipTable.Cash_Bank_Relationship = N'Disburse')">
                 </asp:SqlDataSource>
