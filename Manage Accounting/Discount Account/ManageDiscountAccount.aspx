<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_qrzjjann" enableeventvalidation="false" %>
         ...
         <tr>
             <td class="style2" colspan="2">
                 ...
                 <asp:Label ID="employeeMgtLabel" runat="server" 
                     Text="View Sales Discount Account."></asp:Label>
         ...
         <tr>
             <td class="style53">
                 ...
                 <asp:SqlDataSource ID="ItemDS" runat="server" 
                     ...
                     SelectCommand="SELECT TransDate, SalesID, Account, AccountDetail, TransactionType, Amount, Remark, DateCreated, CreatedBy FROM DiscountAllowedAccountTable ORDER BY TransDate DESC">
                 </asp:SqlDataSource>
