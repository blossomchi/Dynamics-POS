<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_2zcnom2w" enableeventvalidation="false" %>
         ...
         <tr>
             <td class="style2" colspan="2">
                 ...
                 <asp:Label ID="employeeMgtLabel" runat="server" 
                     Text="View Purchase Account."></asp:Label>
         ...
         <tr>
             <td class="style53">
                 ...
                 <asp:SqlDataSource ID="ItemDS" runat="server" 
                     ...
                     SelectCommand="SELECT PurchaseOrderID, PurchaseDate, Account, AccountDetail, Amount, TransactionType, DateCreated, CreatedBy FROM PurchasesAcountTable ORDER BY PurchaseDate DESC">
                 </asp:SqlDataSource>
