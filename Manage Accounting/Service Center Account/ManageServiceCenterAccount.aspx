<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_m52s1zy1" enableeventvalidation="false" %>
...
<meta name="XAR Files" content="index_htm_files/xr_files.txt"/>
 <title>Service Center Account</title>  
         ...
         <tr>
             <td class="style2" colspan="2">
                 ...
                 <asp:Label ID="employeeMgtLabel" runat="server" 
                     Text="View Service Center Account."></asp:Label>
                 <asp:TextBox ID="UpdateTextBox0" runat="server" 
                     ...
                     Font-Size="Medium" Visible="False">Service Center</asp:Label>
         ...
         <tr>
             <td class="style53">
                 ...
                 <asp:SqlDataSource ID="ItemDS" runat="server" 
                     ...
                     SelectCommand="SELECT ServiceAccountTable.TransDate, ServiceAccountTable.JobCardNo, CustomerHeaderTable.CustomerName, ServiceAccountTable.Account, ServiceAccountTable.AccountDetail, ServiceAccountTable.TransactionType, ServiceAccountTable.Amount, ServiceAccountTable.Remark, ServiceAccountTable.DateCreated, ServiceAccountTable.CreatedBy FROM ServiceAccountTable INNER JOIN CustomerHeaderTable ON ServiceAccountTable.CustID = CustomerHeaderTable.CusID ORDER BY ServiceAccountTable.TransDate DESC">
                 </asp:SqlDataSource>
