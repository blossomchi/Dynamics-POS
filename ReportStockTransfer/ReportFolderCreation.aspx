<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_u5egw2tt" %>
...
<div class="xr_ap" id="xr_xr" 
    ...
    style="width: 1274px; height: 712px; top:0px; left:50%; margin-left: -645px; margin-bottom: 0px;">
 <script type="text/javascript">     var xr_xr = document.getElementById("xr_xr")</script>
 &nbsp;<!--[if IE]><div class="xr_ap" id="xr_xri" 
        
        style="width: 1272px; height: 707px; clip: rect(0px 1290px 1600px 0px); top: 0px; left: 4px;"><![endif]-->
<!--[if !IE]>--><div class="xr_ap" id="xr_xri" 
            
            style="width: 1251px; height: 705px; clip: rect(0px, 1290px, 1600px, 0px); top: 0px; left: 16px;"><!--<![endif]-->
 &nbsp;<img class="xr_ap" src="index_htm_files/2.png" alt="" 
                id="LiveCopy:58WriterFooter.MouseOff" title="" 
                style="left: 7px; top: 602px; width: 1240px; height: 91px;"/>
 <span class="xr_s0" style="position: absolute; left:42px; top:1571px;">
  <span class="xr_tc" style="left: 431px; top: -923px; width: 278px;"><span class="xr_s1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span><span class="xr_s2">&nbsp;&#169; Developed by Chinyere Blossom Oyem</span></span>
 </span>
 ...
 <table id="adminInfoTable" runat="server" 
         style="width: 485px; left: 751px; top: 139px; height: 42px; right: 15px; position: absolute;" 
         visible="true">
         <tr>
             <td class="style1" >
     ...
     <table id="employeeTable" 
                ...
                style="position: absolute; top: 241px; left: 182px; width: 974px; height: 220px;">
         <tr>
             <td class="style2">
                 <strong>
