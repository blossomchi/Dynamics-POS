<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_tn15oejx" %>
         ...
         <tr>
             <td class="style2" colspan="2">
                 ...
                 <asp:Label ID="employeeMgtLabel" runat="server" 
                     Text="Program Management."></asp:Label>
                 <asp:TextBox ID="UpdateTextBox0" runat="server" 
                     ...
                     Font-Size="Medium" Visible="False">Add Program.</asp:Label>
         ...
         <tr>
             <td class="style3" colspan="2">
                 <strong>
                     ...
                     Text="Program Name" 
                     Width="115px" ToolTip="Search By barcode" Visible="False" />
                 ...
                 <asp:Button ID="BackButton" runat="server" Text="Back" Visible="False" 
                     Width="66px" />
                 <asp:Button ID="AddattributeButton" runat="server" Text="Add Programs" 
                     Width="118px" />
                                    </strong>
&nbsp;</td>
         </tr>
...
onclick = "Check_Click(this)"/>
                 ...
                 <asp:GridView ID="findBarcodeGridView" runat="server" 
                     ...
                     CellPadding="3" ForeColor="Black" 
                     GridLines="Vertical" Width="989px" Visible="False" 
                     DataSourceID="findBarcodeDS" AllowPaging="True" DataKeyNames="ID">
                     <AlternatingRowStyle BackColor="#CCCCCC" />
                     <Columns>
                      <asp:TemplateField>
                     <HeaderTemplate>
...
onclick = "Check_Click(this)"/>
                 ...
                 <asp:SqlDataSource ID="findBarcodeDS" runat="server" 
                     ...
                     SelectCommand="SELECT DISTINCT ID, ProgramName, Description, RegisteredDate, UpdateBY FROM ProgramNameTable WHERE (ProgramName = @Name)">
                     <SelectParameters>
         ...
         <tr>
             <td class="style14" colspan="2" valign="top">
                 ...
                 <table style="background-position: center; border-style: solid; border-width: medium; width: 989px; margin-left: 0px; height: 204px; background-image: url('../Sub%20Courses/images/eeee.gif'); background-repeat: repeat;" 
                     id="AddItemTable" runat="server" 
            visible="False" align="left" bgcolor="#DBD7CB">
                <tr>
                    <td class="style63" valign="top" colspan="2">

                        <strong>Enter Program Name</strong></td>
                    <td class="style63" valign="top" rowspan="4">

                        <asp:GridView ID="GVCourse" runat="server" AutoGenerateColumns="False" 
                            BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" 
                            CellPadding="3" DataKeyNames="ID" DataSourceID="SubCoursesDS" 
                        ...
                        <asp:SqlDataSource ID="SubCoursesDS" runat="server" 
                            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                            SelectCommand="SELECT ID, ProgramName FROM ProgramNameTable">
                        </asp:SqlDataSource>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="style63" valign="top">
                        ...
                        <asp:TextBox ID="txtDescription" runat="server" style="margin-left: 0px" 
         ...
         <tr>
             <td class="style53">
                 ...
                 <asp:SqlDataSource ID="ItemDS" runat="server" 
                     ...
                     SelectCommand="SELECT DISTINCT ID, ProgramName, Description, RegisteredDate, UpdateBY FROM ProgramNameTable">
                 </asp:SqlDataSource>
