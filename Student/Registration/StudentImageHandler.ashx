<%@ WebHandler Language="VB" Class="StudentImageHandler" %>
...
Public Class StudentImageHandler : Implements IHttpHandler
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        If id IsNot Nothing Then
            ...
            'Get Image Data
            Dim file As Byte() = DirectCast(reader("StudentImageScan"), Byte())
