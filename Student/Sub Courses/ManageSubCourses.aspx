<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_hnjtsbe0" %>
...
<meta name="XAR Files" content="index_htm_files/xr_files.txt"/>
 <title>Manage Sub Courses</title>  
         ...
         <tr>
             <td class="style2" colspan="2">
                 ...
                 <asp:Label ID="employeeMgtLabel" runat="server" 
                     Text="Sub Course Management."></asp:Label>
                 <asp:TextBox ID="UpdateTextBox0" runat="server" 
                     ...
                     Font-Size="Medium" Visible="False">Add Sub Courses.</asp:Label>
         ...
         <tr>
             <td class="style3" colspan="2">
                 <strong>
                     ...
                     Text="Course Name" 
                     Width="107px" ToolTip="Click to search for course name." Visible="False" />
                 ...
                 <asp:Button ID="BackButton" runat="server" Text="Back" Visible="False" 
                     Width="66px" />
                 <asp:Button ID="AddattributeButton" runat="server" Text="Sub Courses." 
                     Width="118px" />
                                    </strong>
&nbsp;</td>
         </tr>
         <tr>
             <td class="style14" colspan="2">
                 ...
                 <asp:GridView ID="GVItem" runat="server" 
                     ...
                     DataSourceID="ItemDS" AllowPaging="True" DataKeyNames="CourseID" 
                     PageSize="28">
...
onclick = "Check_Click(this)"/>
                         ...
                         <asp:BoundField DataField="CourseID" HeaderText="Course ID"  
                             SortExpression="CourseID" InsertVisible="False" ReadOnly="True"/>
                         ...
                         <asp:TemplateField ShowHeader="False">
                             <ItemTemplate>
                                 <asp:ImageButton ID="ImageButton1" runat="server" CausesValidation="false" 
                                  CommandName="DeleteFreeItem" ImageUrl="~/images/property/del.png" Text="Delete" Tooltip="Delete"  CommandArgument='<%#Eval("CourseID") %>'/>
                             </ItemTemplate>
                         </asp:TemplateField>
                     </Columns>
                 ...
                 <asp:GridView ID="findBarcodeGridView" runat="server" 
                     ...
                     CellPadding="3" ForeColor="Black" 
                     GridLines="Vertical" Width="989px" Visible="False" 
                     DataSourceID="findBarcodeDS" AllowPaging="True" DataKeyNames="CourseID">
                     <AlternatingRowStyle BackColor="#CCCCCC" />
                     <Columns>
                      <asp:TemplateField>
                     <HeaderTemplate>
...
onclick = "Check_Click(this)"/>
                 ...
                 <asp:SqlDataSource ID="findBarcodeDS" runat="server" 
                     ...
                     SelectCommand="SELECT DISTINCT CourseID, CourseName, Description, RegisterDate, UpdateBY FROM SubCourseTable WHERE (CourseName = @Name)">
                     <SelectParameters>
            ...
            visible="False" align="left" bgcolor="#DBD7CB">
                <tr>
                    <td class="style63" valign="top" colspan="2">
                        ...
                        <strong>Enter Sub Course</strong></td>
                    <td class="style63" valign="top" rowspan="4">

                        <asp:GridView ID="GVCourse" runat="server" AutoGenerateColumns="False" 
                            BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" 
                            CellPadding="3" DataKeyNames="CourseID" DataSourceID="SubCoursesDS" 
                            ForeColor="Black" GridLines="Vertical" Width="371px" AllowPaging="True">
                            <AlternatingRowStyle BackColor="#CCCCCC" />
                            <Columns>
                        ...
                        <asp:SqlDataSource ID="SubCoursesDS" runat="server" 
                            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                            SelectCommand="SELECT CourseID, CourseName FROM SubCourseTable">
                        </asp:SqlDataSource>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="style63" valign="top">
                        ...
                        <asp:TextBox ID="txtCourseName" runat="server" TextMode="MultiLine" 
                ...
                <tr>
                    ...
                    <td class="style63" valign="top">
                        ...
                        <asp:TextBox ID="txtCourseDescription" runat="server" style="margin-left: 0px" 
         ...
         <tr>
             <td class="style53">
                 ...
                 <asp:SqlDataSource ID="ItemDS" runat="server" 
                     ...
                     SelectCommand="SELECT DISTINCT CourseID, CourseName, Description, RegisterDate, UpdateBY FROM SubCourseTable">
                 </asp:SqlDataSource>
