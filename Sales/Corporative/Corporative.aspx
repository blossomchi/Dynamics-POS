<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_5xaflf3a" %>
...
<meta name="XAR Files" content="index_htm_files/xr_files.txt"/>
 <title>Manage Corporative</title>
         ...
         <tr>
             <td class="style2" colspan="2">
                 ...
                 <asp:Label ID="employeeMgtLabel" runat="server" 
                     Text="POS CORPORATE BODY."></asp:Label>
                 <asp:TextBox ID="UpdateTextBox0" runat="server" 
                     ...
                     Font-Size="Medium" Visible="False">SELECT CORPORATE BODY.</asp:Label>
         ...
         <tr>
             <td class="style84" colspan="2">
                 ...
                 <asp:GridView ID="StockGridView" runat="server" 
                     ...
                     DataSourceID="costSellingDS" DataKeyNames="CorporateInvoiceNumber" 
                     style="font-size: small">
                     <AlternatingRowStyle BackColor="#CCCCCC" />

                     <Columns>
                         <asp:BoundField DataField="SN" HeaderText="SN" 
                             SortExpression="SN" ReadOnly="True" InsertVisible="False" />
                         <asp:BoundField DataField="CorporateInvoiceNumber" HeaderText="Corporate Invoice Number" 
                             SortExpression="CorporateInvoiceNumber" ReadOnly="True" />
                               <asp:BoundField DataField="SalesID" HeaderText="Sales ID" SortExpression="SalesID" />
                         <asp:BoundField DataField="SalesInvoiceNumber" HeaderText="Sales Invoice" 
                             SortExpression="SalesInvoiceNumber" />
                             <asp:BoundField DataField="SalesDate" HeaderText="Sales Date" SortExpression="SalesDate" />
                         <asp:BoundField DataField="CorperateBodyName" HeaderText="Corperate Body" SortExpression="CorperateBodyName" />
                         <asp:BoundField DataField="CustomerName" HeaderText="Customers" SortExpression="CustomerName" />
                         ...
                         <asp:TemplateField ShowHeader="False">
                             <ItemTemplate>
                                 <asp:ImageButton ID="ImageButton2" runat="server" CausesValidation="false" 
                                     CommandName="Invoice" ImageUrl="~/images/magnify.jpg" Text="Print" ToolTip="Display Invoice" CommandArgument='<%#Eval("CorporateInvoiceNumber") %>'/>
                             </ItemTemplate>
                         </asp:TemplateField>
                     </Columns>
         ...
         <tr>
             <td class="style14" colspan="2">
                 ...
                 <asp:SqlDataSource ID="costSellingDS" runat="server" 
                     ...
                     SelectCommand="SELECT CorporateHeaderTable.SN, CorporateHeaderTable.CorporateInvoiceNumber, CorporateHeaderTable.SalesID, CorporateHeaderTable.SalesInvoiceNumber, CorporateHeaderTable.SalesDate, CorporateHeaderTable.CorperateBodyName, CustomerHeaderTable.CustomerName, employeeTable.Firstname + ' ' + employeeTable.LastName AS [Sales Person], CorporateHeaderTable.DateCreated FROM employeeTable INNER JOIN CorporateHeaderTable ON employeeTable.SN = CorporateHeaderTable.SalesPerson INNER JOIN CustomerHeaderTable ON CorporateHeaderTable.CusID = CustomerHeaderTable.CusID WHERE (CorporateHeaderTable.BranchID = @Branch) ORDER BY CorporateHeaderTable.SN DESC">
                     <SelectParameters>
                         <asp:ControlParameter ControlID="BranchLabel" Name="Branch" PropertyName="Text" />
                     </SelectParameters>
                 </asp:SqlDataSource>
                 ...
                 <asp:GridView ID="findUnitCostGridView0" runat="server" 
                     ...
                     DataKeyNames="CorporateInvoiceNumber" style="font-size: 12px">
                     <AlternatingRowStyle BackColor="#CCCCCC" />

                     <Columns>
                         <asp:BoundField DataField="CorporateInvoiceNumber" HeaderText="Corporate Invoice" ReadOnly="True" 
                             SortExpression="CorporateInvoiceNumber" />
                         <asp:BoundField DataField="SalesDate" HeaderText="Sales Date" 
                             SortExpression="SalesDate" />
                         <asp:BoundField DataField="CorperateBodyName" HeaderText="Corperate Body" 
                             SortExpression="CorperateBodyName" />
                         ...
                         <asp:BoundField DataField="Sales Person" HeaderText="Sales Person" 
                             SortExpression="Sales Person" ReadOnly="True" />
                 ...
                 <asp:GridView ID="CustomerGridView" runat="server" 
                     ...
                     <Columns>
                         ...
                         <asp:BoundField DataField="SalesDate" HeaderText="Sales Date" 
                             SortExpression="SalesDate" />
                         <asp:BoundField DataField="Sales Person" HeaderText="Sales Person" SortExpression="Sales Person" ReadOnly="True" />
                         <asp:BoundField DataField="DateCreated" HeaderText="Date Created" 
                             SortExpression="DateCreated" />
                           <asp:TemplateField ShowHeader="False">
                             <ItemTemplate>
                 ...
                 <asp:GridView ID="SalesIDGridView" runat="server" 
                     ...
                     <Columns>
                         <asp:BoundField DataField="CorporateInvoiceNumber" HeaderText="Corporate Invoice" ReadOnly="True" 
                             SortExpression="CorporateInvoiceNumber" />
                         <asp:BoundField DataField="SalesInvoiceNumber" HeaderText="Sales Invoice "  SortExpression="SalesInvoiceNumber"/>
                         <asp:BoundField DataField="CorperateBodyName" HeaderText="Corperate Body" 
                             SortExpression="CorperateBodyName" />
                 ...
                 <asp:SqlDataSource ID="SalesIDDS" runat="server" 
                     ...
                     SelectCommand="SELECT CorporateHeaderTable.CorporateInvoiceNumber, CorporateHeaderTable.SalesInvoiceNumber, CorporateHeaderTable.CorperateBodyName, CustomerHeaderTable.CustomerName, employeeTable.Firstname + ' ' + employeeTable.LastName AS [Sales Person], CorporateHeaderTable.DateCreated FROM employeeTable INNER JOIN CorporateHeaderTable ON employeeTable.SN = CorporateHeaderTable.SalesPerson INNER JOIN CustomerHeaderTable ON CorporateHeaderTable.CusID = CustomerHeaderTable.CusID WHERE (employeeTable.BranchID = @BranchID) AND (CorporateHeaderTable.CorporateInvoiceNumber = @InvoiceID)">
                     <SelectParameters>
                 ...
                 <asp:SqlDataSource ID="CustomerDS" runat="server" 
                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                     SelectCommand="SELECT CorporateHeaderTable.CorporateInvoiceNumber, CustomerHeaderTable.CustomerName AS [Customer Name], CorporateHeaderTable.SalesDate, CorporateHeaderTable.CorperateBodyName, CorporateHeaderTable.DateCreated, employeeTable.Firstname + ' ' + employeeTable.LastName AS [Sales Person] FROM CorporateHeaderTable INNER JOIN employeeTable ON CorporateHeaderTable.SalesPerson = employeeTable.SN INNER JOIN CustomerHeaderTable ON CorporateHeaderTable.CusID = CustomerHeaderTable.CusID INNER JOIN CorporateDetailsTable ON CorporateHeaderTable.CorporateInvoiceNumber = CorporateDetailsTable.CorporateInvoiceNumber WHERE (CustomerHeaderTable.CustomerName = @Name) AND (CorporateHeaderTable.BranchID = @Branch)">
                     <SelectParameters>
                 ...
                 <asp:SqlDataSource ID="SerialNoDS" runat="server" 
                     ...
                     SelectCommand="SELECT CorporateHeaderTable.CorporateInvoiceNumber, CorporateDetailsTable.Barcode, CorporateDetailsTable.ProductNumber, CorporateDetailsTable.ItemDescription, CorporateDetailsTable.SerialNumber, CorporateDetailsTable.Amount, CustomerHeaderTable.CustomerName AS [Customer Name], employeeTable.Firstname + ' ' + employeeTable.LastName AS [Sales Person] FROM CorporateHeaderTable INNER JOIN employeeTable ON CorporateHeaderTable.SalesPerson = employeeTable.SN INNER JOIN CustomerHeaderTable ON CorporateHeaderTable.CusID = CustomerHeaderTable.CusID INNER JOIN CorporateDetailsTable ON CorporateHeaderTable.CorporateInvoiceNumber = CorporateDetailsTable.CorporateInvoiceNumber WHERE (CorporateHeaderTable.BranchID = @Branch) AND (CorporateDetailsTable.SerialNumber = @Serial)">
                     <SelectParameters>
                         <asp:ControlParameter ControlID="BranchLabel" Name="Branch" 
                             PropertyName="Text" />
                 ...
                 <asp:SqlDataSource ID="ItemDesDS" runat="server" 
                     ...
                     SelectCommand="SELECT DISTINCT CorporateHeaderTable.CorporateInvoiceNumber, CorporateHeaderTable.SalesDate, CorporateHeaderTable.CorperateBodyName, CustomerHeaderTable.CustomerName AS [Customer Name], CorporateDetailsTable.ItemDescription, employeeTable.Firstname + ' ' + employeeTable.LastName AS [Sales Person], CorporateHeaderTable.SalesPerson, CorporateHeaderTable.DateCreated FROM CorporateHeaderTable INNER JOIN employeeTable ON CorporateHeaderTable.SalesPerson = employeeTable.SN INNER JOIN CustomerHeaderTable ON CorporateHeaderTable.CusID = CustomerHeaderTable.CusID INNER JOIN CorporateDetailsTable ON CorporateHeaderTable.CorporateInvoiceNumber = CorporateDetailsTable.CorporateInvoiceNumber WHERE (CorporateDetailsTable.ItemDescription = @ItemDes) AND (CorporateHeaderTable.BranchID = @BranchID)">
                     <SelectParameters>
             ...
             <td class="style14" colspan="2">
                     ...
                     style="background-position: center; border-style: ridge; border-width: medium; width: 989px; height: 24px; margin-left: 0px; background-image: url('images/eeee.gif'); background-repeat: repeat;">
                        ...
                        <asp:Label ID="MSGLabel1" runat="server" ForeColor="Red"></asp:Label>
                             ...
                             <td class="style108" align="left" valign="top" rowspan="5">
                                 &nbsp;</td>
                         </tr>
                         <tr>
                             <td class="auto-style3" align="left" valign="top" 
                                 >
                                 SALES INVOICE</td>
                             <td class="auto-style4" align="left" valign="top" 
                                  >
                      
                                 <asp:DropDownList ID="CBInvoice" runat="server" 
                                     DataSourceID="InvoiceDS" DataTextField="InvoiceName" 
                                     DataValueField="InvoiceName"  class="chosen-select" Width="450px" 
                                     AutoPostBack="True">
                                 </asp:DropDownList>
                             ...
                             <td class="auto-style5" align="left" valign="top" 
                                 >
                      
                                 </td>
                         </tr>
                         <tr>
                             <td class="auto-style16" align="left" valign="top" 
                                 >
                                 SALES ID</td>
                         ...
                         <tr>
                             ...
                             <td class="style113" align="left" valign="top" 
                                 ...
                                 <strong > 
                        <asp:TextBox ID="txtCorporateName" runat="server" Width="450px" 
            ...
            visible="False" align="left" bgcolor="#DBD7CB">
                <tr>
                    <td class="style35">
                        ...
                        Text="Sales Information"></asp:Label>
...
<asp:GridView ID="SalesGV" runat="server" 
...
<ControlStyle Width="10px"></ControlStyle>
                                   ...
                                   <asp:TemplateField HeaderText="Amount" SortExpression="Amount">
                                       ...
                                       <ItemTemplate>
                                        ...
                                        <asp:Label ID="GrandTotal" runat="server" Font-Bold="true" ForeColor="Magenta"></asp:Label><br />
                                     </FooterTemplate>
                ...
                <tr>
                    <td class="style35">
                                 ...
                                 <strong >
                                 <asp:Button ID="NEXTID" runat="server" 
                     Text="NEXT" 
         ...
         <tr>
             <td class="style14" colspan="2">
                     ...
                     <table ID="SalesInfoTable" runat="server" visible="False" 
                         ...
                         <tr>
                             <td class="auto-style6" align="left" valign="top">
                                 CORPORATE INVOICE</td>
                             <td class="auto-style20" align="left" valign="top">
                      
                                 <strong > 
                        <asp:TextBox ID="txtCorporateInvoice" runat="server" Width="230px" 
                            style="text-align: left" ReadOnly="True"></asp:TextBox>
                        </strong>
                        ...
                        <asp:TextBox ID="txtItem" runat="server" Width="230px" 
                         ...
                         <tr>
                             ...
                             <td class="auto-style20" align="left" valign="top">
                                 ...
                                 <strong > 
                        <asp:TextBox ID="txtGrandAmountTotal" runat="server" Width="230px" 
                            style="text-align: left" ReadOnly="True"></asp:TextBox>
                        </strong>
                         ...
                         <tr>
                             ...
                             <td class="auto-style20" align="left" valign="top">
                                 ...
                                 <asp:DropDownList ID="CBCustomer" runat="server" 
                                     ...
                                     DataValueField="CusID"  class="chosen-select" Width="235px" 
                                     AutoPostBack="True">
                                 </asp:DropDownList>
                        ...
                        <asp:DropDownList ID="CBItemDes" runat="server" AutoPostBack="True" 
                            DataSourceID="CorporateDS" DataTextField="Barcode" DataValueField="Barcode" 
                         ...
                         <tr>
                             ...
                             <td class="auto-style21" align="left" valign="top">
                                 <strong > 
                         ...
                         <tr>
                             ...
                             <td class="auto-style22" align="left" valign="top">
                         ...
                         <tr>
                             <td class="auto-style9" align="left" valign="top">
                         ...
                         <tr>
                             <td class="auto-style31" align="left" valign="top">
                             ...
                             <td class="auto-style32" align="left" valign="top">
                      
                                 <strong > 
                                 <asp:DropDownList ID="cbMdate" runat="server" 
                            Width="235px" DataSourceID="MDateDS" 
                            DataTextField="MFG" DataValueField="MFG" Height="16px"  
                         ...
                         <tr>
                             <td class="auto-style17" align="left" valign="top">
                                 QUANTITY</td>
                        ...
                        <asp:TextBox ID="txtQty" runat="server" Width="230px" 
                         ...
                         <tr>
                             <td class="auto-style29" align="left" valign="top">
                                 SELLING PRICE</td>
                             <td class="auto-style30" align="left" valign="top">
                        ...
                        <asp:TextBox ID="txtSellingPrice" runat="server" Width="230px" 
                         ...
                         <tr>
                             ...
                             <td class="auto-style26" align="left" valign="top">
                         ...
                         <tr>
                             <td class="auto-style17" align="left" valign="top">
                                 ...
                                 <asp:Label ID="LBStockName" runat="server" BorderStyle="None" Visible="False" 
                                     Width="104px">SALES STOCK</asp:Label>
                      
                        

                                 </td>
                             <td class="auto-style27" align="left" valign="top">
                      
                                 <strong > 
                        <asp:TextBox ID="LBStock" runat="server" Width="230px" 
                            style="text-align: left" ReadOnly="True" Visible="False"></asp:TextBox>
                        </strong>
                             </td>
                     ...
                     Width="135px" ToolTip="Click to add free item for this sales." Height="28px" 
                         ...
                         <tr>
                             <td class="style150" align="left" valign="top" colspan="3">
                      <div style="overflow:auto;height:361px; width: 974px;">
<asp:GridView ID="ReturnGV" runat="server" 
                            ...
                            ShowFooter="True" Height="104px" PageSize="6" Font-Size="7pt" 
                                     style="text-align: left; font-size: 8pt;" AutoGenerateColumns="False" 
                                     DataSourceID="ReturnView0" Visible="False" DataKeyNames="ID" 
                                      >
                            <AlternatingRowStyle BackColor="#CCCCCC" />
                               <Columns>
                                   ...
                                   <asp:BoundField DataField="ItemDescription" HeaderText="Item Description" SortExpression="ItemDescription" />
                                   <asp:BoundField DataField="ProductNumber" HeaderText="PN" SortExpression="ProductNumber" />
                                   <asp:BoundField DataField="SerialNumber" HeaderText="SN" SortExpression="SerialNumber" />
                                   ...
                                   <asp:TemplateField HeaderText="Selling Price" SortExpression="SellingPrice">
                                          <ItemTemplate>
                                           <asp:Label ID="Label1" runat="server" Text='<%# Bind("SellingPrice") %>'></asp:Label>
                                       </ItemTemplate>
                                       <FooterTemplate>
                                        <asp:Label ID="SubTotalLabel" runat="server" Font-Bold="true" ForeColor="Magenta">Sub Total:</asp:Label><br /><br />
                                        <asp:Label ID="DiscountLabel5" runat="server" Font-Bold="true" ForeColor="Magenta"></asp:Label><br /><br />
                            ...
                            <SortedDescendingHeaderStyle BackColor="#383838" />
                                       ...
                                       <asp:SqlDataSource ID="ReturnView0" runat="server" 
                                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                                     
                            
                              
                              
                              SelectCommand="SELECT CorporateDetailsTable.ID, CorporateDetailsTable.Barcode, CorporateDetailsTable.ItemDescription, CorporateDetailsTable.ProductNumber, CorporateDetailsTable.SerialNumber, CorporateDetailsTable.IMEI, CorporateDetailsTable.ExpiryDate, CorporateDetailsTable.MFG, CorporateDetailsTable.Quantity, CorporateDetailsTable.SellingPrice, CorporateDetailsTable.Amount FROM CorporateHeaderTable INNER JOIN CorporateDetailsTable ON CorporateHeaderTable.CorporateInvoiceNumber = CorporateDetailsTable.CorporateInvoiceNumber WHERE (CorporateHeaderTable.CorporateInvoiceNumber = @INVOICE) AND (CorporateHeaderTable.SalesID = @SalesID) AND (CorporateHeaderTable.BranchID = @BranchID)">
                                           <SelectParameters>
                                               <asp:ControlParameter ControlID="txtCorporateInvoice" Name="INVOICE" PropertyName="Text" />
                                               <asp:ControlParameter ControlID="LBSalesID" Name="salesID" 
                                                   PropertyName="Text" />
                                               <asp:ControlParameter ControlID="BranchLabel" Name="BranchID" 
                                                   PropertyName="Text" />
         ...
         <tr>
             <td class="style51" colspan="2">
                 ...
                 <asp:Button ID="btnDelete" runat="server" Text="Delete Selected" 
                     ...
                     Width="113px" ToolTip="Click to delete selected records" Visible="False" />
                            ...
                            SelectCommand="SELECT SN, Firstname + ' ' + LastName AS [Employee Name] FROM employeeTable">
                                    ...
                                    <asp:SqlDataSource ID="CorporateDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT DISTINCT SalesHeaderTable.SalesID, SalesDetailTable.Barcode, SalesHeaderTable.BranchID FROM SalesHeaderTable INNER JOIN SalesDetailTable ON SalesHeaderTable.SalesID = SalesDetailTable.SalesID WHERE (SalesHeaderTable.SalesID = @SalesID) AND (SalesHeaderTable.BranchID = @Branch)">
                                        <SelectParameters>
                                            <asp:ControlParameter ControlID="LBSalesID" Name="SalesID" PropertyName="Text" />
                                            <asp:ControlParameter ControlID="BranchLabel" Name="Branch" PropertyName="Text" />
                                        </SelectParameters>
                        </asp:SqlDataSource>
                        ...
                        <asp:SqlDataSource ID="ItemDataSource" runat="server" 
                            ...
                            <SelectParameters>
                                ...
                                <asp:ControlParameter ControlID="UpdateTextBox1" Name="Date" 
                                 ...
                                 <asp:SqlDataSource ID="InvoiceDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT SalesHeaderTable.InvoiceName, SalesHeaderTable.SalesID, SalesHeaderTable.BranchID, CustomerHeaderTable.TypeID FROM SalesHeaderTable INNER JOIN CustomerHeaderTable ON SalesHeaderTable.CusID = CustomerHeaderTable.CusID WHERE (SalesHeaderTable.InvoiceName &lt;&gt; N'CANCELLED') AND (SalesHeaderTable.BranchID = @Branch) AND (CustomerHeaderTable.TypeID = N'CORPORATE')">
                                     <SelectParameters>
                                         <asp:ControlParameter ControlID="BranchLabel" Name="Branch" PropertyName="Text" />
                                     </SelectParameters>
                        </asp:SqlDataSource>
                            ...
                            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                            SelectCommand="SELECT ID, PaymentName FROM PaymentMethodTypeTable WHERE (PaymentName = N'CASH')">
                        </asp:SqlDataSource>
                 ...
                 <asp:SqlDataSource ID="CustDropdown" runat="server" 
                     ...
                     SelectCommand="SELECT SN, TypeID, TypeName FROM CustomerTypeTable WHERE (TypeName = N'INDIVIDUAL')"></asp:SqlDataSource>
                 ...
                 <asp:SqlDataSource ID="countrySqlDataSource1" runat="server" 
                     ...
                     SelectCommand="SELECT * FROM [countryTable]"></asp:SqlDataSource>
                            ...
                            SelectCommand="SELECT DISTINCT SalesHeaderTable.SalesID, SalesDetailTable.Barcode, SalesHeaderTable.BranchID, SalesDetailTable.ExpiryDate FROM SalesHeaderTable INNER JOIN SalesDetailTable ON SalesHeaderTable.SalesID = SalesDetailTable.SalesID WHERE (SalesHeaderTable.SalesID = @SalesID) AND (SalesHeaderTable.BranchID = @Branch) AND (SalesDetailTable.Barcode = @Barcode) ORDER BY SalesDetailTable.ExpiryDate">
                                     <SelectParameters>
                                         <asp:ControlParameter ControlID="LBSalesID" Name="SalesID" 
                                             PropertyName="Text" />
                                         <asp:ControlParameter ControlID="BranchLabel" Name="Branch" PropertyName="Text" />
                            ...
                            SelectCommand="SELECT DISTINCT SalesHeaderTable.SalesID, SalesDetailTable.Barcode, SalesHeaderTable.BranchID, SalesDetailTable.MFG FROM SalesHeaderTable INNER JOIN SalesDetailTable ON SalesHeaderTable.SalesID = SalesDetailTable.SalesID WHERE (SalesHeaderTable.SalesID = @SalesID) AND (SalesHeaderTable.BranchID = @Branch) AND (SalesDetailTable.Barcode = @Barcode) ORDER BY SalesDetailTable.MFG">
                                     <SelectParameters>
                                         <asp:ControlParameter ControlID="LBSalesID" Name="SalesID" 
                                             PropertyName="Text" />
                                         <asp:ControlParameter ControlID="BranchLabel" Name="Branch" PropertyName="Text" />
                            ...
                            SelectCommand="SELECT DISTINCT SalesHeaderTable.SalesID, SalesDetailTable.Barcode, SalesHeaderTable.BranchID, SalesDetailTable.IMEI FROM SalesHeaderTable INNER JOIN SalesDetailTable ON SalesHeaderTable.SalesID = SalesDetailTable.SalesID WHERE (SalesHeaderTable.SalesID = @SalesID) AND (SalesHeaderTable.BranchID = @Branch) AND (SalesDetailTable.Barcode = @Barcode)">
                                     <SelectParameters>
                                         <asp:ControlParameter ControlID="LBSalesID" Name="SalesID" 
                                             PropertyName="Text" />
                                         <asp:ControlParameter ControlID="BranchLabel" Name="Branch" PropertyName="Text" />
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                            SelectCommand="SELECT CusID, CustomerName, TypeID FROM CustomerHeaderTable WHERE (TypeID = N'INDIVIDUAL')">
                        </asp:SqlDataSource>
                        ...
                        <asp:SqlDataSource ID="stockHeader" runat="server" 
                            ...
                            SelectCommand="SELECT DISTINCT SalesHeaderTable.SalesID, SalesDetailTable.Barcode, SalesHeaderTable.BranchID, SalesDetailTable.SerialNumber FROM SalesHeaderTable INNER JOIN SalesDetailTable ON SalesHeaderTable.SalesID = SalesDetailTable.SalesID WHERE (SalesHeaderTable.SalesID = @SalesID) AND (SalesHeaderTable.BranchID = @Branch) AND (SalesDetailTable.Barcode = @Barcode)">
                                     <SelectParameters>
                                         <asp:ControlParameter ControlID="LBSalesID" Name="SalesID" 
                                             PropertyName="Text" />
                                         <asp:ControlParameter ControlID="BranchLabel" Name="Branch" 
                                             PropertyName="Text" />
                                         <asp:ControlParameter ControlID="CBItemDes" Name="Barcode" PropertyName="SelectedValue" />
                                     </SelectParameters>
                                 </asp:SqlDataSource>
             ...
             <td class="style4">
                 ...
                 <strong>
                     ...
                     Font-Size="Medium" Height="25px" 
                        ...
                        <asp:TextBox ID="txtinvoiceID" runat="server" Width="16px" 
                            style="text-align: left" Visible="False"></asp:TextBox>
