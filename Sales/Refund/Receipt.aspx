<%@ page language="VB" autoeventwireup="false" inherits="Invoice, App_Web_r5cvcgng" %>
...
<div class="xr_ap" id="xr_xr" style="width: 303px; height: auto; top:0px; margin-left: -7px; margin-right: -7px; left: 10px;">
 ...
 <!--[if IE]><div class="xr_ap" id="xr_xri" 
        style="width: 303px; height: auto; clip: rect(0px 303px 1682px 0px); top: 0px; left: 4px;"><![endif]-->
<!--[if !IE]>-->
<div class="xr_ap" id="xr_xri" style="width: 303px; height: auto; clip: rect(0px, 303px, 1682px, 0px);"><!--<![endif]-->
 <span class="xr_s0" style="position: absolute; left:-166px; top:31px;">
  ...
  <span class="xr_tc" style="left: 311px; top: 6px; width: 6px; height: 23px;"> </span>
 </span>
 <span class="xr_s2" style="position: absolute; left:-157px; top:92px;">
  <span class="xr_tc" style="left: 174px; top: -14px; width: 256px;">Website: www.rolofcomputers.com</span>
 </span>
...
&nbsp;<table id="ReceiptTable" runat="server" visible="True" 
        ...
        style="position: absolute; top: 101px; left: 5px; width: 267px; height: auto"  >
                        ...
                        <table id="ReceiptHeaderTable" runat="server" visible="True" 
                                        style="border-style: ridge; width: 269px; height: 69px;"  >
                            <tr>
                                <td class="style23"  >
                 ...
                 <asp:TextBox ID="UpdateTextBox0" runat="server" 
                     ...
                     <asp:TextBox ID="txt8" runat="server" Visible="False" Width="27px"></asp:TextBox>
                                    ...
                                    <asp:SqlDataSource ID="Receipt" runat="server" 
                                        ...
                                        SelectCommand="SELECT ItemDescription, Quantity, Amount FROM RefundDetailsTable WHERE (RefundID = @RefundID)">
                                        <SelectParameters>
                                            <asp:ControlParameter ControlID="ID" Name="RefundID" PropertyName="Text" />
                                        </SelectParameters>
                                    </asp:SqlDataSource>
                                    ...
                                    <asp:SqlDataSource ID="SerialNumbersDS" runat="server" 
                                        ...
                                        SelectCommand="SELECT SerialNumber + ' ' + '--' + ' ' + ItemDescription AS Expr1 FROM RefundDetailsTable WHERE (RefundID = @RefundID) AND (NOT (SerialNumber + ' ' + '--' + ' ' + ItemDescription IS NULL)) ORDER BY Expr1">
                                        <SelectParameters>
                                            <asp:ControlParameter ControlID="ID" Name="RefundID" PropertyName="Text" />
                                        </SelectParameters>
                                    </asp:SqlDataSource>
                                    <asp:SqlDataSource ID="PaymentDS" runat="server" 
                                        ...
                                        SelectCommand="SELECT RefundPaymentMethodTypeTable.PaymentName, - (+ PaymentRefundTable.AmountPaid) AS amount FROM PaymentRefundTable INNER JOIN RefundPaymentMethodTypeTable ON PaymentRefundTable.PaymentMethodTypeID = RefundPaymentMethodTypeTable.ID WHERE (PaymentRefundTable.RefundID = @ID)">
                                        <SelectParameters>
  ...
  <div id="xr_xo0" class="xr_ap" style="left:0; top:0; width:302px; height:100px; visibility:hidden;">
