<%@ page language="VB" autoeventwireup="false" inherits="Invoice, App_Web_ubjvboqf" %>
...
<!--[if !IE]>--><div class="xr_ap" id="xr_xri" 
 ...
 <span class="xr_s1" style="position: absolute; left:186px; top:132px;">
  ...
  <span class="xr_tl xr_s2" style="top: 21px; left: -48px;">Tel: +234 805 322 3691, +234 708 499 3553&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp Tel:+234 818 305 4068, +234 907 988 8493</span>
 </span>
                        ...
                        <table id="InvoiceHeaderTable" runat="server" visible="True" 
                            ...
                            <tr>
                                <td class="style1" colspan="2" >
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="InvoiceDS" Width="743px">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Rate (Naira)" SortExpression="SellingPrice">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="Label4" runat="server" Text='<%# Bind("SellingPrice", "{0:0,0.00}") %>'></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                        ...
                                        <asp:Label ID="GrandLabel1" runat="server" Font-Bold="true" ForeColor="Green">Grand Total:</asp:Label><br />
                                            ...
                                            <asp:TemplateField HeaderText="Amount (Naira)" SortExpression="Amount">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="Label5" runat="server" Text='<%# Bind("Amount", "{0:0,0.00}") %>'></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                        ...
                        <table id="TotalTable" runat="server" visible="True" 
                                ...
                                <td class="style1" colspan="2" >
                                    ...
                                    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="AmountPaid" DataFormatString="{0:0,0.0}" 
                                                HeaderText="Amount Paid" SortExpression="AmountPaid" />
                                            <asp:BoundField DataField="DateCreated" HeaderText="Date Paid" 
                            ...
                            <tr>
                                <td class="style25" colspan="2" >
                                    ...
                                    <img src="invoice_htm_files/2.png" alt="" title="" 
                style="width: 568px; height: 39px;"/>
                            ...
                            <tr>
                                <td class="style1" colspan="2" >
                                    ...
                                    <asp:SqlDataSource ID="InvoiceDS" runat="server" 
                                        ...
                                        SelectCommand="SELECT ItemDescription, ProductNumber, SUM(Quantity) AS Quantity, SellingPrice, SUM(Amount) AS Amount FROM SalesDetailTable WHERE (SalesID = @SalesID) GROUP BY ItemDescription, ProductNumber, Quantity, Amount, SellingPrice">
                                        <SelectParameters>
                 ...
                 <strong>
                                    <asp:SqlDataSource ID="SerialNumbersDS" runat="server" 
                                        ...
                                        SelectCommand="SELECT ItemDescription + ' ' + '--' + ' ' + SerialNumber AS Expr1 FROM SalesDetailTable WHERE (SalesID = @SalesID) AND (NOT (SerialNumber + ' ' + '--' + ' ' + ItemDescription IS NULL)) ORDER BY Expr1">
                                        <SelectParameters>
                                            <asp:ControlParameter ControlID="ID" Name="SalesID" PropertyName="Text" />
                                        </SelectParameters>
                                    </asp:SqlDataSource>
                                    <asp:SqlDataSource ID="PaymentDS" runat="server" 
                                        ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                                        SelectCommand="SELECT PaymentMethodTypeTable.PaymentName, PaymentTable.AmountPaid, PaymentTable.DateCreated FROM PaymentMethodTypeTable INNER JOIN PaymentTable ON PaymentMethodTypeTable.ID = PaymentTable.PaymentMethodTypeID WHERE (PaymentTable.SalesID = @SalesID)">
                                        <SelectParameters>
                                            <asp:ControlParameter ControlID="ID" Name="SalesID" PropertyName="Text" />
                                        </SelectParameters>
                                    </asp:SqlDataSource>
...
minor-latin"><span style="mso-list:Ignore">1.<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></span></span>All products carry warranty as offered by the manufacturer. Consumables and batteries are not covered by warranty.</p>
                                    <p class="MsoListParagraph" style="text-align:justify;text-indent:-.25in;
line-height:normal;mso-list:l0 level1 lfo1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; The maximum period of the warranty depending on the product and manufacturer is six (6) months unless expressly stated otherwise by the manufacturer.  In all cases the customer will be required to send the faulty product direct to the manufacturer or a designed service centre of the manufacturer.</p>
                                    <p class="MsoListParagraph" style="text-align:justify;text-indent:-.25in;
line-height:normal;mso-list:l0 level1 lfo1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; If the customer opts for Rolof Computers to send the faulty item to the manufacturer’s service centre, the customer will be required to pay the freight to and fro.</p>
                                    <p class="MsoListParagraph" style="text-align:justify;text-indent:-.25in;
line-height:normal;mso-list:l0 level1 lfo1"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Exclusions from Warranty:</strong></p>
                                    <ul>
                                        <li>	Physical damage, sand, liquid or moisture damage.</li>
                                         <li>	Power related problems such as power surges, overcurrent and overcurrent, static electricity.</li>
                                         <li>	Consumable parts.</li>
                                        <li>	Defects resulting from operations outside the usage parameters stated in the product operating manual.</li>
                                        <li>	Malfunctioning caused by damage, repair or modification by any person or persons not so authorized by the manufacturer and Rolof Computers.</li>
                                         <li>	Pre-installed software on the product.</li>
                                        <li>	Loss or damage to any data or programs.</li>
                                    </ul>
                                    <p class="MsoListParagraph" style="text-align:justify;text-indent:-.25in;
line-height:normal;mso-list:l0 level1 lfo1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Customers are advised to buy protective devices such as surge protectors, notebook bags, cooling fans, ups, stabilizers etc for Notebooks, Desktops, projectors, Inverters etc to prolong the life span of the products bought.</p>
                                    <p class="MsoListParagraph" style="text-align:justify;text-indent:-.25in;
line-height:normal;mso-list:l0 level1 lfo1">
                                        <o:p>
                                        2.&nbsp;&nbsp;&nbsp;	Customers should report defective product within 48hours and return same with invoice within 7days. After 7days from date on invoice, no refund/returns/exchange is covered by Rolof Computers.AII returned or exchanged items must be in new condition, in their original box, and must include all packing materials, blank warranty cards, manuals, and all accessories. Rolof Computers is not responsible for personal data or items left in returned merchandise.</o:p></p>
                                    <p class="MsoListParagraph" style="text-align:justify;text-indent:-.25in;
line-height:normal;mso-list:l0 level1 lfo1">
                                        ...
                                        Please read all conditions below. If conditions are not met, Rolof Computers reserves the right to refuse the return or charge a restocking fee not less than 15%. The following are not considered defects:
                                        
                                    </p>
                                    <ul>
      
    <li>Notebooks or software purchased by you which are not compatible with your operating systems and/or existing hardware (where system requirements have been stated on the product detail page).</li>
   <li> Products which shows evidence of impact, sand, liquid or moisture damage; dropping, mishandling or tampering battery or chemical corrosion; damage caused by electrical power; or use contrary to the applicable instruction manual. </li>
<li>Unlicensed or pirated software installed on the product or device.</li>
                                    </ul>
                                    <p class="MsoListParagraph" style="text-align:justify;text-indent:-.25in;
line-height:normal;mso-list:l0 level1 lfo1">
                                         
                                        3.&nbsp;&nbsp;&nbsp;On all manufacturing defects brought to Rolof Computers notice beyond 7 days from purchase, customers will be supported with limited manufacturer's warranty that is applicable on all products (excluding consumables, batteries and accessories). It is mandatory to produce original invoice and warranty card to claim the warranty support. </p>
                                    <p class="MsoListParagraph" style="text-align:justify;text-indent:-.25in;
line-height:normal;mso-list:l0 level1 lfo1">
                                        
                                        4.&nbsp;&nbsp;&nbsp;Product once purchased cannot be returned or refunded unless if falls either as mentioned above in clause 2 above or Rolof Computers is unable to support the replacement /repair (as applicable).
                                         
                                    </p>
                                    <p class="MsoListParagraph" style="text-align:justify;text-indent:-.25in;
line-height:normal;mso-list:l0 level1 lfo1">
                                         
                                        5.&nbsp;&nbsp;&nbsp;Customers returning non defective items wrongly bought or having specification not lower or higher than what the customer intended to buy for use within 3days will forfeit 1S% of the invoiced value. The returned item must satisfy clause 2 above. No cash refund will be entertained.
                                        
                                    </p>
                                    <p class="MsoListParagraph" style="text-align:justify;text-indent:-.25in;
line-height:normal;mso-list:l0 level1 lfo1">
                                        
                                        6.&nbsp;&nbsp;&nbsp;In a situation of refund within clause3, the refunded value will be equal to existing retail price prevailing on the day of the complaints (if lower) or invoice value with depreciation @5% per month of usage whichever is lower. The refund will be in form of cheque and will be handed over within 7 working days from date of refund approval. </p>
                                    <p class="MsoListParagraph" style="text-align:justify;text-indent:-.25in;
line-height:normal;mso-list:l0 level1 lfo1">
                                        
                                        7.&nbsp;&nbsp;&nbsp;In-case of a refund of product sold through credit /debit card, the amount will be reversed on card by the issuing bank through our bank. </p>
                                    <p class="MsoListParagraph" style="text-align:justify;text-indent:-.25in;
line-height:normal;mso-list:l0 level1 lfo1">
                                         
                                        8.&nbsp;&nbsp;&nbsp; Rolof Computers is not responsible for any consequential or incidental damage resulting from the sale or use of any merchandise bought from us. We are responsible for the monetary value of the merchandise only. </p>
                                    <p class="MsoListParagraph" style="text-align:justify;text-indent:-.25in;
line-height:normal;mso-list:l0 level1 lfo1">
                                         
                                        9.&nbsp;&nbsp;&nbsp;Signature on the invoice copy and successful completion of transaction would be treated as acceptance of above items and hence shall be applicable. </p>
