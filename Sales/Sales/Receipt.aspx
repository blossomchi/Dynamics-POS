<%@ page language="VB" autoeventwireup="false" inherits="Invoice, App_Web_5cjx04xp" %>
...
<!--[if !IE]>--><div class="auto-style1" id="xr_xri" style="width: 303px; height: auto; clip: rect(0px, 303px, 1682px, 0px);"><!--<![endif]-->
        ...
        <tr align="left" style="text-align: left">
            <td style="text-align: left" align="left">
                                 ...
                                 <asp:Label ID="LBBranchTelephone" runat="server" 
                                     style="text-align: left; font-size: x-small;"></asp:Label>
