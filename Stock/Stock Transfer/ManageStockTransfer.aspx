<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_cecpfdss" %>
...
//           prtWindow.close();
 ...
 <script type="text/javascript">
     function printGrid1() {
         var gridData = document.getElementById('<%= RecievedStockGV.ClientID %>');
         var windowUrl = 'about:blank';
     ...
     <table id="employeeTable" 
         ...
         <tr>
             <td class="style2" colspan="2">
                 ...
                 <asp:Label ID="employeeMgtLabel" runat="server" 
                     Text=" Manage Stock Transfer."></asp:Label>
                 <asp:TextBox ID="UpdateTextBox0" runat="server" 
                     ...
                     Font-Size="Medium" Visible="False">Transfer Stock.</asp:Label>
         ...
         <tr>
             <td class="style3" colspan="2">
                 ...
                 <asp:Button ID="View" runat="server" 
                     Text="View" 
                     Width="66px" ToolTip="View" />
                        </strong>
                 <asp:Button ID="BackButton" runat="server" Text="Back" 
                     Width="66px" Visible="False" />
                 <asp:Button ID="RecieveStockButton" runat="server" Text="Recieve Stock" 
                     Width="118px" />
                 <asp:Button ID="TransferStockButton" runat="server" Text="Transfer Stock" 
                     Width="118px" />
                                    </strong>
&nbsp;</td>
         </tr>
         <tr>
             <td class="style84" colspan="2">
                 ...
                 <asp:GridView ID="StockGridView" runat="server" 
                     ...
                     GridLines="Vertical" Width="989px" PageSize="23" AllowPaging ="True" 
...
OnClientClick = "Check_Click(this)"/>
         ...
         <tr>
             <td class="style14" colspan="2">
                 ...
                 <asp:SqlDataSource ID="CostSellingPriceDS" runat="server" 
                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                     SelectCommand="SELECT DISTINCT StockDetailsTable.StockID, StockDetailsTable.ItemDescription, SUM(StockDetailsTable.Quantity) AS [Total Stock], StockLocationTable.StoreName FROM StockDetailsTable INNER JOIN StockHeaderTable ON StockDetailsTable.StockID = StockHeaderTable.StockID INNER JOIN StockLocationTable ON StockDetailsTable.StockLocationID = StockLocationTable.StockLocationID GROUP BY StockDetailsTable.ItemDescription, StockLocationTable.StoreName, StockLocationTable.BranchID, StockDetailsTable.Comment, StockDetailsTable.StockID HAVING (StockLocationTable.BranchID = @branchID) AND (StockDetailsTable.Comment = N'R') AND (StockDetailsTable.StockID = @barcode)">
                     <SelectParameters>
                         <asp:ControlParameter ControlID="BranchLabel" Name="branchID" 
                             PropertyName="Text" />
         ...
         <tr>
             <td class="style14" colspan="2">
                 ...
                 <asp:Label ID="LBSN" runat="server" Visible="False">Serial Number</asp:Label>
                             ...
                             <td class="style113" align="left" valign="top" colspan="2" >
                      
                        <asp:DropDownList ID="CBSerialNO" runat="server" AutoPostBack="True" class="chosen-select"
                           ...
                           Width="331px" style="text-align: left" Height="16px" 
                             ...
                             <td class="style114" align="left" valign="top" rowspan="9">
                 ...
                 <asp:Label ID="LBSIMEI" runat="server" Visible="False">IMEI</asp:Label>
                        ...
                        <asp:DropDownList ID="CBIMEI" runat="server" AutoPostBack="True" class="chosen-select"
                 ...
                 <asp:Label ID="LBUnitCostPrice" runat="server" Visible="False">Unit Cost Price</asp:Label>
                        ...
                        <asp:TextBox ID="txtQty" runat="server" Width="328px" 
                            style="text-align: left" ToolTip="Enter Quantity."></asp:TextBox>
                        </strong>
                         ...
                         <tr>
                            ...
                            DataTextField="DesName" DataValueField="RoleID" AutoPostBack="True">
                        </asp:DropDownList>
                        </strong>
                         ...
                         <tr>
                            ...
                            DataTextField="StoreName" DataValueField="StockLocationID" AutoPostBack="True">
                        </asp:DropDownList>
                        </strong>
                        ...
                        Text="Item Description Values" Visible="False"></asp:Label>
                         ...
                         <tr>
                             <td class="style106" align="left" valign="top" colspan="4">
                                  <div style="overflow: auto; height: 286px; width: 962px;">
                                  <asp:GridView ID="PendingGV" runat="server" 
                                 BackColor="White" BorderColor="#999999" 
                            BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" 
                                     GridLines="Vertical" Width="948px" 
                            ShowFooter="True" Height="161px" Font-Size="7pt" 
                            ...
                            <AlternatingRowStyle BackColor="#CCCCCC" />
                               <Columns>
                                   ...
                                   <asp:BoundField DataField="StoreName" HeaderText="Destination" />
                     ...
                     Text="Cancel All" Visible="False" 
                     Width="97px" OnClientClick = "Delete1()" Height="28px" 
                                     ToolTip="Cancel Stock Transfered Transaction." />
                        </strong>
                             </td>
                         </tr>
                         </table>
         ...
         <tr>
             <td class="style83" colspan="2" valign="top">
                        ...
                        <table id="RecieveTable" runat="server" visible="False" 
                            ...
                            style="background-position: center; border-style: solid; border-width: medium; width: 986px; background-image: url('images/eeee.gif'); background-repeat: repeat; height: 655px; background-color: #DBD8CA;"  >
                            <tr>
                                <td class="style71" valign="top" >
                      
                        

                     <table ID="CostTable0" runat="server" visible="True" align="left" 
                            style="width: 967px; ">
                         <tr>
                             <td class="style45">
                                 <strong>
                    ...
                    <asp:Label ID="PriceTypeLabel2" runat="server" style="text-align: left; font-weight: 700;" 
                        Text="Recieved Stock."></asp:Label>
                       
                                </td>
                         </tr>
                         <tr>
                             <td class="style120">
                             <div id="Recieved" style="overflow: auto; height: 399px; width: 892px;">
                             <asp:GridView ID="RecievedStockGV" runat="server" 
                                 BackColor="White" BorderColor="#999999" 
                            BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" 
                                     GridLines="Vertical" Width="882px" 
                            ShowFooter="True" Height="132px" Font-Size="7pt" AutoGenerateColumns="False" 
                                 DataSourceID="RecievedStockDS"  >
                            <AlternatingRowStyle BackColor="#CCCCCC" />
                               <Columns>
                                   <asp:TemplateField HeaderText="SN">
                                        
                                       <ItemTemplate>
                                           <asp:Label ID="SNLabel5" runat="server" Text='<%# Bind("SN") %>'></asp:Label>
                                       </ItemTemplate>
                                   </asp:TemplateField>
                                   <asp:BoundField DataField="StockID" HeaderText="Stock ID" />
                                   <asp:BoundField DataField="ProductNo" HeaderText="Product No" />
                             ...
                             <ItemTemplate>
                                 <asp:ImageButton ID="ImageButton3" runat="server" CausesValidation="false" 
                                     CommandName="Update" ImageUrl="~/images/property/good.png" Text="Activate" ToolTip="Comfirmed" />
                             </ItemTemplate>
                         </asp:TemplateField>
                               </Columns>
                            <FooterStyle BackColor="#CCCCCC" />
                     ...
                     Width="74px" ToolTip="Click to print only gridview" Height="28px" 
                                 ...
                                 <asp:Button ID="CancelRecievedItem" runat="server" 
                     Text="Cancel Pending Items" 
                     Width="173px" ToolTip="Click to cancel pending items." Height="28px" 
                                     style="margin-left: 0px" />
                        </strong>
                                 <asp:SqlDataSource ID="RecievedStockDS" runat="server" 
                                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                                     
                                     
                                     SelectCommand="SELECT DISTINCT StockPendingTable.SN, StockPendingTable.StockID, StockPendingTable.ProductNo, StockPendingTable.SerialNo, StockPendingTable.Qty, StockPendingTable.IMEI, StockPendingTable.ExpiryDate, StockPendingTable.Status, StockPendingTable.Description, StockPendingTable.MFG FROM StockHeaderTable INNER JOIN StockPendingTable ON StockHeaderTable.StockID = StockPendingTable.StockID INNER JOIN StockLocationTable ON StockPendingTable.Destination = StockLocationTable.StockLocationID WHERE (StockPendingTable.Status = N'PENDING') AND (StockPendingTable.Comment = N'T') AND (StockLocationTable.BranchID = @BranchID) AND (StockPendingTable.Designation = @Designation)" 
                                     ...
                                     UpdateCommand="UPDATE StockPendingTable SET Status = N'RECIEVED' WHERE (SN = @SN)">
                                     <SelectParameters>
                                         <asp:ControlParameter ControlID="BranchLabel" Name="BranchID" 
                                             PropertyName="Text" />
                                         <asp:ControlParameter ControlID="txtRoleID" Name="Designation" 
                                             PropertyName="Text" />
                                     </SelectParameters>
                                     <UpdateParameters>
         ...
         <tr>
             <td class="style51" colspan="2" 
                 style="position: absolute; top: 80px; " valign="top">
                      
                        <table id="WholeSaleTable" runat="server" visible="False" align="left" 
                            
                            
                            
                            
                            
                            style="border-style: solid; border-width: medium; width: 985px; background-color: #DBD8CA;"  >
                            <tr>
                        ...
                        <div style="overflow: auto; height: 379px;">
                        <asp:GridView ID="PriceLevelsGV" runat="server" 
                            AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" 
                            BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" 
                                     GridLines="Vertical" Width="976px" 
                            ShowFooter="True" Height="132px" PageSize="15" 
                                     DataSourceID="PendingDS" style="font-size: 12px" 
                                        ToolTip="Items on pending view.">
                            <AlternatingRowStyle BackColor="#CCCCCC" />
                            <Columns>
                                ...
                                <asp:BoundField DataField="StoreName" HeaderText="Arriving Destination" 
                                    SortExpression="StoreName" />
                                <asp:BoundField DataField="Qty" HeaderText="Qty" SortExpression="Qty" />
                                <asp:BoundField DataField="UintCost" HeaderText="UintCost" 
                                    SortExpression="UintCost" />
                            ...
                            <SortedDescendingHeaderStyle BackColor="#383838" />
                                    ...
                                    <strong style="font-weight: 700" >
                                    <asp:Button ID="BackButton3" runat="server" 
                     Text="Close" 
         ...
         <tr>
             <td class="style51" colspan="2">
                        ...
                        <strong > 
                                 ...
                                 <asp:SqlDataSource ID="ManufacturingDS" runat="server" 
                            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                            SelectCommand="SELECT DISTINCT StockDetailsTable.StockID, StockLocationTable.BranchID, StockDetailsTable.MFGDate FROM StockDetailsTable INNER JOIN StockLocationTable ON StockDetailsTable.StockLocationID = StockLocationTable.StockLocationID WHERE (StockLocationTable.BranchID = @BranchID) AND (StockDetailsTable.StockID = @BArcode) ORDER BY StockDetailsTable.MFGDate">
                                     <SelectParameters>
                                         <asp:ControlParameter ControlID="BranchLabel" Name="BranchID" 
                                             PropertyName="Text" />
                            ...
                            SelectCommand="SELECT StockDetailsTable.StockID, StockDetailsTable.SerialNumber, StockLocationTable.BranchID FROM StockDetailsTable INNER JOIN StockLocationTable ON StockDetailsTable.StockLocationID = StockLocationTable.StockLocationID WHERE (StockLocationTable.BranchID = @BranchID) AND (StockDetailsTable.StockID = @Barcode)">
                                     <SelectParameters>
                                         <asp:ControlParameter ControlID="BranchLabel" Name="BranchID" 
                                             PropertyName="Text" />
                                         <asp:ControlParameter ControlID="CBItemDes" Name="Barcode" 
                            ...
                            SelectCommand="SELECT DISTINCT StockDetailsTable.IMEI, StockDetailsTable.StockID, StockLocationTable.BranchID FROM StockDetailsTable INNER JOIN StockLocationTable ON StockDetailsTable.StockLocationID = StockLocationTable.StockLocationID WHERE (NOT (StockDetailsTable.IMEI LIKE N'[N]%')) AND (StockLocationTable.BranchID = @BranchID) AND (StockDetailsTable.StockID = @Barcode)">
                                     <SelectParameters>
                                         <asp:ControlParameter ControlID="BranchLabel" Name="BranchID" 
                                             PropertyName="Text" />
                                         <asp:ControlParameter ControlID="CBItemDes" Name="Barcode" 
                            ...
                            SelectCommand="SELECT DISTINCT StockDetailsTable.StockID, StockDetailsTable.ExpiryDate, StockLocationTable.BranchID, StockLocationTable.StoreName FROM StockDetailsTable INNER JOIN StockLocationTable ON StockDetailsTable.StockLocationID = StockLocationTable.StockLocationID WHERE (StockLocationTable.BranchID = @BranchID) AND (StockDetailsTable.StockID = @BArcode) AND (StockLocationTable.StoreName LIKE N'%Store') ORDER BY StockDetailsTable.ExpiryDate">
                                     <SelectParameters>
                                         <asp:ControlParameter ControlID="BranchLabel" Name="BranchID" 
                                             PropertyName="Text" />
                                         <asp:ControlParameter ControlID="CBItemDes" Name="BArcode" 
                 ...
                 <asp:SqlDataSource ID="UnitDS" runat="server" 
                     ...
                     <DeleteParameters>
                         <asp:Parameter Name="SN" />
                            ...
                            SelectCommand="SELECT DISTINCT StockPendingTable.SN, StockPendingTable.StockID, StockPendingTable.Description, StockPendingTable.ProductNo, StockPendingTable.IMEI, StockPendingTable.UintCost, StockPendingTable.SellingPrice, StockPendingTable.SerialNo, StockPendingTable.Qty, StockPendingTable.Amount, StockPendingTable.ExpiryDate, StockPendingTable.Status, StockPendingTable.PendingDate, StockPendingTable.MFG, StockLocationTable.StoreName FROM StockPendingTable INNER JOIN StockLocationTable ON StockPendingTable.Destination = StockLocationTable.StockLocationID WHERE (StockPendingTable.Status = N'PENDING') AND (StockPendingTable.EmployeeID = @EmployeeID)">
                                     <SelectParameters>
                        ...
                        <asp:SqlDataSource ID="PendingDS" runat="server" 
                            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                            SelectCommand="SELECT StockPendingTable.StockID, StockPendingTable.ProductNo, StockPendingTable.Description, StockPendingTable.SerialNo, StockPendingTable.IMEI, StockPendingTable.ExpiryDate, StockPendingTable.MFG, StockLocationTable.StoreName, StockPendingTable.Qty, StockPendingTable.UintCost, StockPendingTable.SellingPrice, StockPendingTable.Amount, StockPendingTable.Status, employeeTable.Firstname + ' ' + employeeTable.LastName AS [Employee Name] FROM StockPendingTable INNER JOIN StockLocationTable ON StockPendingTable.Destination = StockLocationTable.StockLocationID INNER JOIN employeeTable ON StockPendingTable.EmployeeID = employeeTable.SN">
                        </asp:SqlDataSource>
                 <br />
             </td>
         </tr>
             ...
             <td class="style4">
                 ...
                 <strong>
                     ...
                     Width="41px" 
                        ...
                        <asp:TextBox ID="CodeName1TextBox0" runat="server" Visible="False" Width="19px" 
                            Wrap="False"></asp:TextBox>
                        <asp:TextBox ID="DesignationTextBox" runat="server" Visible="False" Width="19px" 
                            Wrap="False"></asp:TextBox>
                     ...
                     Width="107px" ToolTip="Search by barcode." Visible="False" />
                        ...
                        <asp:TextBox ID="txtUpdate" runat="server" Visible="False" Width="36px" 
                            Wrap="False"></asp:TextBox>
                        <asp:TextBox ID="txtMAx" runat="server" Visible="False" Width="18px" 
                            Wrap="False"></asp:TextBox>
                        <asp:TextBox ID="txtDesig" runat="server" Visible="False" Width="18px" 
                            Wrap="False"></asp:TextBox>
                        <asp:TextBox ID="txtDesti" runat="server" Visible="False" Width="18px" 
                            Wrap="False"></asp:TextBox>
                        <asp:TextBox ID="txtEmployeeID" runat="server" Visible="False" Width="18px" 
                            Wrap="False"></asp:TextBox>
                        <asp:TextBox ID="txtRoleID" runat="server" Visible="False" Width="18px" 
                            Wrap="False"></asp:TextBox>
                        <asp:TextBox ID="TotalShowStore" runat="server" Visible="False" Width="18px" 
                            Wrap="False"></asp:TextBox>
                                    </strong>
             </td>
         </tr>
