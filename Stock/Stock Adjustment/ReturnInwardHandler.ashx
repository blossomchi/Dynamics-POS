<%@ WebHandler Language="VB" Class="ReturnInwardHandler" %>
Imports System.Web
...
Public Class ReturnInwardHandler : Implements IHttpHandler
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        If id IsNot Nothing Then
            ...
            Dim sql As String = "SELECT * From ReturnInwardStockImageTable Where ID = @id"
            ...
            'Get Image Data
            Dim file As Byte() = DirectCast(reader("ReturnInwardScanDoc"), Byte())
