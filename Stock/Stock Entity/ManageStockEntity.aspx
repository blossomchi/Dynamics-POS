<%@ page language="VB" autoeventwireup="false" inherits="Stock_Manage_New_Stock_Default, App_Web_w0j30m5x" %>
...
<meta name="XAR Files" content="index_htm_files/xr_files.txt"/>
 <title>Manage Stock Entity</title>
     ...
     <table id="employeeTable" 
         ...
         <tr>
             <td class="style2">
                 ...
                 <asp:Label ID="employeeMgtLabel" runat="server" 
                     Text=" Manage Stock Entity"></asp:Label>
                 <asp:TextBox ID="UpdateTextBox0" runat="server" 
                     ...
                     Font-Size="Medium" Visible="False">Update Stock Entity.</asp:Label>
         ...
         <tr>
             <td class="style3">
                 ...
                 <asp:Button ID="AddattributeButton" runat="server" Text="Update Entity" 
                     Width="100px" />
                                    </strong>
&nbsp;</td>
         </tr>
         ...
         <tr>
             <td class="style83" valign="top">
                    ...
                    <asp:Label ID="StockLabel" runat="server" style="text-align: left; font-weight: 700;" 
                        Text="Select Stock Entity"></asp:Label>
                             </td>
                         </tr>
                         <tr>
                             <td class="style94">
                                 &nbsp;</td>
                             <td class="style68" colspan="2">
                                 <asp:CheckBox ID="chSN" runat="server" AutoPostBack="True" CssClass="auto-style1" Text="Check Serial Number" />
&nbsp;
                                 <asp:CheckBox ID="chIMEi" runat="server" AutoPostBack="True" CssClass="auto-style1" Text="Check IMEI" />
&nbsp;
                                 <asp:CheckBox ID="chExpiryDate" runat="server" AutoPostBack="True" CssClass="auto-style1" Text="Check Expiry Date" />
&nbsp;
                                 <asp:CheckBox ID="chMFGDate" runat="server" AutoPostBack="True" CssClass="auto-style1" Text="Check Manufacturing Date" />
                        ...
                        <asp:DropDownList ID="CBItemDes" runat="server" AutoPostBack="True" class="chosen-select"
                            DataSourceID="ItemDescriptionDs0" DataTextField="Item Description &amp; Barcode" DataValueField="StockID" 
                            Width="331px" style="text-align: left" Height="16px" >
                             ...
                             <td class="style68" rowspan="4" valign="top">
                                 <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                                     AutoGenerateColumns="False" DataSourceID="AvaliableStock" PageSize="3" 
                                     Width="440px" style="font-size: x-small; text-align: left" 
                         ...
                         <tr>
                             ...
                             <td class="style68">
                        <asp:DropDownList ID="CBName" runat="server" AutoPostBack="True" class="chosen-select" 
                            Width="331px" style="text-align: left" Height="16px" Enabled="False" >
                        </asp:DropDownList>
                         ...
                         <tr>
                             <td class="style94">
                                 <asp:Label ID="LBStockQty" runat="server" Visible="False"></asp:Label>
                             </td>
                             <td class="style68">
                                 <asp:TextBox ID="TxDateStock" runat="server" Width="320px" ReadOnly="True" Visible="False"></asp:TextBox>
                        ...
                        <asp:DropDownList ID="CBSourceNO" runat="server" AutoPostBack="True" 
                         ...
                         <tr>
                             ...
                             class="chosen-select" Width="331px" DataSourceID="supplier" 
                            DataTextField="CompanyName" DataValueField="SupID">
                        </asp:DropDownList>
                        </strong>
                             </td>
                             <td class="style99" rowspan="3">
                                 <strong > 
                        <asp:TextBox ID="txtSupID" runat="server" Width="16px" 
                            style="text-align: left" Visible="False"></asp:TextBox>
                        <asp:TextBox ID="txtCheck" runat="server" Width="16px" 
                            style="text-align: left" Visible="False"></asp:TextBox>
                        </strong>
                             </td>
                         </tr>
                         <tr>
                             <td class="style98">
                                 <asp:Label ID="LBEnterName" runat="server"></asp:Label>
                             </td>
                             <td class="style99">
                                 <asp:TextBox ID="TxEntityName" runat="server" Width="320px"></asp:TextBox>
                             </td>
                         </tr>
                         <tr>
                             <td class="style98">
                 ...
                 <asp:Button 
                     ...
                     Width="66px" ToolTip="Update Stock Information." OnClientClick = "Confirm()" />
                                    </strong>
                             </td>
                         </tr>
                         <tr>
                     ...
                     <DeleteParameters>
                        ...
                        <strong > 
                            ...
                            SelectCommand="SELECT DISTINCT StockLocationID, BranchID, StoreName FROM StockLocationTable WHERE (StoreName LIKE N'%Store') ORDER BY StoreName">
                                 ...
                                 <asp:SqlDataSource ID="ItemDescriptionDs0" runat="server" 
                                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                                     
                            
                            
                            
                            SelectCommand="SELECT DISTINCT StockID, StockID + ' ' + ItemDescription AS [Item Description &amp; Barcode] FROM StockDetailsTable">
                                 </asp:SqlDataSource>
                 <br />
             </td>
         </tr>
