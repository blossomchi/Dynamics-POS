<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_fv3af2p0" %>
         ...
         <tr>
             <td class="style2" colspan="2">
                 ...
                 <asp:Label ID="employeeMgtLabel" runat="server" 
                     Text="Purchases Request Managment"></asp:Label>
         ...
         <tr>
             <td class="style3" colspan="2">
                 ...
                 <asp:Button ID="BackButton" runat="server" Text="Back" Visible="False" 
                     Width="66px" />
                 <asp:Button ID="PRequestButton" runat="server" Text="Purchase Request" 
                     Width="128px" />
                                    </strong>
&nbsp;</td>
         </tr>
         <tr>
             <td class="style14" colspan="2">
                 ...
                 <asp:GridView ID="GVRequest" runat="server" 
                     ...
                     DataSourceID="RequestDS" AllowPaging="True" DataKeyNames="ID" 
                         ...
                         <asp:BoundField DataField="DateCreated" 
                             ...
                             <ItemTemplate>
                                 <asp:ImageButton ID="ImageButton3" runat="server" CausesValidation="false" 
                                     CommandName="Print" ImageUrl="~/images/property/good.png" Text="Print" ToolTip="Display PR" CommandArgument='<%#Eval("ID") %>'/>
                             </ItemTemplate>
                         </asp:TemplateField>
            ...
            visible="False" align="left" bgcolor="#DBD7CB">
                <tr>
                    ...
                    <td class="style63" valign="top">
                            ...
                            Height="20px" Width="285px"  class ="chosen-select" DataSourceID="Supplier" 
                ...
                <tr>
                    ...
                    <td class="style152" valign="top">
                        ...
                        <asp:TextBox ID="txtDateCrated" runat="server" Width="282px" ReadOnly="True"></asp:TextBox>
                 ...
                 style="position: absolute; top: 90px; left: 30px;">
                     ...
                     style="border-style: solid; border-width: medium; width: 907px; background-color: #DBD8CA; height: 124px;"  >
                            <tr>
                                ...
                                <td class="style130" valign="top" rowspan="9" >
                                    ...
                                    <asp:GridView ID="PurchaseDetailView" runat="server" AutoGenerateColumns="False" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="QTYPurchased" HeaderText="QTYPurchased" 
                                                SortExpression="QTYPurchased" />
                                            <asp:BoundField DataField="NewCost" HeaderText="NewCost" 
                                                SortExpression="NewCost" />
                        ...
                        <asp:TextBox ID="txtCurrentTotal" runat="server" Width="282px" ReadOnly="True"></asp:TextBox>
         ...
         <tr>
             <td class="style53">
                 ...
                 <asp:SqlDataSource ID="findBarcodeDS" runat="server" 
                     ...
                     SelectCommand="SELECT PurchaseRequestTable.ID, SupplierHeaderTable.CompanyName, employeeTable.Firstname + ' ' + employeeTable.LastName AS Employee, PurchaseRequestTable.DateCreated FROM PurchaseRequestTable INNER JOIN SupplierHeaderTable ON PurchaseRequestTable.SupplierID = SupplierHeaderTable.SupID INNER JOIN employeeTable ON PurchaseRequestTable.EmployeeID = employeeTable.SN WHERE (PurchaseRequestTable.ID = @ID)">
                     <SelectParameters>
                     ...
                     SelectCommand="SELECT purchaseRequestDetailTable.ID, purchaseRequestDetailTable.Barcode, purchaseRequestDetailTable.ProductNumber, purchaseRequestDetailTable.QTYPurchased, purchaseRequestDetailTable.NewCost, purchaseRequestDetailTable.Amount FROM purchaseRequestDetailTable INNER JOIN PurchaseRequestTable ON purchaseRequestDetailTable.PurchaseRequestID = PurchaseRequestTable.ID WHERE (purchaseRequestDetailTable.PurchaseRequestID = @ID) AND (PurchaseRequestTable.EmployeeID = @EmployeeID)">
                                     <SelectParameters>
