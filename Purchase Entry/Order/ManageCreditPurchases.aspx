<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_guygn0tp" %>
...
<img class="xr_ap" src="index_htm_files/14.png" alt="" title="" 
 ...
 <img class="xr_ap" src="index_htm_files/17.png" alt="" 
                ...
                style="left: 2px; top: 1507px; width: 1005px; height: 74px;"/>
     ...
     <table id="employeeTable" 
         ...
         <tr>
             <td class="style2" colspan="2">
                 ...
                 <asp:Label ID="employeeMgtLabel" runat="server" 
                     Text="Purchases Order Managment."></asp:Label>
             ...
             <td class="style3" colspan="2">
                 <strong>
                        <asp:DropDownList ID="CBSourceNO0" runat="server" AutoPostBack="True" 
                            DataSourceID="SqlDataSource1" DataTextField="PurchaseOrderID" DataValueField="PurchaseOrderID" 
                 ...
                 <asp:Button ID="BackButton" runat="server" Text="Back" Visible="False" 
                     Width="66px" />
                 <asp:Button ID="AddattributeButton" runat="server" Text="Purchase Order" 
                     Width="118px" />
                                    </strong>&nbsp;</td>
         </tr>
         <tr>
             <td class="style14" colspan="2">
                 ...
                 <asp:GridView ID="GVItem" runat="server" 
                     ...
                     DataSourceID="ItemDS" AllowPaging="True" DataKeyNames="PurchaseOrderID" 
                     PageSize="28" style="font-size: 12px">
                     <AlternatingRowStyle BackColor="#CCCCCC" />
                     <Columns>
                         <asp:BoundField DataField="PurchaseOrderID" HeaderText="PO ID"  
                             SortExpression="PurchaseOrderID" InsertVisible="False" ReadOnly="True"/>
                   <asp:BoundField DataField="PurchaseDate" HeaderText="Purchase Date" 
                         ...
                         <asp:BoundField DataField="Employee" 
                             HeaderText="Employee" SortExpression="Employee" ReadOnly="True"/>
                         <asp:BoundField DataField="DateCreated" HeaderText="Date Created" 
                             ...
                             <ItemTemplate>
                                 <asp:ImageButton ID="ImageButton3" runat="server" CausesValidation="false" 
                                     CommandName="Print" ImageUrl="~/images/property/good.png" Text="Print" ToolTip="Display PO" CommandArgument='<%#Eval("PurchaseOrderID") %>'/>
                             </ItemTemplate>
                         </asp:TemplateField>
                         ...
                         <asp:TemplateField ShowHeader="False">
                             <ItemTemplate>
                                 <asp:ImageButton ID="ImageButton1" runat="server" CausesValidation="false" 
                                  CommandName="DeletePurchase" ImageUrl="~/images/property/del.png" Text="Delete" Tooltip="Delete"  CommandArgument='<%#Eval("PurchaseOrderID") %>'/>
                             </ItemTemplate>
                         </asp:TemplateField>
                     </Columns>
                 ...
                 <asp:SqlDataSource ID="RequestDS" runat="server" 
                     ...
                     SelectCommand="SELECT PurchaseRequestTable.ID, SupplierHeaderTable.CompanyName, employeeTable.Firstname + ' ' + employeeTable.LastName AS Employee, PurchaseRequestTable.DateCreated FROM PurchaseRequestTable INNER JOIN SupplierHeaderTable ON PurchaseRequestTable.SupplierID = SupplierHeaderTable.SupID INNER JOIN employeeTable ON PurchaseRequestTable.EmployeeID = employeeTable.SN">
                 </asp:SqlDataSource>
                 ...
                 <asp:GridView ID="findBarcodeGridView" runat="server" 
                     ...
                     CellPadding="3" ForeColor="Black" 
                     GridLines="Vertical" Width="989px" Visible="False" 
                     DataSourceID="findBarcodeDS" DataKeyNames="PurchaseOrderID">
                     <AlternatingRowStyle BackColor="#CCCCCC" />
                     <Columns>
                         <asp:BoundField DataField="PurchaseOrderID" HeaderText="PO ID" 
                             SortExpression="PurchaseOrderID" InsertVisible="False" ReadOnly="True"/>
                         ...
                         <asp:BoundField DataField="CompanyName" HeaderText="Supplier" 
                             ...
                             SortExpression="Shipper" />
                              <asp:BoundField DataField="Amount" DataFormatString="{0:0,0.00}" 
                             HeaderText="Total Amount" SortExpression="Amount" />
         ...
         <tr>
             <td class="style14" colspan="2" valign="top">
                 ...
                 <table style="background-position: center; border-style: solid; border-width: medium; width: 989px; margin-left: 0px; height: 138px; background-image: url('images/eeee.gif'); background-repeat: repeat;" 
                     id="PurchasesOrderTable" runat="server" 
            visible="False" align="left" bgcolor="#DBD7CB">
                        ...
                        <asp:TextBox ID="txtDate" runat="server" Width="200px" ReadOnly="True"></asp:TextBox>
                                 <strong > 
                                    ...
                                    <asp:ImageButton ID="ImageButton19" runat="server" 
                                        ImageUrl="~/images/property/calendar.png" ToolTip="Click to select purchase date" 
                                        Width="16px" />
                        </strong>
                    </td>
                ...
                <tr>
                    ...
                    <td class="style63" valign="top">
                            ...
                            Height="20px" Width="207px" class ="chosen-select" DataSourceID="Supplier" 
                                     DataTextField="CompanyName" DataValueField="SupID" AutoPostBack="True">
                ...
                <tr>
                    ...
                    <td class="style63" valign="top">
                                 ...
                                 <asp:DropDownList ID="CBSupplierContact" runat="server" 
                            Height="20px" Width="207px" class ="chosen-select"  DataSourceID="ContactDSSSS" 
                                     DataTextField="Supplier Contact" DataValueField="ContactID">
                        </asp:DropDownList>
                    </td>
                    <td class="style63" valign="top">
                ...
                <tr>
                    ...
                    <td class="style63" valign="top">
                            ...
                            Height="20px" Width="207px" class ="chosen-select"  DataSourceID="EmployeeDS" 
                                     DataTextField="Authorized By" DataValueField="Authorized By">
                ...
                <tr>
                    ...
                    <td class="style63" valign="top">
                        ...
                        <asp:TextBox ID="txtAmount" runat="server" Width="200px" ReadOnly="True"></asp:TextBox>
                                 <asp:ImageButton ID="ImageButton20" runat="server" Height="10px" 
                                     ImageUrl="~/images/PLUSign - Copy.png" 
                                     ToolTip="click to edit details item." Visible="False" 
                            Width="10px" />
                    </td>
                    <td class="style63" valign="top">
         ...
         <tr>
             <td class="style65" colspan="2" valign="top" align="center">
         ...
         <tr>
             <td class="style14" colspan="2" valign="top" align="center" 
                 style="position: absolute; top: 140px; left: 500px;">
         ...
         <tr>
             <td class="style14" colspan="2" valign="top" align="center" 
                 style="position: absolute; top: 90px; left: 94px;">


                 

                        <table id="POItemDetailsTable" runat="server" visible="False" align="center" 
                             
                            
                            
                     
                            
                            style="border-style: solid; border-width: medium; width: 823px; background-color: #DBD8CA; height: 124px;"  >
                            <tr>
                                <td class="style130" valign="top" colspan="2" >
                      
                                    <strong>Enter Item Details</strong></td>
                                <td class="style130" valign="top" rowspan="7" >
                      
                                    <asp:GridView ID="PurchaseDetailView" runat="server" AutoGenerateColumns="False" 
                                        DataSourceID="DetialsDS" style="font-size: 11px" Width="357px" 
                                        Visible="False">
                                        <Columns>
                         ...
                         <asp:TemplateField ShowHeader="False">
                            ...
                            <tr>
                                <td class="style136" valign="top" >
                                    ...
                                    Purchase Reguest ID</td>
                                <td class="style137" valign="top" >
                      
                        
                        <asp:DropDownList ID="cbRequestID" runat="server" DataSourceID="RequestIDDS" 
                            DataTextField="ID" DataValueField="ID" Height="20px" 
                            Width="285px" class ="chosen-select"  AutoPostBack="True">
                        </asp:DropDownList>
                      
                        

                                    <asp:SqlDataSource ID="RequestIDDS" runat="server" 
                                        ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                                        SelectCommand="SELECT ID FROM PurchaseRequestTable"></asp:SqlDataSource>
                        ...
                        <asp:DropDownList ID="cbBarcode" runat="server" DataSourceID="BarcodeDS" 
                            DataTextField="Barcode" DataValueField="ID" Height="20px" 
                            Width="285px" class ="chosen-select"  AutoPostBack="True">
                        </asp:DropDownList>
                      
                        

                                    <asp:SqlDataSource ID="BarcodeDS" runat="server" 
                                        ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                                        SelectCommand="SELECT Barcode, PurchaseRequestID, ID FROM purchaseRequestDetailTable WHERE (PurchaseRequestID = @ID)">
                                        <SelectParameters>
                                            <asp:ControlParameter ControlID="txtPurchaseReqID" Name="ID" 
                                                PropertyName="Text" />
                                        </SelectParameters>
                                    </asp:SqlDataSource>
                        ...
                        <asp:TextBox ID="txtDescription0" runat="server" TextMode="MultiLine" 
                        ...
                        <asp:TextBox ID="txtPOProductNo" runat="server" Width="282px" ReadOnly="True"></asp:TextBox>
                        ...
                        <asp:TextBox ID="txtPOQTY" runat="server" Width="282px" ReadOnly="True"></asp:TextBox>
                        ...
                        <asp:TextBox ID="txtPOUnitPrice" runat="server" Width="282px" ReadOnly="True"></asp:TextBox>
                     ...
                     Width="66px" />
                        ...
                        <asp:TextBox ID="txtPurchaseReqID" runat="server" Width="16px" 
                 ...
                 <table class="style1" visible="False">
                    ...
                    <td class="style22">
                        ...
                        <asp:TextBox ID="txtRatio" runat="server" Width="20px" 
                            style="text-align: left" Visible="False" MaxLength="100" 
                            ToolTip="Min 0, Max 100"></asp:TextBox>
                        <asp:TextBox ID="txtRatio0" runat="server" Width="20px" 
                            style="text-align: left" Visible="False" MaxLength="100" 
                            ToolTip="Min 0, Max 100"></asp:TextBox>
                        <asp:TextBox ID="txtContactID" runat="server" Width="20px" 
                            style="text-align: left" Visible="False" MaxLength="100" 
                            ToolTip="Min 0, Max 100"></asp:TextBox>
         ...
         <tr>
             <td class="style53">
                 ...
                 <asp:SqlDataSource ID="findBarcodeDS" runat="server" 
                     ...
                     SelectCommand="SELECT DISTINCT PurchaseOrderHeaderTable.PurchaseOrderID, PurchaseOrderHeaderTable.PurchaseDate, PurchaseOrderHeaderTable.DateCreated, employeeTable.Firstname + ' ' + employeeTable.LastName AS Employee, SupplierHeaderTable.CompanyName, PurchaseOrderHeaderTable.Shipper, PurchaseOrderHeaderTable.Amount FROM PurchaseOrderHeaderTable INNER JOIN employeeTable ON PurchaseOrderHeaderTable.CreatedBy = employeeTable.SN INNER JOIN SupplierHeaderTable ON PurchaseOrderHeaderTable.SupplierID = SupplierHeaderTable.SupID WHERE (PurchaseOrderHeaderTable.PurchaseOrderID = @id)">
                     <SelectParameters>
                         <asp:ControlParameter ControlID="findTextBox" Name="id" 
                             PropertyName="Text" />
                     </SelectParameters>
                 </asp:SqlDataSource>

                                 <asp:SqlDataSource ID="SupplierContactDS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT DISTINCT SupplierHeaderTable.SupID, SupplierContactPersonsTable.ContactID, SupplierContactPersonsTable.FirstName + ' ' + SupplierContactPersonsTable.LastName AS [Supplier Contact] FROM SupplierHeaderTable INNER JOIN SupplierContactPersonsTable ON SupplierHeaderTable.SupID = SupplierContactPersonsTable.SupID WHERE (SupplierHeaderTable.SupID = @SupID)">
                                     <SelectParameters>
                                         <asp:ControlParameter ControlID="txtContactID" Name="SupID" PropertyName="Text" />
                                     </SelectParameters>
                 </asp:SqlDataSource>
                     ...
                     SelectCommand="SELECT PurchaseOrderID, Barcode, Description, ProductNumber, UnitCost, Quantity, ID FROM PurchaseOrderDetailsTable WHERE (PurchaseOrderID = @ID) AND (PurchaseRequestID = @ReguestID)">
                                     <SelectParameters>
                                         <asp:ControlParameter ControlID="lbPOID" Name="ID" PropertyName="Text" />
                                         <asp:ControlParameter ControlID="txtPurchaseReqID" Name="ReguestID" 
                                             PropertyName="Text" />
                                     </SelectParameters>
                 </asp:SqlDataSource>
                 ...
                 <asp:SqlDataSource ID="EmployeeDS" runat="server" 
                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                     SelectCommand="SELECT SN, Firstname + ' ' + LastName AS [Authorized By] FROM employeeTable">
                 </asp:SqlDataSource>
                 <asp:SqlDataSource ID="ContactDSSSS" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT DISTINCT SupplierHeaderTable.SupID, SupplierContactPersonsTable.ContactID, SupplierContactPersonsTable.FirstName + ' ' + SupplierContactPersonsTable.LastName AS [Supplier Contact] FROM SupplierHeaderTable INNER JOIN SupplierContactPersonsTable ON SupplierHeaderTable.SupID = SupplierContactPersonsTable.SupID WHERE (SupplierHeaderTable.SupID = @SupID)">
                     <SelectParameters>
                         <asp:ControlParameter ControlID="txtContactID" Name="SupID" PropertyName="Text" />
                     </SelectParameters>
                 </asp:SqlDataSource>
                 <asp:SqlDataSource ID="PendingViewDS" runat="server" 
                     ...
                     SelectCommand="SELECT PurchaseOrderID, Barcode, ProductNumber, UnitCost, Quantity, ID FROM PurchaseOrderPendingTable WHERE (PurchaseOrderID = @ID)">
                     <SelectParameters>
                         <asp:ControlParameter ControlID="lbPOID" Name="ID" PropertyName="Text" />
                     </SelectParameters>
                 </asp:SqlDataSource>
