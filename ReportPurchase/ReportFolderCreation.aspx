<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_ehxy0nvq" %>
...
<!--[if !IE]>--><div class="xr_ap" id="xr_xri" 
 ...
 <table id="adminInfoTable" runat="server" 
         style="width: 483px; left: 760px; top: 146px; height: 42px; right: 8px; position: absolute;" 
         visible="true">
         <tr>
             <td class="style1" >
     ...
     <table id="employeeTable" 
                ...
                style="position: absolute; top: 237px; left: 146px; width: 974px; height: 220px;">
         <tr>
             <td class="style2">
                 <strong>
