<%@ page language="VB" autoeventwireup="false" inherits="Default3, App_Web_x0vlpik1" %>
...
<!--[if !IE]>--><div class="xr_ap" id="xr_xri" 
 ...
 <table id="adminInfoTable" runat="server" 
         style="width: 532px; left: 683px; top: 151px; height: 30px; right: 36px; position: absolute;" 
     ...
     <table id="employeeTable" 
                ...
                style="position: absolute; top: 245px; left: 6px; width: 1239px; height: 180px;">
         <tr>
             <td class="style2">
                 <strong>
